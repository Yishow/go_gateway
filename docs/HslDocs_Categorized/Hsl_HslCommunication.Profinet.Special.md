# HslCommunication - HslCommunication.Profinet.Special
...
[原文連結](http://api.hslcommunication.cn/html/adcbb261-c22c-20d0-b1c5-347b39ca0992.htm)

HslCommunication Library Document

[HslCommunication Library Document](../html\c136d3de-eab7-9b0f-4bdf-d891297c8018.htm "HslCommunication Library Document")

[HslCommunication.Profinet.Special](../html/adcbb261-c22c-20d0-b1c5-347b39ca0992.htm "HslCommunication.Profinet.Special")

[EcFanData 类](../html/6b5b84c1-ce17-28a4-3d02-71dca9912bdf.htm "EcFanData 类")

[EcFanMachine 类](../html/81fa5b69-20c7-3a43-02f4-f2a6962d1182.htm "EcFanMachine 类")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| HslCommunication.Profinet.Special 命名空间 |

[缺少 "N:HslCommunication.Profinet.Special" 的 <summary> 文档]

![](../icons/SectionExpanded.png)类

|  | 类 | 说明 |
| --- | --- | --- |
| 公共类 | [EcFanData](6b5b84c1-ce17-28a4-3d02-71dca9912bdf.htm) | 数据对象 |
| 公共类 | [EcFanMachine](81fa5b69-20c7-3a43-02f4-f2a6962d1182.htm) | FFU 用EC 风机风机通信协议，使用串口通讯，支持风机的转速控制，风机的地址设置，风机的状态读取等功能 |
...
[原文連結](http://api.hslcommunication.cn/html/6b5b84c1-ce17-28a4-3d02-71dca9912bdf.htm)
...
[EcFanData 构造函数](../html/21b346b6-adc2-cd8d-7ddf-7795d17810a8.htm "EcFanData 构造函数 ")

[EcFanData 属性](../html/ff4c05a2-26ad-4925-78c3-03eb9d33b164.htm "EcFanData 属性")

[EcFanData 方法](../html/0a5b2ed3-349f-add8-4a46-aa0e67767436.htm "EcFanData 方法")
...
SystemObject  
  HslCommunication.Profinet.SpecialEcFanData

**命名空间：**
 [HslCommunication.Profinet.Special](adcbb261-c22c-20d0-b1c5-347b39ca0992.htm)  
**程序集：**
...
```
public ref class EcFanData
```

```
type EcFanData =  class end
```
...
|  | 名称 | 说明 |
| --- | --- | --- |
| 公共方法 | [EcFanData](21b346b6-adc2-cd8d-7ddf-7795d17810a8.htm) | 初始化 EcFanData 类的一个新实例 |
...
|  | 名称 | 说明 |
| --- | --- | --- |
| 公共属性 | [EmergencyState](459ee64c-2398-a104-7e69-f2798e089c61.htm) | 应急状态，True表示应急状态，False表示正常 |
| 公共属性 | [LockState](7dd9152e-5ff5-a351-c470-12fa34566959.htm) | 堵转状态，True表示堵转，False表示正常 |
| 公共属性 | [LostSpeedState](87a7c32f-abc9-5fcc-3678-fc974f66d1af.htm) | 失速状态，True表示失速，False表示正常 |
| 公共属性 | [OverHotState](7c2cb44b-2a97-fd25-2bc1-6284c42ff353.htm) | 过热状态，True表示过热，False表示正常 |
| 公共属性 | [RunState](c1fd5b03-d424-de47-8ea7-8b413970507a.htm) | 运行状态，True表示运行，False表示停止 |
| 公共属性 | [Speed](050a695e-c454-12f9-3f3b-68687559a7fc.htm) | 实际的转速 |
...
| 公共方法 | [ToString](5336e4b2-5e6c-d789-d6e7-66a6a88a9030.htm) | (重写 ObjectToString.) |
...
[HslCommunication.Profinet.Special 命名空间](adcbb261-c22c-20d0-b1c5-347b39ca0992.htm)
...
[原文連結](http://api.hslcommunication.cn/html/21b346b6-adc2-cd8d-7ddf-7795d17810a8.htm)
...
初始化 [EcFanData](6b5b84c1-ce17-28a4-3d02-71dca9912bdf.htm) 类的一个新实例
...
[EcFanData 类](6b5b84c1-ce17-28a4-3d02-71dca9912bdf.htm)
...
[原文連結](http://api.hslcommunication.cn/html/ff4c05a2-26ad-4925-78c3-03eb9d33b164.htm)
...
[EmergencyState 属性](../html/459ee64c-2398-a104-7e69-f2798e089c61.htm "EmergencyState 属性 ")

[LockState 属性](../html/7dd9152e-5ff5-a351-c470-12fa34566959.htm "LockState 属性 ")

[LostSpeedState 属性](../html/87a7c32f-abc9-5fcc-3678-fc974f66d1af.htm "LostSpeedState 属性 ")

[OverHotState 属性](../html/7c2cb44b-2a97-fd25-2bc1-6284c42ff353.htm "OverHotState 属性 ")

[RunState 属性](../html/c1fd5b03-d424-de47-8ea7-8b413970507a.htm "RunState 属性 ")

[Speed 属性](../html/050a695e-c454-12f9-3f3b-68687559a7fc.htm "Speed 属性 ")
...
[EcFanData](6b5b84c1-ce17-28a4-3d02-71dca9912bdf.htm) 类型公开以下成员。
...
[原文連結](http://api.hslcommunication.cn/html/459ee64c-2398-a104-7e69-f2798e089c61.htm)
...
|  |
| --- |
| EcFanDataEmergencyState 属性 |

应急状态，True表示应急状态，False表示正常
...
```
Public Property EmergencyState As Boolean
	Get
	Set
```
...
```
member EmergencyState : bool with get, set
```
...
[原文連結](http://api.hslcommunication.cn/html/7dd9152e-5ff5-a351-c470-12fa34566959.htm)
...
|  |
| --- |
| EcFanDataLockState 属性 |

堵转状态，True表示堵转，False表示正常
...
```
Public Property LockState As Boolean
	Get
	Set
```
...
```
member LockState : bool with get, set
```
...
[原文連結](http://api.hslcommunication.cn/html/87a7c32f-abc9-5fcc-3678-fc974f66d1af.htm)
...
|  |
| --- |
| EcFanDataLostSpeedState 属性 |

失速状态，True表示失速，False表示正常
...
```
Public Property LostSpeedState As Boolean
	Get
	Set
```
...
```
member LostSpeedState : bool with get, set
```
...
[原文連結](http://api.hslcommunication.cn/html/7c2cb44b-2a97-fd25-2bc1-6284c42ff353.htm)
...
|  |
| --- |
| EcFanDataOverHotState 属性 |

过热状态，True表示过热，False表示正常
...
```
Public Property OverHotState As Boolean
	Get
	Set
```
...
```
member OverHotState : bool with get, set
```
...
[原文連結](http://api.hslcommunication.cn/html/c1fd5b03-d424-de47-8ea7-8b413970507a.htm)
...
|  |
| --- |
| EcFanDataRunState 属性 |

运行状态，True表示运行，False表示停止
...
```
Public Property RunState As Boolean
	Get
	Set
```
...
```
member RunState : bool with get, set
```
...
[原文連結](http://api.hslcommunication.cn/html/050a695e-c454-12f9-3f3b-68687559a7fc.htm)
...
[原文連結](http://api.hslcommunication.cn/html/0a5b2ed3-349f-add8-4a46-aa0e67767436.htm)
...
[ToString 方法](../html/5336e4b2-5e6c-d789-d6e7-66a6a88a9030.htm "ToString 方法 ")
...
[原文連結](http://api.hslcommunication.cn/html/5336e4b2-5e6c-d789-d6e7-66a6a88a9030.htm)
...
|  |
| --- |
| EcFanDataToString 方法 |

[缺少 "M:HslCommunication.Profinet.Special.EcFanData.ToString" 的 <summary> 文档]
...
[缺少 "M:HslCommunication.Profinet.Special.EcFanData.ToString" 的 <returns> 文档]
...
[原文連結](http://api.hslcommunication.cn/html/81fa5b69-20c7-3a43-02f4-f2a6962d1182.htm)
...
[EcFanMachine 构造函数](../html/9596f398-4c8c-6705-9c72-a2f267734829.htm "EcFanMachine 构造函数 ")

[EcFanMachine 属性](../html/6b32c486-8441-3a92-8064-0df7507b0738.htm "EcFanMachine 属性")

[EcFanMachine 方法](../html/ea22a2ca-5eeb-98be-e314-48584e239bb0.htm "EcFanMachine 方法")

[EcFanMachine 字段](../html/f4dc41ee-fcf1-6a43-1529-dea008a12c31.htm "EcFanMachine 字段")
...
FFU 用EC 风机风机通信协议，使用串口通讯，支持风机的转速控制，风机的地址设置，风机的状态读取等功能
...
        HslCommunication.Profinet.SpecialEcFanMachine
...
```
Public Class EcFanMachine
	Inherits DeviceSerialPort
```

```
public ref class EcFanMachine : public DeviceSerialPort
```
...
EcFanMachine 类型公开以下成员。

![](../icons/SectionExpanded.png)构造函数

|  | 名称 | 说明 |
| --- | --- | --- |
| 公共方法 | [EcFanMachine](9596f398-4c8c-6705-9c72-a2f267734829.htm) | 实例化一个默认的对象 |
...
| 公共属性 | [Station](17359409-bb7d-4bb0-1147-4f222cd89696.htm) | 获取或设置风机的地址，范围是1-30 |
...
|  | 名称 | 说明 |
| --- | --- | --- |
| 公共方法静态成员 | [BuildCommand5A](d62f795b-1cea-8d99-1f94-ab8573359401.htm) | 构建命令5A的命令数据 |
| 公共方法静态成员 | [BuildEntireCommand](2ce1896c-c913-65c1-10f2-32a42071aa4f.htm) | 传入命令，返回完整的命令数据 |
| 公共方法静态成员 | [CheckReceiveDataComplete](6bed6733-2fd6-ba62-72ae-cecca64beb53.htm) | 当消息头报文的长度定义为-1的时候，则使用动态的长度信息，可以使用本方法来判断一个消息是否处于完整的状态。  If the length of the message header is defined as -1, this method can be used to determine whether a message is in the complete state by using dynamic length information. |
...
| 公共方法 | [ControlSpeed](a52ae16c-1d48-dbe0-ba19-55a398410aa2.htm) | 下发速度的命令，返回风机的状态数据 |
...
| 受保护的方法 | [GetNewNetMessage](13ffd876-169a-532f-c54e-f8f04ed23878.htm) | 获取一个新的消息对象的方法，需要在继承类里面进行重写  The method to get a new message object needs to be overridden in the inheritance class (重写 [BinaryCommunicationGetNewNetMessage](16636a1b-a6f0-9c0f-9d9c-c94e26c67459.htm).) |
| 公共方法 | GetType | (继承自 Object。) |
...
| 公共方法 | [ReadSpeedEmergency](f8f44530-8d3b-0fbf-bca2-cf04cd1a34c8.htm) | 读取应急模式的转速 |
| 公共方法 | [ReadSpeedMax](e7caecd2-3940-9de1-f218-1786a8ac7703.htm) | 读取风机的最高转速 |
| 公共方法 | [ReadSpeedMin](0947993c-c98b-1710-f1ba-99f079aecc9c.htm) | 读取风机的最低转速 |
...
[原文連結](http://api.hslcommunication.cn/html/9596f398-4c8c-6705-9c72-a2f267734829.htm)
...
[EcFanMachine 类](81fa5b69-20c7-3a43-02f4-f2a6962d1182.htm)
...
[原文連結](http://api.hslcommunication.cn/html/6b32c486-8441-3a92-8064-0df7507b0738.htm)
...
[Station 属性](../html/17359409-bb7d-4bb0-1147-4f222cd89696.htm "Station 属性 ")
...
[EcFanMachine](81fa5b69-20c7-3a43-02f4-f2a6962d1182.htm) 类型公开以下成员。
...
[原文連結](http://api.hslcommunication.cn/html/17359409-bb7d-4bb0-1147-4f222cd89696.htm)
...
[原文連結](http://api.hslcommunication.cn/html/ea22a2ca-5eeb-98be-e314-48584e239bb0.htm)
...
[BuildCommand5A 方法](../html/d62f795b-1cea-8d99-1f94-ab8573359401.htm "BuildCommand5A 方法 ")

[BuildEntireCommand 方法](../html/2ce1896c-c913-65c1-10f2-32a42071aa4f.htm "BuildEntireCommand 方法 ")

[CheckReceiveDataComplete 方法](../html/6bed6733-2fd6-ba62-72ae-cecca64beb53.htm "CheckReceiveDataComplete 方法 ")

[ControlSpeed 方法](../html/a52ae16c-1d48-dbe0-ba19-55a398410aa2.htm "ControlSpeed 方法 ")

[GetNewNetMessage 方法](../html/13ffd876-169a-532f-c54e-f8f04ed23878.htm "GetNewNetMessage 方法 ")

[ReadSpeedEmergency 方法](../html/f8f44530-8d3b-0fbf-bca2-cf04cd1a34c8.htm "ReadSpeedEmergency 方法 ")

[ReadSpeedMax 方法](../html/e7caecd2-3940-9de1-f218-1786a8ac7703.htm "ReadSpeedMax 方法 ")

[ReadSpeedMin 方法](../html/0947993c-c98b-1710-f1ba-99f079aecc9c.htm "ReadSpeedMin 方法 ")

[SetStation 方法](../html/eafbd3dd-af23-1a35-88be-274a2a808f76.htm "SetStation 方法 ")

[UnpackResponseContent 方法](../html/b4ed2fbf-430c-b8ae-bce9-6d09af666513.htm "UnpackResponseContent 方法 ")
...
[原文連結](http://api.hslcommunication.cn/html/d62f795b-1cea-8d99-1f94-ab8573359401.htm)
...
```
public static byte[] BuildCommand5A(
	byte stat,
	bool run,
	bool emergency,
	int speed
...
---
## BuildEntireCommand 方法 

[原文連結](http://api.hslcommunication.cn/html/2ce1896c-c913-65c1-10f2-32a42071aa4f.htm)
...
|  |
| --- |
| EcFanMachineBuildEntireCommand 方法 |
...
```
public static byte[] BuildEntireCommand(
	byte[] command
)
```

```
Public Shared Function BuildEntireCommand ( 
	command As Byte()
) As Byte()
```
...
```
public:
static array<unsigned char>^ BuildEntireCommand(
	array<unsigned char>^ command
)
```

```
static member BuildEntireCommand : 
        command : byte[] -> byte[] 
```
...
[缺少 "M:HslCommunication.Profinet.Special.EcFanMachine.BuildEntireCommand(System.Byte[])" 的 <returns> 文档]
...
[原文連結](http://api.hslcommunication.cn/html/6bed6733-2fd6-ba62-72ae-cecca64beb53.htm)
...
|  |
| --- |
| EcFanMachineCheckReceiveDataComplete 方法 |
...
:   类型：SystemByte  
    ...
    [缺少 "M:HslCommunication.Profinet.Special.EcFanMachine.CheckReceiveDataComplete(System.Byte[],System.Byte[])" 的 <param name="response"/> 文档]
...
[原文連結](http://api.hslcommunication.cn/html/a52ae16c-1d48-dbe0-ba19-55a398410aa2.htm)
...
```
public OperateResult<EcFanData> ControlSpeed(
	bool run,
	bool emergency,
	int speed
)
...
```
Public Function ControlSpeed ( 
	run As Boolean,
	emergency As Boolean,
	speed As Integer
) As OperateResult(Of EcFanData)
```

```
public:
OperateResult<EcFanData^>^ ControlSpeed(
	bool run, 
	bool emergency, 
	int speed
)
...
member ControlSpeed : 
        run : bool * 
        emergency : bool * 
        speed : int -> OperateResult<EcFanData> 
```
...
emergency
:   类型：SystemBoolean  
    应急模式设置位，True表示切换应急模式，False表示不操作
...
类型：[OperateResult](cf3af065-3e0e-e0ad-7063-8d7eab691b48.htm)[EcFanData](6b5b84c1-ce17-28a4-3d02-71dca9912bdf.htm)  

[缺少 "M:HslCommunication.Profinet.Special.EcFanMachine.ControlSpeed(System.Boolean,System.Boolean,System.Int32)" 的 <returns> 文档]
...
[原文連結](http://api.hslcommunication.cn/html/13ffd876-169a-532f-c54e-f8f04ed23878.htm)
...
|  |
| --- |
| EcFanMachineGetNewNetMessage 方法 |
...
---
## ReadSpeedEmergency 方法 

[原文連結](http://api.hslcommunication.cn/html/f8f44530-8d3b-0fbf-bca2-cf04cd1a34c8.htm)
...
|  |
| --- |
| EcFanMachineReadSpeedEmergency 方法 |
...
```
Public Function ReadSpeedEmergency As OperateResult(Of Integer)
```

```
public:
OperateResult<int>^ ReadSpeedEmergency()
```

```
member ReadSpeedEmergency : unit -> OperateResult<int> 
```
...
[原文連結](http://api.hslcommunication.cn/html/e7caecd2-3940-9de1-f218-1786a8ac7703.htm)
...
```
Public Function ReadSpeedMax As OperateResult(Of Integer)
```

```
public:
OperateResult<int>^ ReadSpeedMax()
```

```
member ReadSpeedMax : unit -> OperateResult<int> 
```
...
[原文連結](http://api.hslcommunication.cn/html/0947993c-c98b-1710-f1ba-99f079aecc9c.htm)
...
```
Public Function ReadSpeedMin As OperateResult(Of Integer)
```

```
public:
OperateResult<int>^ ReadSpeedMin()
```

```
member ReadSpeedMin : unit -> OperateResult<int> 
```
...
[原文連結](http://api.hslcommunication.cn/html/eafbd3dd-af23-1a35-88be-274a2a808f76.htm)
...
```
public OperateResult SetStation(
	byte id
)
```
...
[原文連結](http://api.hslcommunication.cn/html/b4ed2fbf-430c-b8ae-bce9-6d09af666513.htm)
...
|  |
| --- |
| EcFanMachineUnpackResponseContent 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/f4dc41ee-fcf1-6a43-1529-dea008a12c31.htm)
