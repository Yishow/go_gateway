# HslCommunication - HslCommunication.Profinet.Freedom
...
[原文連結](http://api.hslcommunication.cn/html/9d5c429c-a3b8-b8a1-f2b3-1395b96796ae.htm)

HslCommunication Library Document

[HslCommunication Library Document](../html\c136d3de-eab7-9b0f-4bdf-d891297c8018.htm "HslCommunication Library Document")

[HslCommunication.Profinet.Freedom](../html/9d5c429c-a3b8-b8a1-f2b3-1395b96796ae.htm "HslCommunication.Profinet.Freedom")

[FreedomSerial 类](../html/882ab6b5-345e-dbfd-fbfb-912e06f18acd.htm "FreedomSerial 类")

[FreedomTcpNet 类](../html/dc6c8106-87a3-cefd-5bc6-54c80ac3709e.htm "FreedomTcpNet 类")

[FreedomUdpNet 类](../html/9523d7b3-118c-dd35-dbb1-aa96aea7d2c1.htm "FreedomUdpNet 类")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| HslCommunication.Profinet.Freedom 命名空间 |

[缺少 "N:HslCommunication.Profinet.Freedom" 的 <summary> 文档]

![](../icons/SectionExpanded.png)类

|  | 类 | 说明 |
| --- | --- | --- |
| 公共类代码示例 | [FreedomSerial](882ab6b5-345e-dbfd-fbfb-912e06f18acd.htm) | 基于串口的自由协议，需要在地址里传入报文信息，也可以传入数据偏移信息，[ByteTransform](f35118c9-3691-f752-ae6f-2c5549714faa.htm)默认为[RegularByteTransform](4a51ffeb-6068-0331-b842-19f7ec0133f0.htm) |
| 公共类代码示例 | [FreedomTcpNet](dc6c8106-87a3-cefd-5bc6-54c80ac3709e.htm) | 基于TCP/IP协议的自由协议，需要在地址里传入报文信息，也可以传入数据偏移信息，[ByteTransform](720ae40b-1a12-b12f-7845-11c3bf80de8a.htm)默认为[RegularByteTransform](4a51ffeb-6068-0331-b842-19f7ec0133f0.htm) |
| 公共类代码示例 | [FreedomUdpNet](9523d7b3-118c-dd35-dbb1-aa96aea7d2c1.htm) | 基于UDP/IP协议的自由协议，需要在地址里传入报文信息，也可以传入数据偏移信息，[ByteTransform](f35118c9-3691-f752-ae6f-2c5549714faa.htm)默认为[RegularByteTransform](4a51ffeb-6068-0331-b842-19f7ec0133f0.htm) |
...
[原文連結](http://api.hslcommunication.cn/html/882ab6b5-345e-dbfd-fbfb-912e06f18acd.htm)
...
[FreedomSerial 构造函数](../html/0f31d13d-7989-30f4-4f22-a2afe157a898.htm "FreedomSerial 构造函数 ")

[FreedomSerial 属性](../html/c3ebcb95-97d5-0929-66dc-b9117ef7e242.htm "FreedomSerial 属性")

[FreedomSerial 方法](../html/265e1252-79a1-094b-7027-f5fb5d519426.htm "FreedomSerial 方法")

[FreedomSerial 字段](../html/d7d47813-e94e-f044-fc1b-f192f3a712d9.htm "FreedomSerial 字段")
...
基于串口的自由协议，需要在地址里传入报文信息，也可以传入数据偏移信息，[ByteTransform](f35118c9-3691-f752-ae6f-2c5549714faa.htm)默认为[RegularByteTransform](4a51ffeb-6068-0331-b842-19f7ec0133f0.htm)
...
**命名空间：**
 [HslCommunication.Profinet.Freedom](9d5c429c-a3b8-b8a1-f2b3-1395b96796ae.htm)  
**程序集：**
...
```
Public Class FreedomSerial
	Inherits DeviceSerialPort
```

```
public ref class FreedomSerial : public DeviceSerialPort
```
...
FreedomSerial 类型公开以下成员。

![](../icons/SectionExpanded.png)构造函数

|  | 名称 | 说明 |
| --- | --- | --- |
| 公共方法 | [FreedomSerial](0f31d13d-7989-30f4-4f22-a2afe157a898.htm) | 实例化一个默认的对象 |
...
| 公共属性 | [CheckResponseStatus](b70b5e49-30ef-fe91-5642-514c9dd88139.htm) | 一个对返回数据合法检查的委托实例，默认为空，不进行合法性检查，可以实例化实现任意的报文检测，返回是否合法结果。  A delegate instance that checks the legality of the returned data. It is empty by default and does not perform legality checking. It can be instantiated to implement any packet inspection and return whether the result is legal or not. |
...
| 公共方法 | [Read(String, UInt16)](9bdf0cda-6219-b7c6-c3e8-047fe5b3eacb.htm) | 批量读取字节数组信息，需要指定地址和长度，返回原始的字节数组  Batch read byte array information, need to specify the address and length, return the original byte array (重写 [DeviceCommunicationRead(String, UInt16)](9dd09452-c200-bc65-75ff-69aa34b366d4.htm).) |
...
| 公共方法 | [ToString](b4703597-71fa-59b8-e092-2d398ec30cb9.htm) | (重写 [DeviceSerialPortToString](774e7804-97ce-fb07-3764-39fb1ca2e1e7.htm).) |
...
| 公共方法 | [Write(String, Byte)](18342335-9033-3e63-b44c-2ba77e13b330.htm) | 写入原始的byte数组数据到指定的地址，返回是否写入成功  Write the original byte array data to the specified address, and return whether the write was successful (重写 [DeviceCommunicationWrite(String, Byte)](b5536dd6-ccde-6883-ac27-bff9e4b37806.htm).) |
...
public void ReadSample( )
{
    ...
    freedom.ByteTransform = new HslCommunication.Core.RegularByteTransform( HslCommunication.Core.DataFormat.CDAB ); // modbus协议的字节变换操作

    // 串口不需要连接，直接读取，如果串口没有打开，会去打开串口，我们进行读取，地址为报文数据，可以携带stx参数，在解析数据结果的时候，进行偏移多少地址
    OperateResult<short> read = freedom.ReadInt16( "stx=3;01 03 00 64 00 01 C5 D5" );
    if (read.IsSuccess)
    {
    ...
    // 当然，如果你想发送一串byte[]过去，然后直接接受一串byte[]回来的话，可以直接
    OperateResult<byte[]> read2 = freedom.ReadFromCoreServer( "01 03 00 64 00 01 C5 D5".ToHexBytes( ) );
    if (read2.IsSuccess)
    {
        Console.WriteLine( "Read Value:" + read2.Content.ToHexString( ' ' ) );
        // 打印  01 03 02 00 7B F8 67
    }
}
```
...
[HslCommunication.Profinet.Freedom 命名空间](9d5c429c-a3b8-b8a1-f2b3-1395b96796ae.htm)
...
[原文連結](http://api.hslcommunication.cn/html/0f31d13d-7989-30f4-4f22-a2afe157a898.htm)
...
[FreedomSerial 类](882ab6b5-345e-dbfd-fbfb-912e06f18acd.htm)
...
[原文連結](http://api.hslcommunication.cn/html/c3ebcb95-97d5-0929-66dc-b9117ef7e242.htm)
...
[CheckResponseStatus 属性](../html/b70b5e49-30ef-fe91-5642-514c9dd88139.htm "CheckResponseStatus 属性 ")
...
[FreedomSerial](882ab6b5-345e-dbfd-fbfb-912e06f18acd.htm) 类型公开以下成员。
...
---
## CheckResponseStatus 属性 

[原文連結](http://api.hslcommunication.cn/html/b70b5e49-30ef-fe91-5642-514c9dd88139.htm)
...
|  |
| --- |
| FreedomSerialCheckResponseStatus 属性 |
...
```
Public Property CheckResponseStatus As Func(Of Byte(), Byte(), OperateResult)
	Get
	Set
```
...
```
public:
property Func<array<unsigned char>^, array<unsigned char>^, OperateResult^>^ CheckResponseStatus {
	Func<array<unsigned char>^, array<unsigned char>^, OperateResult^>^ get ();
	void set (Func<array<unsigned char>^, array<unsigned char>^, OperateResult^>^ value);
}
```

```
member CheckResponseStatus : Func<byte[], byte[], OperateResult> with get, set
```

#### 属性值

类型：FuncByte, Byte, [OperateResult](a8ab4838-9351-2ebe-b761-3b0fddbcda6b.htm)
...
[原文連結](http://api.hslcommunication.cn/html/265e1252-79a1-094b-7027-f5fb5d519426.htm)
...
[Read 方法](../html/b0aaf5b1-24d5-f6e1-de56-54ffa954fc3f.htm "Read 方法 ")

[ToString 方法](../html/b4703597-71fa-59b8-e092-2d398ec30cb9.htm "ToString 方法 ")

[Write 方法](../html/38c33e86-a501-f5b1-efe9-85e07fd9993e.htm "Write 方法 ")
...
[原文連結](http://api.hslcommunication.cn/html/b0aaf5b1-24d5-f6e1-de56-54ffa954fc3f.htm)
...
[Read 方法 (String, UInt16)](../html/9bdf0cda-6219-b7c6-c3e8-047fe5b3eacb.htm "Read 方法 (String, UInt16)")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| FreedomSerialRead 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/9bdf0cda-6219-b7c6-c3e8-047fe5b3eacb.htm)
...
|  |
| --- |
| FreedomSerialRead 方法 (String, UInt16) |
...
[Read 重载](b0aaf5b1-24d5-f6e1-de56-54ffa954fc3f.htm)
...
[原文連結](http://api.hslcommunication.cn/html/b4703597-71fa-59b8-e092-2d398ec30cb9.htm)
...
|  |
| --- |
| FreedomSerialToString 方法 |

[缺少 "M:HslCommunication.Profinet.Freedom.FreedomSerial.ToString" 的 <summary> 文档]
...
[缺少 "M:HslCommunication.Profinet.Freedom.FreedomSerial.ToString" 的 <returns> 文档]
...
[原文連結](http://api.hslcommunication.cn/html/38c33e86-a501-f5b1-efe9-85e07fd9993e.htm)
...
[Write 方法 (String, Byte[])](../html/18342335-9033-3e63-b44c-2ba77e13b330.htm "Write 方法 (String, Byte[])")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| FreedomSerialWrite 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/18342335-9033-3e63-b44c-2ba77e13b330.htm)
...
|  |
| --- |
| FreedomSerialWrite 方法 (String, Byte) |
...
[Write 重载](38c33e86-a501-f5b1-efe9-85e07fd9993e.htm)
...
[原文連結](http://api.hslcommunication.cn/html/d7d47813-e94e-f044-fc1b-f192f3a712d9.htm)
...
[原文連結](http://api.hslcommunication.cn/html/dc6c8106-87a3-cefd-5bc6-54c80ac3709e.htm)
...
[FreedomTcpNet 构造函数](../html/e9a3eb8c-7776-4cc5-da3c-cab9c12949dc.htm "FreedomTcpNet 构造函数 ")

[FreedomTcpNet 属性](../html/7d2cef66-c61f-959b-ab3d-76ab292782fc.htm "FreedomTcpNet 属性")

[FreedomTcpNet 方法](../html/39e485e7-a242-e25c-294f-9d0f7e44f1a1.htm "FreedomTcpNet 方法")

[FreedomTcpNet 字段](../html/b70a76ae-61d9-6bf3-c0ed-aa5f5092927b.htm "FreedomTcpNet 字段")
...
基于TCP/IP协议的自由协议，需要在地址里传入报文信息，也可以传入数据偏移信息，[ByteTransform](720ae40b-1a12-b12f-7845-11c3bf80de8a.htm)默认为[RegularByteTransform](4a51ffeb-6068-0331-b842-19f7ec0133f0.htm)
...
        HslCommunication.Profinet.FreedomFreedomTcpNet  
          [HslCommunication.Profinet.FreedomFreedomUdpNet](9523d7b3-118c-dd35-dbb1-aa96aea7d2c1.htm)
...
```
Public Class FreedomTcpNet
	Inherits DeviceTcpNet
```

```
public ref class FreedomTcpNet : public DeviceTcpNet
```
...
FreedomTcpNet 类型公开以下成员。

![](../icons/SectionExpanded.png)构造函数

|  | 名称 | 说明 |
| --- | --- | --- |
| 公共方法 | [FreedomTcpNet](9e878e07-7601-7e21-25a2-da2dec0674f5.htm) | 实例化一个默认的对象 |
| 公共方法 | [FreedomTcpNet(String, Int32)](d4f9d572-929e-7c2c-5c11-870de505d937.htm) | 指定IP地址及端口号来实例化自由的TCP协议 |
...
| --- | --- | --- |
| 公共属性代码示例 | [ByteTransform](f35118c9-3691-f752-ae6f-2c5549714faa.htm) | 当前的数据变换机制，当你需要从字节数据转换类型数据的时候需要。  The current data transformation mechanism is required when you need to convert type data from byte data. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共属性 | [CheckResponseStatus](8d7945a1-47bc-e691-3edf-d44286f02497.htm) | 一个对返回数据合法检查的委托实例，默认为空，不进行合法性检查，可以实例化实现任意的报文检测，返回是否合法结果。  A delegate instance that checks the legality of the returned data. It is empty by default and does not perform legality checking. It can be instantiated to implement any packet inspection and return whether the result is legal or not. |
...
| 公共属性代码示例 | [LogNet](8c56f246-88ac-afb8-8c06-972fafe4f78a.htm) | 组件的日志工具，支持日志记录，只要实例化后，当前网络的基本信息，就以[DEBUG](3ce37fee-7678-e278-6a0a-7656126003b6.htm)等级进行输出  The component's logging tool supports logging. As long as the instantiation of the basic network information, the output will be output at [DEBUG](3ce37fee-7678-e278-6a0a-7656126003b6.htm) (继承自 [BinaryCommunication](1edb8336-6f5d-2697-7b3b-911625a330f6.htm)。) |
| 公共属性 | [NetMessage](85ab0942-03f6-bea6-ecee-49cbf3cc1986.htm) | 如果当前的报文使用了固定报文头加剩余报文长度来描述完整报文的情况下，可以自定义实例化报文消息对象，可以更快更完整的接收全部报文的数据。  If the current message uses a fixed header and the remaining message length to describe the complete message, you can customize the instantiated message object to receive the data of all messages faster and more completely. |
...
| 公共方法 | GetHashCode | (继承自 Object。) |
| 受保护的方法 | [GetLogTextFromBinary](67f3b2f7-957c-fa0b-8320-6799237157db.htm) | 获取当前的报文进行日志记录的时候，是否使用二进制的格式记录，默认返回 [LogMsgFormatBinary](2ed2ff87-caec-0e44-f08b-e2b015225a58.htm)，重写可以根据session对象分别返回不同记录模式  Whether to log the current packet in binary format, the default return is [LogMsgFormatBinary](2ed2ff87-caec-0e44-f08b-e2b015225a58.htm). If you want to override it, different recording modes can be returned according to session (继承自 [BinaryCommunication](1edb8336-6f5d-2697-7b3b-911625a330f6.htm)。) |
| 受保护的方法 | [GetNewNetMessage](ddf2783b-bd78-07ce-18a3-7008d62c6905.htm) | 获取一个新的消息对象的方法，需要在继承类里面进行重写  The method to get a new message object needs to be overridden in the inheritance class (重写 [BinaryCommunicationGetNewNetMessage](16636a1b-a6f0-9c0f-9d9c-c94e26c67459.htm).) |
| 公共方法 | GetType | (继承自 Object。) |
| 受保护的方法 | [GetWordLength](c27821ea-1739-8eb9-a848-23a00828fec8.htm) | 一个字单位的数据表示的地址长度，西门子为2，三菱，欧姆龙，modbusTcp就为1，AB PLC无效  The address length represented by one word of data, Siemens is 2, Mitsubishi, Omron, modbusTcp is 1, AB PLC is invalid (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 受保护的方法代码示例 | [InitializationOnConnect](4ab6989f-a5b5-05fe-8b44-bfa45824a2a7.htm) | 根据实际的协议选择是否重写本方法，有些协议在创建连接之后，需要进行一些初始化的信号握手，才能最终建立网络通道。  Whether to rewrite this method is based on the actual protocol. Some protocols require some initial signal handshake to establish a network channel after the connection is created. (继承自 [BinaryCommunication](1edb8336-6f5d-2697-7b3b-911625a330f6.htm)。) |
| 受保护的方法代码示例 | [InitializationOnConnectAsync](7da2af04-d4fc-5045-19a4-4b0d1722eef3.htm) | 根据实际的协议选择是否重写本方法，有些协议在创建连接之后，需要进行一些初始化的信号握手，才能最终建立网络通道。  Whether to rewrite this method is based on the actual protocol. Some protocols require some initial signal handshake to establish a network channel after the connection is created. (继承自 [BinaryCommunication](1edb8336-6f5d-2697-7b3b-911625a330f6.htm)。) |
...
| 受保护的方法 | MemberwiseClone | (继承自 Object。) |
| 公共方法 | [PackCommandWithHeader](d0b2cd76-c306-11fc-38c7-af8ad306cce7.htm) | 对当前的命令进行打包处理，通常是携带命令头内容，标记当前的命令的长度信息，需要进行重写，否则默认不打包  The current command is packaged, usually carrying the content of the command header, marking the length of the current command, and it needs to be rewritten, otherwise it is not packaged by default (继承自 [BinaryCommunication](1edb8336-6f5d-2697-7b3b-911625a330f6.htm)。) |
| 公共方法 | [Read(String, UInt16)](7c245fd3-5fb8-b902-85de-ad2fcf62be1f.htm) | 批量读取字节数组信息，需要指定地址和长度，返回原始的字节数组  Batch read byte array information, need to specify the address and length, return the original byte array (重写 [DeviceCommunicationRead(String, UInt16)](9dd09452-c200-bc65-75ff-69aa34b366d4.htm).) |
| 公共方法代码示例 | [ReadT](95abe064-5594-5ae7-a849-98c53f88fee0.htm) | 读取支持Hsl特性的数据内容，该特性为[HslDeviceAddressAttribute](e39ddd01-95cf-ea40-1f29-20801dddfbe0.htm)，详细参考api文档说明，或是官网的详细文档  Read the data content of the Hsl attribute. The attribute is [HslDeviceAddressAttribute](e39ddd01-95cf-ea40-1f29-20801dddfbe0.htm), please refer to the api documentation for details. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法 | [ReadAsync(String, UInt16)](c1f0d479-5ddc-d882-ce6b-7f5040b21bf9.htm) | 批量读取字节数组信息，需要指定地址和长度，返回原始的字节数组  Batch read byte array information, need to specify the address and length, return the original byte array (重写 [DeviceCommunicationReadAsync(String, UInt16)](d8c14d37-56dc-2a31-1a19-3e2b5b65197d.htm).) |
| 公共方法代码示例 | [ReadAsyncT](0522e740-4bf0-2e31-c4c5-e41384321b37.htm) | 异步读取支持Hsl特性的数据内容，该特性为[HslDeviceAddressAttribute](e39ddd01-95cf-ea40-1f29-20801dddfbe0.htm)，详细参考api文档说明  Asynchronously read the data content of the Hsl attribute. The attribute is [HslDeviceAddressAttribute](e39ddd01-95cf-ea40-1f29-20801dddfbe0.htm), please refer to the api documentation for details. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法 | [ReadBool(String)](9b2faa2e-eaa9-7ace-c49f-7a0318f1df1a.htm) | 读取单个的Boolean数据信息  Read a single Boolean data message (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法 | [ReadBool(String, UInt16)](69d0d24f-34a7-5b41-5c1b-619edc7e6b54.htm) | 批量读取Boolean数组信息，需要指定地址和长度，返回Boolean 数组  Batch read Boolean array information, need to specify the address and length, return Boolean array (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法 | [ReadBoolAsync(String)](cc37da1f-d673-fe67-78ee-4e465d29a2bd.htm) | 异步读取单个的Boolean数据信息  Asynchronously read a single Boolean data message (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
...
| 公共方法 | [ToString](903fce69-9d46-c42d-3e49-8f9daee4b101.htm) | (重写 [DeviceTcpNetToString](209a196b-90ea-2b73-e915-ce4b11f1263d.htm).) |
| 公共方法 | [UnpackResponseContent](208017a7-8da2-33f8-3273-d7e7e850100f.htm) | 根据对方返回的报文命令，对命令进行基本的拆包，例如各种Modbus协议拆包为统一的核心报文，还支持对报文的验证  According to the message command returned by the other party, the command is basically unpacked, for example, various Modbus protocols are unpacked into a unified core message, and the verification of the message is also supported (继承自 [BinaryCommunication](1edb8336-6f5d-2697-7b3b-911625a330f6.htm)。) |
| 公共方法 | [Wait(String, Boolean, Int32, Int32)](0e4db26e-1177-2b18-9492-ba05afb6fcc4.htm) | 等待指定地址的Boolean值为指定的值，可以指定刷新数据的频率，等待的超时时间，如果超时时间为-1的话，则是无期限等待。  Waiting for the Boolean value of the specified address to be the specified value, you can specify the frequency of refreshing the data, and the timeout time to wait. If the timeout time is -1, it is an indefinite wait. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法 | [Wait(String, Int16, Int32, Int32)](e06fe098-8c8b-83f9-73ca-2a7cce19d43d.htm) | 等待指定地址的Int16值为指定的值，可以指定刷新数据的频率，等待的超时时间，如果超时时间为-1的话，则是无期限等待。  Waiting for the Int16 value of the specified address to be the specified value, you can specify the frequency of refreshing the data, and the timeout time to wait. If the timeout time is -1, it is an indefinite wait. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法 | [Wait(String, Int32, Int32, Int32)](1bce0aae-27e9-f1d6-e8f3-25ae6b47554e.htm) | 等待指定地址的Int32值为指定的值，可以指定刷新数据的频率，等待的超时时间，如果超时时间为-1的话，则是无期限等待。  Waiting for the Int32 value of the specified address to be the specified value, you can specify the frequency of refreshing the data, and the timeout time to wait. If the timeout time is -1, it is an indefinite wait. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
...
| 公共方法代码示例 | [Write(String, UInt64)](4924086e-9b36-d446-4ae4-6682134a6ad1.htm) | 写入ulong数据，返回是否成功  Write ulong data, return whether the write was successful (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法代码示例 | [Write(String, UInt64)](b1131bdd-8b51-ec6d-dd0e-fec1f6cb51b6.htm) | 写入ulong数组，返回是否成功  Write ulong array, return whether the write was successful (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法 | [Write(String, Byte)](8d933151-d92b-a245-afd0-05a9b41f5c04.htm) | 写入原始的byte数组数据到指定的地址，返回是否写入成功  Write the original byte array data to the specified address, and return whether the write was successful (重写 [DeviceCommunicationWrite(String, Byte)](b5536dd6-ccde-6883-ac27-bff9e4b37806.htm).) |
| 公共方法代码示例 | [Write(String, String, Int32)](02fe2ca9-49a3-ede4-d1af-8c6da1f644da.htm) | 写入指定长度的字符串信息，如果超出，就截断字符串，如果长度不足，那就补0操作，编码为ASCII  Write string information of the specified length. If it exceeds the value, the string is truncated. If the length is not enough, it is filled with 0 and the encoding is ASCII. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法代码示例 | [Write(String, String, Encoding)](7b602661-902d-2b70-1fdb-ba87ecd307bf.htm) | 写入字符串信息，需要指定的编码信息  Write string information, need to specify the encoding information (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法代码示例 | [Write(String, String, Int32, Encoding)](e8cb30d9-4c5e-6c68-b9af-1b1b6c2dc714.htm) | 写入指定长度的字符串信息，如果超出，就截断字符串，如果长度不足，那就补0操作，编码为指定的编码信息  Write string information of the specified length. If it exceeds the value, the string is truncated. If the length is not enough, then the operation is complemented with 0 , you should specified the encoding information (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法代码示例 | [WriteT(T)](9f48853f-fbeb-c37d-25a2-1c76d1dee407.htm) | 写入支持Hsl特性的数据，返回是否写入成功，该特性为[HslDeviceAddressAttribute](e39ddd01-95cf-ea40-1f29-20801dddfbe0.htm)，详细参考api文档说明  Write data that supports the Hsl attribute, and return whether the write was successful. The attribute is [HslDeviceAddressAttribute](e39ddd01-95cf-ea40-1f29-20801dddfbe0.htm), please refer to the api documentation for details. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
...
| 公共方法代码示例 | [WriteAsync(String, UInt64)](e396074d-6cf1-b45d-5e8e-01026f6e391b.htm) | 异步写入ulong数据，返回是否成功  Asynchronously write ulong data, return whether the write was successful (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法代码示例 | [WriteAsync(String, UInt64)](ae3df8ec-29c0-42ff-3d6a-68f496997b3d.htm) | 异步写入ulong数组，返回是否成功  Asynchronously write ulong array, return whether the write was successful (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法代码示例 | [WriteAsync(String, Byte)](d8223df7-ab96-1c84-5188-1bb6d9f5c74c.htm) | 异步写入原始的byte数组数据到指定的地址，返回是否写入成功  Asynchronously writes the original byte array data to the specified address, and returns whether the write was successful (重写 [DeviceCommunicationWriteAsync(String, Byte)](8f1cec30-8b86-6749-c8f3-7d39168d59df.htm).) |
| 公共方法 | [WriteAsync(String, String, Int32)](b739b983-b03c-8ecf-2713-75f19233ae2f.htm) | 异步写入指定长度的字符串信息，如果超出，就截断字符串，如果长度不足，那就补0操作，编码为ASCII  Asynchronously write string information of the specified length. If it exceeds the value, the string is truncated. If the length is not enough, it is filled with 0 and the encoding is ASCII. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法代码示例 | [WriteAsync(String, String, Encoding)](876e9800-0406-6407-bdf8-8ab1cf28df38.htm) | 异步写入字符串信息，需要指定的编码信息  Asynchronously write string information, need to specify the encoding information (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法 | [WriteAsync(String, String, Int32, Encoding)](ae9fb2a3-fddb-48eb-e9ad-6cc0ebbac1f6.htm) | 异步写入指定长度的字符串信息，如果超出，就截断字符串，如果长度不足，那就补0操作，编码为指定的编码信息  Asynchronously write string information of the specified length. If it exceeds the value, the string is truncated. If the length is not enough, then the operation is complemented with 0 , you should specified the encoding information (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法代码示例 | [WriteAsyncT(T)](25d96e77-d1b2-918c-33f9-e5e4cc57c9cd.htm) | 异步写入支持Hsl特性的数据，返回是否写入成功，该特性为[HslDeviceAddressAttribute](e39ddd01-95cf-ea40-1f29-20801dddfbe0.htm)，详细参考api文档说明  Asynchronously write data that supports the Hsl attribute, and return whether the write was successful. The attribute is [HslDeviceAddressAttribute](e39ddd01-95cf-ea40-1f29-20801dddfbe0.htm), please refer to the api documentation for details. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
...
public void ReadSample( )
{
    ...
    if (connect.IsSuccess)
    {
        ...
        OperateResult<short> read = freedom.ReadInt16( "stx=9;00 00 00 00 00 06 01 03 00 64 00 01" );
        if (read.IsSuccess)
        {
            Console.WriteLine( "Read Value:" + read.Content );
        }
        ...
        // 当然，如果你想发送一串byte[]过去，然后直接接受一串byte[]回来的话，可以直接
        OperateResult<byte[]> read2 = freedom.ReadFromCoreServer( "00 00 00 00 00 06 01 03 00 64 00 01".ToHexBytes( ) );
        if (read2.IsSuccess)
        {
            Console.WriteLine( "Read Value:" + read2.Content.ToHexString( ' ' ) );
            // 打印  00 00 00 00 00 05 01 03 02 00 7B
        }
    }
    else
    {
...
[原文連結](http://api.hslcommunication.cn/html/e9a3eb8c-7776-4cc5-da3c-cab9c12949dc.htm)
...
[FreedomTcpNet 构造函数](../html/9e878e07-7601-7e21-25a2-da2dec0674f5.htm "FreedomTcpNet 构造函数 ")

[FreedomTcpNet 构造函数 (String, Int32)](../html/d4f9d572-929e-7c2c-5c11-870de505d937.htm "FreedomTcpNet 构造函数 (String, Int32)")
...
[FreedomTcpNet 类](dc6c8106-87a3-cefd-5bc6-54c80ac3709e.htm)
...
[原文連結](http://api.hslcommunication.cn/html/9e878e07-7601-7e21-25a2-da2dec0674f5.htm)
...
[FreedomTcpNet 重载](e9a3eb8c-7776-4cc5-da3c-cab9c12949dc.htm)
...
---
## FreedomTcpNet 构造函数 (String, Int32)

[原文連結](http://api.hslcommunication.cn/html/d4f9d572-929e-7c2c-5c11-870de505d937.htm)
...
[原文連結](http://api.hslcommunication.cn/html/7d2cef66-c61f-959b-ab3d-76ab292782fc.htm)
...
[CheckResponseStatus 属性](../html/8d7945a1-47bc-e691-3edf-d44286f02497.htm "CheckResponseStatus 属性 ")

[NetMessage 属性](../html/85ab0942-03f6-bea6-ecee-49cbf3cc1986.htm "NetMessage 属性 ")
...
[FreedomTcpNet](dc6c8106-87a3-cefd-5bc6-54c80ac3709e.htm) 类型公开以下成员。
...
[原文連結](http://api.hslcommunication.cn/html/8d7945a1-47bc-e691-3edf-d44286f02497.htm)
...
|  |
| --- |
| FreedomTcpNetCheckResponseStatus 属性 |
...
[原文連結](http://api.hslcommunication.cn/html/85ab0942-03f6-bea6-ecee-49cbf3cc1986.htm)
...
[原文連結](http://api.hslcommunication.cn/html/39e485e7-a242-e25c-294f-9d0f7e44f1a1.htm)
...
[GetNewNetMessage 方法](../html/ddf2783b-bd78-07ce-18a3-7008d62c6905.htm "GetNewNetMessage 方法 ")

[Read 方法](../html/9d8094bc-02c2-dbc5-8419-5b204592c1f1.htm "Read 方法 ")

[ReadAsync 方法](../html/e4854fdc-52a4-db8a-bd0e-c1a55b719aed.htm "ReadAsync 方法 ")

[ToString 方法](../html/903fce69-9d46-c42d-3e49-8f9daee4b101.htm "ToString 方法 ")

[Write 方法](../html/0032cd8a-98a8-d2b6-e434-fa4494419019.htm "Write 方法 ")

[WriteAsync 方法](../html/4036438c-90a8-4097-e79c-4003d7b27ff4.htm "WriteAsync 方法 ")
...
[原文連結](http://api.hslcommunication.cn/html/ddf2783b-bd78-07ce-18a3-7008d62c6905.htm)
...
|  |
| --- |
| FreedomTcpNetGetNewNetMessage 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/9d8094bc-02c2-dbc5-8419-5b204592c1f1.htm)
...
[Read 方法 (String, UInt16)](../html/7c245fd3-5fb8-b902-85de-ad2fcf62be1f.htm "Read 方法 (String, UInt16)")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| FreedomTcpNetRead 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/7c245fd3-5fb8-b902-85de-ad2fcf62be1f.htm)
...
|  |
| --- |
| FreedomTcpNetRead 方法 (String, UInt16) |
...
[Read 重载](9d8094bc-02c2-dbc5-8419-5b204592c1f1.htm)
...
[原文連結](http://api.hslcommunication.cn/html/e4854fdc-52a4-db8a-bd0e-c1a55b719aed.htm)
...
[ReadAsync 方法 (String, UInt16)](../html/c1f0d479-5ddc-d882-ce6b-7f5040b21bf9.htm "ReadAsync 方法 (String, UInt16)")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| FreedomTcpNetReadAsync 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/c1f0d479-5ddc-d882-ce6b-7f5040b21bf9.htm)
...
|  |
| --- |
| FreedomTcpNetReadAsync 方法 (String, UInt16) |
...
[ReadAsync 重载](e4854fdc-52a4-db8a-bd0e-c1a55b719aed.htm)
...
[原文連結](http://api.hslcommunication.cn/html/903fce69-9d46-c42d-3e49-8f9daee4b101.htm)
...
|  |
| --- |
| FreedomTcpNetToString 方法 |

[缺少 "M:HslCommunication.Profinet.Freedom.FreedomTcpNet.ToString" 的 <summary> 文档]
...
[缺少 "M:HslCommunication.Profinet.Freedom.FreedomTcpNet.ToString" 的 <returns> 文档]
...
[原文連結](http://api.hslcommunication.cn/html/0032cd8a-98a8-d2b6-e434-fa4494419019.htm)
...
[Write 方法 (String, Byte[])](../html/8d933151-d92b-a245-afd0-05a9b41f5c04.htm "Write 方法 (String, Byte[])")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| FreedomTcpNetWrite 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/8d933151-d92b-a245-afd0-05a9b41f5c04.htm)
...
|  |
| --- |
| FreedomTcpNetWrite 方法 (String, Byte) |
...
[Write 重载](0032cd8a-98a8-d2b6-e434-fa4494419019.htm)
...
[原文連結](http://api.hslcommunication.cn/html/4036438c-90a8-4097-e79c-4003d7b27ff4.htm)
...
[WriteAsync 方法 (String, Byte[])](../html/d8223df7-ab96-1c84-5188-1bb6d9f5c74c.htm "WriteAsync 方法 (String, Byte[])")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| FreedomTcpNetWriteAsync 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/d8223df7-ab96-1c84-5188-1bb6d9f5c74c.htm)
...
|  |
| --- |
| FreedomTcpNetWriteAsync 方法 (String, Byte) |
...
[WriteAsync 重载](4036438c-90a8-4097-e79c-4003d7b27ff4.htm)
