# HslCommunication - HslCommunication.Robot.Estun
...
[原文連結](http://api.hslcommunication.cn/html/56c116ec-2055-c609-9e2a-bc99ff3556ed.htm)

HslCommunication Library Document

[HslCommunication Library Document](../html\c136d3de-eab7-9b0f-4bdf-d891297c8018.htm "HslCommunication Library Document")

[HslCommunication.Robot.Estun](../html/56c116ec-2055-c609-9e2a-bc99ff3556ed.htm "HslCommunication.Robot.Estun")

[EstunData 类](../html/41cc1b39-4204-1f44-1a8d-e9ba96a1ef79.htm "EstunData 类")

[EstunTcpNet 类](../html/cff3d107-8861-be9f-6c49-6fa0d9b5689f.htm "EstunTcpNet 类")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| HslCommunication.Robot.Estun 命名空间 |

[缺少 "N:HslCommunication.Robot.Estun" 的 <summary> 文档]

![](../icons/SectionExpanded.png)类

|  | 类 | 说明 |
| --- | --- | --- |
| 公共类 | [EstunData](41cc1b39-4204-1f44-1a8d-e9ba96a1ef79.htm) | 埃斯顿的数据类对象 |
| 公共类 | [EstunTcpNet](cff3d107-8861-be9f-6c49-6fa0d9b5689f.htm) | 一个埃斯顿的机器人的通信类，底层使用的是ModbusTCP协议，支持读取简单机器人数据，并且支持对机器人进行一些操作。  A communication class of Estun's robot, the bottom layer uses the ModbusTCP protocol, supports reading simple robot data, and supports some operations on the robot. |
...
[原文連結](http://api.hslcommunication.cn/html/52329a2a-e8bd-0dee-7cfd-8f4abaf72847.htm)
...
[EstunData 构造函数](../html/52329a2a-e8bd-0dee-7cfd-8f4abaf72847.htm "EstunData 构造函数 ")

[EstunData 构造函数](../html/08a8c9c7-383f-2bfc-d54a-318081a88951.htm "EstunData 构造函数 ")

[EstunData 构造函数 (Byte[], IByteTransform)](../html/66a3e59e-a392-14ff-4805-1ddbffc764c4.htm "EstunData 构造函数 (Byte[], IByteTransform)")
...
|  | 名称 | 说明 |
| --- | --- | --- |
| 公共方法 | [EstunData](08a8c9c7-383f-2bfc-d54a-318081a88951.htm) | 实例化一个默认的对象 |
| 公共方法 | [EstunData(Byte, IByteTransform)](66a3e59e-a392-14ff-4805-1ddbffc764c4.htm) | 使用指定的原始字节数据来实例化埃斯顿机器人对象 |
...
[EstunData 类](41cc1b39-4204-1f44-1a8d-e9ba96a1ef79.htm)

[HslCommunication.Robot.Estun 命名空间](56c116ec-2055-c609-9e2a-bc99ff3556ed.htm)
...
[原文連結](http://api.hslcommunication.cn/html/08a8c9c7-383f-2bfc-d54a-318081a88951.htm)
...
**命名空间：**
 [HslCommunication.Robot.Estun](56c116ec-2055-c609-9e2a-bc99ff3556ed.htm)  
**程序集：**
...
[EstunData 重载](52329a2a-e8bd-0dee-7cfd-8f4abaf72847.htm)
...
[原文連結](http://api.hslcommunication.cn/html/66a3e59e-a392-14ff-4805-1ddbffc764c4.htm)
...
new : 
        source : byte[] * 
        byteTransform : IByteTransform -> EstunData
```
...
[原文連結](http://api.hslcommunication.cn/html/19e3bbe7-57c0-8a7b-c291-c439ea03234c.htm)
...
[EstunData 属性](../html/b1cba462-b8e8-96f8-0c7c-edb7b996cff0.htm "EstunData 属性")

[AI 属性](../html/19e3bbe7-57c0-8a7b-c291-c439ea03234c.htm "AI 属性 ")

[AO 属性](../html/d5caf5a9-ac9c-f523-fffe-b55234df5888.htm "AO 属性 ")

[AutoMode 属性](../html/d7451fd3-b635-d8b1-83af-acab2f308cb2.htm "AutoMode 属性 ")

[DI 属性](../html/153f2f92-9512-42fe-aee3-2c5bfb2120c5.htm "DI 属性 ")

[DO 属性](../html/df54c392-0036-800b-3185-09c557da067b.htm "DO 属性 ")

[EnableStatus 属性](../html/d46777e0-4588-4b78-d312-3302664bece2.htm "EnableStatus 属性 ")

[ErrorStatus 属性](../html/46dfbd58-bbda-35d4-1ec1-6d3936f3c461.htm "ErrorStatus 属性 ")

[GlobalSpeedValue 属性](../html/31c2262d-f6d8-9a49-a711-3fb5e1c427a9.htm "GlobalSpeedValue 属性 ")

[ManualMode 属性](../html/ad226f6c-d1f2-8825-597e-a5f99ff35329.htm "ManualMode 属性 ")

[ProgramRunStatus 属性](../html/a4c395a7-0016-06b7-c81c-692c5a2a6784.htm "ProgramRunStatus 属性 ")

[ProjectName 属性](../html/279cb0b5-dac8-87d0-c2d4-36956281e50c.htm "ProjectName 属性 ")

[ReadWriteFlag 属性](../html/dbcaa12f-8f6a-c1b2-92dd-3b0e00006796.htm "ReadWriteFlag 属性 ")

[RemoteMode 属性](../html/41f7d9f9-32e8-64a5-618f-dae0932bd279.htm "RemoteMode 属性 ")

[RobotCommandStatus 属性](../html/6b7c2d24-df02-4623-5451-274cac929de7.htm "RobotCommandStatus 属性 ")

[RobotMoving 属性](../html/8fedc488-56d5-256c-75e5-d0bb9ec244ef.htm "RobotMoving 属性 ")

[RunStatus 属性](../html/fd3b0c25-b7f7-39dc-59e4-81566542a8dc.htm "RunStatus 属性 ")
...
```
member AI : float32[] with get, set
```
...
[原文連結](http://api.hslcommunication.cn/html/d7451fd3-b635-d8b1-83af-acab2f308cb2.htm)
...
```
member AutoMode : bool with get, set
```
...
[原文連結](http://api.hslcommunication.cn/html/153f2f92-9512-42fe-aee3-2c5bfb2120c5.htm)
...
[原文連結](http://api.hslcommunication.cn/html/df54c392-0036-800b-3185-09c557da067b.htm)
...
[原文連結](http://api.hslcommunication.cn/html/46dfbd58-bbda-35d4-1ec1-6d3936f3c461.htm)
...
```
Public Property ErrorStatus As Boolean
	Get
	Set
```
...
```
member ErrorStatus : bool with get, set
```
...
[原文連結](http://api.hslcommunication.cn/html/31c2262d-f6d8-9a49-a711-3fb5e1c427a9.htm)
...
```
Public Property GlobalSpeedValue As Short
	Get
	Set
```
...
```
public:
property short GlobalSpeedValue {
	short get ();
...
```
member GlobalSpeedValue : int16 with get, set
```
...
[原文連結](http://api.hslcommunication.cn/html/ad226f6c-d1f2-8825-597e-a5f99ff35329.htm)
...
```
Public Property ManualMode As Boolean
	Get
	Set
```
...
```
member ManualMode : bool with get, set
```
...
[原文連結](http://api.hslcommunication.cn/html/a4c395a7-0016-06b7-c81c-692c5a2a6784.htm)
...
```
Public Property ProgramRunStatus As Boolean
	Get
	Set
```
...
```
public:
property bool ProgramRunStatus {
	bool get ();
	void set (bool value);
}
```
...
```
member ProgramRunStatus : bool with get, set
```
...
[原文連結](http://api.hslcommunication.cn/html/279cb0b5-dac8-87d0-c2d4-36956281e50c.htm)
...
[原文連結](http://api.hslcommunication.cn/html/dbcaa12f-8f6a-c1b2-92dd-3b0e00006796.htm)
...
```
Public Property ReadWriteFlag As Short
	Get
	Set
```
...
```
member ReadWriteFlag : int16 with get, set
```
...
[原文連結](http://api.hslcommunication.cn/html/41f7d9f9-32e8-64a5-618f-dae0932bd279.htm)
...
```
Public Property RemoteMode As Boolean
	Get
	Set
```
...
```
member RemoteMode : bool with get, set
```
...
---
## RobotCommandStatus 属性 

[原文連結](http://api.hslcommunication.cn/html/6b7c2d24-df02-4623-5451-274cac929de7.htm)
...
[原文連結](http://api.hslcommunication.cn/html/8fedc488-56d5-256c-75e5-d0bb9ec244ef.htm)
...
```
Public Property RobotMoving As Boolean
	Get
	Set
```
...
```
member RobotMoving : bool with get, set
```
...
[原文連結](http://api.hslcommunication.cn/html/fd3b0c25-b7f7-39dc-59e4-81566542a8dc.htm)
...
```
Public Property RunStatus As Boolean
	Get
	Set
```
...
```
member RunStatus : bool with get, set
```
...
[原文連結](http://api.hslcommunication.cn/html/20c93f17-3f5e-2a7f-fe76-fbf1fe86a34d.htm)
...
[EstunData 方法](../html/20c93f17-3f5e-2a7f-fe76-fbf1fe86a34d.htm "EstunData 方法")

[LoadBySourceData 方法](../html/c716bcfd-1846-681d-56bf-25c85d3dbcea.htm "LoadBySourceData 方法 ")
...
[EstunData](41cc1b39-4204-1f44-1a8d-e9ba96a1ef79.htm) 类型公开以下成员。
...
| 公共方法 | [LoadBySourceData](c716bcfd-1846-681d-56bf-25c85d3dbcea.htm) | 从原始的字节数据里加载 |
...
[原文連結](http://api.hslcommunication.cn/html/c716bcfd-1846-681d-56bf-25c85d3dbcea.htm)
...
```
member LoadBySourceData : 
        source : byte[] * 
        byteTransform : IByteTransform -> unit 
```
...
[原文連結](http://api.hslcommunication.cn/html/cff3d107-8861-be9f-6c49-6fa0d9b5689f.htm)
...
[EstunTcpNet 构造函数](../html/86d77d0d-9dd0-b736-d317-380ee26268ee.htm "EstunTcpNet 构造函数 ")

[EstunTcpNet 属性](../html/6191f170-c7eb-1b29-855b-ca5b631d85b2.htm "EstunTcpNet 属性")

[EstunTcpNet 方法](../html/88ba3e5e-0fb2-00ce-1b40-fe9d367a5d27.htm "EstunTcpNet 方法")

[EstunTcpNet 字段](../html/f69f1cc3-8cf4-8fcf-fdcd-9f89bb89c56f.htm "EstunTcpNet 字段")
...
一个埃斯顿的机器人的通信类，底层使用的是ModbusTCP协议，支持读取简单机器人数据，并且支持对机器人进行一些操作。  
...
          HslCommunication.Robot.EstunEstunTcpNet
...
```
Public Class EstunTcpNet
	Inherits ModbusTcpNet
```

```
public ref class EstunTcpNet : public ModbusTcpNet
```
...
EstunTcpNet 类型公开以下成员。

![](../icons/SectionExpanded.png)构造函数

|  | 名称 | 说明 |
| --- | --- | --- |
| 公共方法 | [EstunTcpNet](aff6b470-6da1-b279-a64e-9144d41b7cd7.htm) | 实例化一个Modbus-Tcp协议的客户端对象  Instantiate a client object of the Modbus-Tcp protocol |
| 公共方法 | [EstunTcpNet(String, Int32, Byte)](eb7ec22b-b53d-696d-dbc2-e89df7451f37.htm) | 指定服务器地址，端口号，客户端自己的站号来初始化  Specify the server address, port number, and client's own station number to initialize |
...
| 受保护的方法 | [GetNewNetMessage](c15715fd-c770-77f9-93e1-abde9e33b17d.htm) | 获取一个新的消息对象的方法，需要在继承类里面进行重写  The method to get a new message object needs to be overridden in the inheritance class (继承自 [ModbusTcpNet](8b0255a2-7125-a4ed-7a9c-14314e33603a.htm)。) |
| 公共方法 | GetType | (继承自 Object。) |
...
| 公共方法 | [ReadRobotData](a3b1b0b9-964f-5710-95bf-68c24fc632e4.htm) | 读取埃斯顿的机器人的数据 |
...
| 公共方法 | [RobotCommandStatusRestart](71661a9c-45c2-866b-932b-dd55e6d4fe34.htm) | 重置机器人的命令状态 |
| 公共方法 | [RobotLoadProject](c750f6a0-e757-4b20-4afd-1410343654a9.htm) | 机器人重新装载程序名 |
| 公共方法 | [RobotResetError](3a503bb5-ade0-e243-e03d-d3f3f6492ab2.htm) | 机器人的错误进行复位 |
| 公共方法 | [RobotSetGlobalSpeedValue](0190610d-625d-6880-d88b-afecd0165ec3.htm) | 机器人设置全局速度值 |
| 公共方法 | [RobotStartPrograme](f66cb514-89f6-69db-c0de-85399fb85b66.htm) | 机器人程序启动 |
| 公共方法 | [RobotStopPrograme](3e7f3066-2480-fba3-3f67-3a0e9ad56617.htm) | 机器人程序停止 |
| 公共方法 | [RobotUnregisterProject](433fa791-9eb6-61e4-4e52-377f51215537.htm) | 机器人卸载程序名 |
...
| 公共方法 | [ToString](b62a8a16-d90d-cb5f-bf58-5b11e07e95ce.htm) | (重写 [ModbusTcpNetToString](14f25d02-723d-25f8-5839-3d2ed9ff1c97.htm).) |
...
[原文連結](http://api.hslcommunication.cn/html/86d77d0d-9dd0-b736-d317-380ee26268ee.htm)
...
[EstunTcpNet 构造函数](../html/aff6b470-6da1-b279-a64e-9144d41b7cd7.htm "EstunTcpNet 构造函数 ")

[EstunTcpNet 构造函数 (String, Int32, Byte)](../html/eb7ec22b-b53d-696d-dbc2-e89df7451f37.htm "EstunTcpNet 构造函数 (String, Int32, Byte)")
...
[EstunTcpNet 类](cff3d107-8861-be9f-6c49-6fa0d9b5689f.htm)
...
[原文連結](http://api.hslcommunication.cn/html/aff6b470-6da1-b279-a64e-9144d41b7cd7.htm)
...
[EstunTcpNet 重载](86d77d0d-9dd0-b736-d317-380ee26268ee.htm)
...
---
## EstunTcpNet 构造函数 (String, Int32, Byte)

[原文連結](http://api.hslcommunication.cn/html/eb7ec22b-b53d-696d-dbc2-e89df7451f37.htm)
...
[原文連結](http://api.hslcommunication.cn/html/6191f170-c7eb-1b29-855b-ca5b631d85b2.htm)
...
[EstunTcpNet](cff3d107-8861-be9f-6c49-6fa0d9b5689f.htm) 类型公开以下成员。
...
[原文連結](http://api.hslcommunication.cn/html/88ba3e5e-0fb2-00ce-1b40-fe9d367a5d27.htm)
...
[ReadRobotData 方法](../html/a3b1b0b9-964f-5710-95bf-68c24fc632e4.htm "ReadRobotData 方法 ")

[RobotCommandStatusRestart 方法](../html/71661a9c-45c2-866b-932b-dd55e6d4fe34.htm "RobotCommandStatusRestart 方法 ")

[RobotLoadProject 方法](../html/c750f6a0-e757-4b20-4afd-1410343654a9.htm "RobotLoadProject 方法 ")

[RobotResetError 方法](../html/3a503bb5-ade0-e243-e03d-d3f3f6492ab2.htm "RobotResetError 方法 ")

[RobotSetGlobalSpeedValue 方法](../html/0190610d-625d-6880-d88b-afecd0165ec3.htm "RobotSetGlobalSpeedValue 方法 ")

[RobotStartPrograme 方法](../html/f66cb514-89f6-69db-c0de-85399fb85b66.htm "RobotStartPrograme 方法 ")

[RobotStopPrograme 方法](../html/3e7f3066-2480-fba3-3f67-3a0e9ad56617.htm "RobotStopPrograme 方法 ")

[RobotUnregisterProject 方法](../html/433fa791-9eb6-61e4-4e52-377f51215537.htm "RobotUnregisterProject 方法 ")

[ToString 方法](../html/b62a8a16-d90d-cb5f-bf58-5b11e07e95ce.htm "ToString 方法 ")
