# HslCommunication - HslCommunication.Profinet.Toyota
...
[原文連結](http://api.hslcommunication.cn/html/6e1a37f5-73ed-a07e-bb06-d37949891359.htm)

HslCommunication Library Document

[HslCommunication Library Document](../html\c136d3de-eab7-9b0f-4bdf-d891297c8018.htm "HslCommunication Library Document")

[HslCommunication.Profinet.Toyota](../html/6e1a37f5-73ed-a07e-bb06-d37949891359.htm "HslCommunication.Profinet.Toyota")

[ToyoPuc 类](../html/fa368713-1f68-4423-3ee7-29ed07c31772.htm "ToyoPuc 类")

[ToyoPucServer 类](../html/640f9523-0532-1e97-b3dc-3818523b70f7.htm "ToyoPucServer 类")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| HslCommunication.Profinet.Toyota 命名空间 |

[缺少 "N:HslCommunication.Profinet.Toyota" 的 <summary> 文档]

![](../icons/SectionExpanded.png)类

|  | 类 | 说明 |
| --- | --- | --- |
| 公共类 | [ToyoPuc](fa368713-1f68-4423-3ee7-29ed07c31772.htm) | 丰田工机的计算机链接协议实现，通过2PORT-EFR模块实现对PLC的读写数据操作，需要在PLC配置相关的以太网端口信息，才能进行通信。具体的地址参考DEMO程序信息。  Toyota Gongki's computer link protocol realizes the reading and writing data operation of the PLC through the 2PORT-EFR module, and the relevant Ethernet port information needs to be configured in the PLC in order to communicate. For specific addresses, refer to Demo UI. |
| 公共类 | [ToyoPucServer](640f9523-0532-1e97-b3dc-3818523b70f7.htm) | 丰田工机的PLC对象信息 |
...
[原文連結](http://api.hslcommunication.cn/html/d9091810-6f34-d020-a807-757b9c7e348b.htm)
...
[ToyoPuc 构造函数](../html/d9091810-6f34-d020-a807-757b9c7e348b.htm "ToyoPuc 构造函数 ")

[ToyoPuc 构造函数](../html/c9c22962-ee74-74af-a97e-11b7c39eaff8.htm "ToyoPuc 构造函数 ")

[ToyoPuc 构造函数 (String, Int32)](../html/1d7caed2-a5ba-c83e-8ed1-85b36f08a99f.htm "ToyoPuc 构造函数 (String, Int32)")
...
|  | 名称 | 说明 |
| --- | --- | --- |
| 公共方法 | [ToyoPuc](c9c22962-ee74-74af-a97e-11b7c39eaff8.htm) | 实例化一个默认的对象 |
| 公共方法 | [ToyoPuc(String, Int32)](1d7caed2-a5ba-c83e-8ed1-85b36f08a99f.htm) | 指定IP地址，端口号信息来实例化一个对象 |
...
[ToyoPuc 类](fa368713-1f68-4423-3ee7-29ed07c31772.htm)

[HslCommunication.Profinet.Toyota 命名空间](6e1a37f5-73ed-a07e-bb06-d37949891359.htm)
...
[原文連結](http://api.hslcommunication.cn/html/c9c22962-ee74-74af-a97e-11b7c39eaff8.htm)
...
**命名空间：**
 [HslCommunication.Profinet.Toyota](6e1a37f5-73ed-a07e-bb06-d37949891359.htm)  
**程序集：**
...
[ToyoPuc 重载](d9091810-6f34-d020-a807-757b9c7e348b.htm)
...
---
## ToyoPuc 构造函数 (String, Int32)

[原文連結](http://api.hslcommunication.cn/html/1d7caed2-a5ba-c83e-8ed1-85b36f08a99f.htm)
...
[原文連結](http://api.hslcommunication.cn/html/6e273313-f144-4dce-7245-25084de5a3af.htm)
...
[ToyoPuc 属性](../html/6e273313-f144-4dce-7245-25084de5a3af.htm "ToyoPuc 属性")

[ToyoPuc 方法](../html/e049752a-33ef-8e36-736a-6c3f92be2d90.htm "ToyoPuc 方法")

[ToyoPuc 字段](../html/011ba09b-bd99-047b-8725-bb27890ae11d.htm "ToyoPuc 字段")
...
[ToyoPuc](fa368713-1f68-4423-3ee7-29ed07c31772.htm) 类型公开以下成员。
...
[原文連結](http://api.hslcommunication.cn/html/e049752a-33ef-8e36-736a-6c3f92be2d90.htm)
...
[GetNewNetMessage 方法](../html/65b83e40-137b-a5f7-0b39-e4ed5d2c00ad.htm "GetNewNetMessage 方法 ")

[PackCommandWithHeader 方法](../html/dabf8cf9-7144-6bfe-e28e-e4b1b496e988.htm "PackCommandWithHeader 方法 ")

[Read 方法](../html/ff71d90c-9313-842a-8f53-1a24f45f3233.htm "Read 方法 ")

[ReadAsync 方法](../html/31bf43f7-c008-cd11-9616-0f73bd0ba9b1.htm "ReadAsync 方法 ")

[ReadBool 方法](../html/bd2a74e9-a086-9025-9d21-e77b94fad451.htm "ReadBool 方法 ")

[ReadBoolAsync 方法](../html/cd69501d-6136-6c51-2fc6-375160b29c8f.htm "ReadBoolAsync 方法 ")

[ReadRandom 方法](../html/dbd6403c-359e-3dc9-a4bd-ca3c3f1b3f45.htm "ReadRandom 方法 ")

[ReadRandomAsync 方法](../html/a63b597a-aae5-7483-b29d-901c9e52689c.htm "ReadRandomAsync 方法 ")

[ToString 方法](../html/ed40385d-1ef9-7aa1-32f8-4b817551403c.htm "ToString 方法 ")

[UnpackResponseContent 方法](../html/6077da74-8670-0161-bbec-af19efa9db2b.htm "UnpackResponseContent 方法 ")

[Write 方法](../html/f26d45fa-a3b9-ed57-8903-5d07a61ea3e6.htm "Write 方法 ")

[WriteAsync 方法](../html/5cac05f7-95f2-a565-db36-ac5d8acf15b7.htm "WriteAsync 方法 ")
...
| 受保护的方法 | [GetNewNetMessage](65b83e40-137b-a5f7-0b39-e4ed5d2c00ad.htm) | 获取一个新的消息对象的方法，需要在继承类里面进行重写  The method to get a new message object needs to be overridden in the inheritance class (重写 [BinaryCommunicationGetNewNetMessage](16636a1b-a6f0-9c0f-9d9c-c94e26c67459.htm).) |
...
| 公共方法 | [PackCommandWithHeader](dabf8cf9-7144-6bfe-e28e-e4b1b496e988.htm) | 对当前的命令进行打包处理，通常是携带命令头内容，标记当前的命令的长度信息，需要进行重写，否则默认不打包  The current command is packaged, usually carrying the content of the command header, marking the length of the current command, and it needs to be rewritten, otherwise it is not packaged by default (重写 [BinaryCommunicationPackCommandWithHeader(Byte)](d0b2cd76-c306-11fc-38c7-af8ad306cce7.htm).) |
| 公共方法 | [Read(String, UInt16)](1aed76aa-b91b-9cf2-ad8a-fcadb7cf1d7d.htm) | 批量读取字节数组信息，需要指定地址和长度，返回原始的字节数组  Batch read byte array information, need to specify the address and length, return the original byte array (重写 [DeviceCommunicationRead(String, UInt16)](9dd09452-c200-bc65-75ff-69aa34b366d4.htm).) |
...
| 公共方法 | [ReadAsync(String, UInt16)](835bb2ea-9678-99c6-f23d-c1f95c25eee8.htm) | 批量读取字节数组信息，需要指定地址和长度，返回原始的字节数组  Batch read byte array information, need to specify the address and length, return the original byte array (重写 [DeviceCommunicationReadAsync(String, UInt16)](d8c14d37-56dc-2a31-1a19-3e2b5b65197d.htm).) |
...
| 公共方法 | [ReadBool(String, UInt16)](253168fa-d143-ada7-947e-e13d361154fa.htm) | 批量读取Boolean数组信息，需要指定地址和长度，返回Boolean 数组  Batch read Boolean array information, need to specify the address and length, return Boolean array (重写 [DeviceCommunicationReadBool(String, UInt16)](69d0d24f-34a7-5b41-5c1b-619edc7e6b54.htm).) |
...
| 公共方法 | [ReadBoolAsync(String, UInt16)](ec8c8809-040c-1133-1656-8bfc33493161.htm) | 批量读取Boolean数组信息，需要指定地址和长度，返回Boolean 数组  Batch read Boolean array information, need to specify the address and length, return Boolean array (重写 [DeviceCommunicationReadBoolAsync(String, UInt16)](a45d383d-0095-3ea7-32f8-e75af88d60f8.htm).) |
...
| 公共方法 | [ReadRandom](dbd6403c-359e-3dc9-a4bd-ca3c3f1b3f45.htm) | 随机读取字地址的数据，可以一次性读取多个地址的数据，返回原始字节类型，需要自己做一些二次分析操作  Random read word address data, you can read multiple address data at one time, return the original byte type, you need to do some secondary analysis operations |
| 公共方法 | [ReadRandomAsync](a63b597a-aae5-7483-b29d-901c9e52689c.htm) | 随机读取字地址的数据，可以一次性读取多个地址的数据，返回原始字节类型，需要自己做一些二次分析操作  Random read word address data, you can read multiple address data at one time, return the original byte type, you need to do some secondary analysis operations |
...
| 公共方法 | [Write(String, Boolean)](871bdaaa-3f8b-2e55-e8ce-726d5a99a074.htm) | 写入单个的Boolean数据，返回是否成功  Write a single Boolean data, and return whether the write was successful (重写 [DeviceCommunicationWrite(String, Boolean)](06d0b9af-7f28-0b9c-098f-4da28e69504a.htm).) |
| 公共方法 | [Write(String, Boolean)](dca5d4bd-60b8-7a82-1dc7-d89feb29846e.htm) | 批量写入Boolean数组数据，返回是否成功  Batch write Boolean array data, return whether the write was successful (重写 [DeviceCommunicationWrite(String, Boolean)](5b046c82-3d8e-550b-fdf3-41ca5558169b.htm).) |
| 公共方法 | [Write(String, Byte)](75792e96-761f-0420-632b-b16fc1146166.htm) | 写入原始的byte数组数据到指定的地址，返回是否写入成功  Write the original byte array data to the specified address, and return whether the write was successful (重写 [DeviceCommunicationWrite(String, Byte)](b5536dd6-ccde-6883-ac27-bff9e4b37806.htm).) |
...
| 公共方法 | [WriteAsync(String, Boolean)](bf207d64-ea3f-96d3-eb38-abcf2c331738.htm) | 写入单个的Boolean数据，返回是否成功  Write a single Boolean data, and return whether the write was successful (重写 [DeviceCommunicationWriteAsync(String, Boolean)](10fe669c-805e-1e5a-f016-f319ad363e90.htm).) |
| 公共方法 | [WriteAsync(String, Boolean)](ab3a54c7-febf-f4c1-4c2c-b27fc9026b7f.htm) | 异步批量写入Boolean数组数据，返回是否成功  Asynchronously batch write Boolean array data, return success (重写 [DeviceCommunicationWriteAsync(String, Boolean)](fe872dae-7ef9-12c1-d883-e92ba8676416.htm).) |
| 公共方法 | [WriteAsync(String, Byte)](fa6559e3-7971-7a0a-b7e9-fca0904d9661.htm) | 写入原始的byte数组数据到指定的地址，返回是否写入成功  Write the original byte array data to the specified address, and return whether the write was successful (重写 [DeviceCommunicationWriteAsync(String, Byte)](8f1cec30-8b86-6749-c8f3-7d39168d59df.htm).) |
...
[原文連結](http://api.hslcommunication.cn/html/65b83e40-137b-a5f7-0b39-e4ed5d2c00ad.htm)
...
[原文連結](http://api.hslcommunication.cn/html/dabf8cf9-7144-6bfe-e28e-e4b1b496e988.htm)
...
|  |
| --- |
| ToyoPucPackCommandWithHeader 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/ff71d90c-9313-842a-8f53-1a24f45f3233.htm)
...
[Read 方法 (String, UInt16)](../html/1aed76aa-b91b-9cf2-ad8a-fcadb7cf1d7d.htm "Read 方法 (String, UInt16)")
...
[原文連結](http://api.hslcommunication.cn/html/1aed76aa-b91b-9cf2-ad8a-fcadb7cf1d7d.htm)
...
[Read 重载](ff71d90c-9313-842a-8f53-1a24f45f3233.htm)
...
[原文連結](http://api.hslcommunication.cn/html/31bf43f7-c008-cd11-9616-0f73bd0ba9b1.htm)
...
[ReadAsync 方法 (String, UInt16)](../html/835bb2ea-9678-99c6-f23d-c1f95c25eee8.htm "ReadAsync 方法 (String, UInt16)")
...
[原文連結](http://api.hslcommunication.cn/html/835bb2ea-9678-99c6-f23d-c1f95c25eee8.htm)
...
|  |
| --- |
| ToyoPucReadAsync 方法 (String, UInt16) |
...
[ReadAsync 重载](31bf43f7-c008-cd11-9616-0f73bd0ba9b1.htm)
...
[原文連結](http://api.hslcommunication.cn/html/bd2a74e9-a086-9025-9d21-e77b94fad451.htm)
...
[ReadBool 方法 (String, UInt16)](../html/253168fa-d143-ada7-947e-e13d361154fa.htm "ReadBool 方法 (String, UInt16)")
...
[原文連結](http://api.hslcommunication.cn/html/253168fa-d143-ada7-947e-e13d361154fa.htm)
...
|  |
| --- |
| ToyoPucReadBool 方法 (String, UInt16) |
...
[ReadBool 重载](bd2a74e9-a086-9025-9d21-e77b94fad451.htm)
...
[原文連結](http://api.hslcommunication.cn/html/cd69501d-6136-6c51-2fc6-375160b29c8f.htm)
...
[ReadBoolAsync 方法 (String, UInt16)](../html/ec8c8809-040c-1133-1656-8bfc33493161.htm "ReadBoolAsync 方法 (String, UInt16)")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| ToyoPucReadBoolAsync 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/ec8c8809-040c-1133-1656-8bfc33493161.htm)
...
|  |
| --- |
| ToyoPucReadBoolAsync 方法 (String, UInt16) |
...
[ReadBoolAsync 重载](cd69501d-6136-6c51-2fc6-375160b29c8f.htm)
...
[原文連結](http://api.hslcommunication.cn/html/dbd6403c-359e-3dc9-a4bd-ca3c3f1b3f45.htm)
...
[原文連結](http://api.hslcommunication.cn/html/ed40385d-1ef9-7aa1-32f8-4b817551403c.htm)
...
[缺少 "M:HslCommunication.Profinet.Toyota.ToyoPuc.ToString" 的 <summary> 文档]
...
[缺少 "M:HslCommunication.Profinet.Toyota.ToyoPuc.ToString" 的 <returns> 文档]
...
[原文連結](http://api.hslcommunication.cn/html/6077da74-8670-0161-bbec-af19efa9db2b.htm)
...
[原文連結](http://api.hslcommunication.cn/html/f26d45fa-a3b9-ed57-8903-5d07a61ea3e6.htm)
...
[Write 方法 (String, Boolean)](../html/871bdaaa-3f8b-2e55-e8ce-726d5a99a074.htm "Write 方法 (String, Boolean)")

[Write 方法 (String, Boolean[])](../html/dca5d4bd-60b8-7a82-1dc7-d89feb29846e.htm "Write 方法 (String, Boolean[])")

[Write 方法 (String, Byte[])](../html/75792e96-761f-0420-632b-b16fc1146166.htm "Write 方法 (String, Byte[])")
...
[原文連結](http://api.hslcommunication.cn/html/871bdaaa-3f8b-2e55-e8ce-726d5a99a074.htm)
...
|  |
| --- |
| ToyoPucWrite 方法 (String, Boolean) |
...
[Write 重载](f26d45fa-a3b9-ed57-8903-5d07a61ea3e6.htm)
...
[原文連結](http://api.hslcommunication.cn/html/dca5d4bd-60b8-7a82-1dc7-d89feb29846e.htm)
...
[原文連結](http://api.hslcommunication.cn/html/75792e96-761f-0420-632b-b16fc1146166.htm)
...
[原文連結](http://api.hslcommunication.cn/html/5cac05f7-95f2-a565-db36-ac5d8acf15b7.htm)
...
[WriteAsync 方法 (String, Boolean)](../html/bf207d64-ea3f-96d3-eb38-abcf2c331738.htm "WriteAsync 方法 (String, Boolean)")

[WriteAsync 方法 (String, Boolean[])](../html/ab3a54c7-febf-f4c1-4c2c-b27fc9026b7f.htm "WriteAsync 方法 (String, Boolean[])")

[WriteAsync 方法 (String, Byte[])](../html/fa6559e3-7971-7a0a-b7e9-fca0904d9661.htm "WriteAsync 方法 (String, Byte[])")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| ToyoPucWriteAsync 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/bf207d64-ea3f-96d3-eb38-abcf2c331738.htm)
...
|  |
| --- |
| ToyoPucWriteAsync 方法 (String, Boolean) |
...
[IReadWriteNetWriteAsync(String, Boolean)](559924da-b298-9c81-794f-83d53aafc602.htm)
...
[WriteAsync 重载](5cac05f7-95f2-a565-db36-ac5d8acf15b7.htm)
...
[原文連結](http://api.hslcommunication.cn/html/ab3a54c7-febf-f4c1-4c2c-b27fc9026b7f.htm)
...
[原文連結](http://api.hslcommunication.cn/html/fa6559e3-7971-7a0a-b7e9-fca0904d9661.htm)
...
|  |
| --- |
| ToyoPucWriteAsync 方法 (String, Byte) |
...
[原文連結](http://api.hslcommunication.cn/html/011ba09b-bd99-047b-8725-bb27890ae11d.htm)
