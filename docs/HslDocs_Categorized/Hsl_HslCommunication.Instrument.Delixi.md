# HslCommunication - HslCommunication.Instrument.Delixi
...
---
## HslCommunication.Instrument.Delixi

[原文連結](http://api.hslcommunication.cn/html/224b290c-9d48-4258-2092-4c2a23001eb4.htm)

HslCommunication Library Document

[HslCommunication Library Document](../html\c136d3de-eab7-9b0f-4bdf-d891297c8018.htm "HslCommunication Library Document")

[HslCommunication.Instrument.Delixi](../html/224b290c-9d48-4258-2092-4c2a23001eb4.htm "HslCommunication.Instrument.Delixi")

[DTSU6606Serial 类](../html/8ecc0544-1c32-f6e2-cb46-145c1ce9701e.htm "DTSU6606Serial 类")

[ElectricalParameters 类](../html/72d4da7c-80dc-14aa-b44e-73804d0909a9.htm "ElectricalParameters 类")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| HslCommunication.Instrument.Delixi 命名空间 |

[缺少 "N:HslCommunication.Instrument.Delixi" 的 <summary> 文档]

![](../icons/SectionExpanded.png)类

|  | 类 | 说明 |
| --- | --- | --- |
| 公共类 | [DTSU6606Serial](8ecc0544-1c32-f6e2-cb46-145c1ce9701e.htm) | DTSU6606型三相四线电子式电能表的Modbus-RTU通信协议 |
| 公共类 | [ElectricalParameters](72d4da7c-80dc-14aa-b44e-73804d0909a9.htm) | 电参数类 |
...
[原文連結](http://api.hslcommunication.cn/html/8ecc0544-1c32-f6e2-cb46-145c1ce9701e.htm)
...
[DTSU6606Serial 构造函数](../html/18723e2e-0a9d-d8df-9542-3841ddeeb15c.htm "DTSU6606Serial 构造函数 ")

[DTSU6606Serial 属性](../html/4b12189a-a017-bd77-1677-82dacba940b8.htm "DTSU6606Serial 属性")

[DTSU6606Serial 方法](../html/64d75dff-f92b-4586-50a3-7aabf00de751.htm "DTSU6606Serial 方法")

[DTSU6606Serial 字段](../html/6ee72806-85c5-3338-bd71-7e873eb0ae1d.htm "DTSU6606Serial 字段")
...
          HslCommunication.Instrument.DelixiDTSU6606Serial

**命名空间：**
 [HslCommunication.Instrument.Delixi](224b290c-9d48-4258-2092-4c2a23001eb4.htm)  
**程序集：**
...
```
Public Class DTSU6606Serial
	Inherits ModbusRtu
```

```
public ref class DTSU6606Serial : public ModbusRtu
```
...
DTSU6606Serial 类型公开以下成员。

![](../icons/SectionExpanded.png)构造函数

|  | 名称 | 说明 |
| --- | --- | --- |
| 公共方法 | [DTSU6606Serial](d2f1d3ce-0c43-d888-2b14-7cb89560116d.htm) | 实例化一个Modbus-Rtu协议的客户端对象  Instantiate a client object of the Modbus-Rtu protocol |
| 公共方法 | [DTSU6606Serial(Byte)](50b1f90c-07b3-133f-0c1e-961474ed6527.htm) | 指定客户端自己的站号来初始化  Specify the client's own station number to initialize |
...
| 公共方法 | [ReadElectricalParameters](1f9db265-9456-d262-32c0-a997436d614b.htm) | 读取电表的电参数类，主要包含电压，电流，频率，有功功率，无功功率，视在功率，功率因数  Read the electrical parameters of the meter, including voltage, current, frequency, active power, reactive power, apparent power, and power factor |
...
| 公共方法 | [ToString](3c5cfa64-0ab4-4337-feda-0d9cdef607d0.htm) | (重写 [ModbusRtuToString](11f9cb41-d3e4-d45d-abd1-36e7bb2577e6.htm).) |
...
[HslCommunication.Instrument.Delixi 命名空间](224b290c-9d48-4258-2092-4c2a23001eb4.htm)
...
[原文連結](http://api.hslcommunication.cn/html/18723e2e-0a9d-d8df-9542-3841ddeeb15c.htm)
...
[DTSU6606Serial 构造函数](../html/d2f1d3ce-0c43-d888-2b14-7cb89560116d.htm "DTSU6606Serial 构造函数 ")

[DTSU6606Serial 构造函数 (Byte)](../html/50b1f90c-07b3-133f-0c1e-961474ed6527.htm "DTSU6606Serial 构造函数 (Byte)")
...
[DTSU6606Serial 类](8ecc0544-1c32-f6e2-cb46-145c1ce9701e.htm)
...
[原文連結](http://api.hslcommunication.cn/html/d2f1d3ce-0c43-d888-2b14-7cb89560116d.htm)
...
[DTSU6606Serial 重载](18723e2e-0a9d-d8df-9542-3841ddeeb15c.htm)
...
---
## DTSU6606Serial 构造函数 (Byte)

[原文連結](http://api.hslcommunication.cn/html/50b1f90c-07b3-133f-0c1e-961474ed6527.htm)
...
[原文連結](http://api.hslcommunication.cn/html/4b12189a-a017-bd77-1677-82dacba940b8.htm)
...
[DTSU6606Serial](8ecc0544-1c32-f6e2-cb46-145c1ce9701e.htm) 类型公开以下成员。
...
[原文連結](http://api.hslcommunication.cn/html/64d75dff-f92b-4586-50a3-7aabf00de751.htm)
...
[ReadElectricalParameters 方法](../html/1f9db265-9456-d262-32c0-a997436d614b.htm "ReadElectricalParameters 方法 ")

[ToString 方法](../html/3c5cfa64-0ab4-4337-feda-0d9cdef607d0.htm "ToString 方法 ")
...
---
## ReadElectricalParameters 方法 

[原文連結](http://api.hslcommunication.cn/html/1f9db265-9456-d262-32c0-a997436d614b.htm)
...
|  |
| --- |
| DTSU6606SerialReadElectricalParameters 方法 |
...
```
Public Function ReadElectricalParameters As OperateResult(Of ElectricalParameters)
```

```
public:
OperateResult<ElectricalParameters^>^ ReadElectricalParameters()
```

```
member ReadElectricalParameters : unit -> OperateResult<ElectricalParameters> 
```

#### 返回值

类型：[OperateResult](cf3af065-3e0e-e0ad-7063-8d7eab691b48.htm)[ElectricalParameters](72d4da7c-80dc-14aa-b44e-73804d0909a9.htm)  
包含是否成功的电表结果对象
...
[原文連結](http://api.hslcommunication.cn/html/3c5cfa64-0ab4-4337-feda-0d9cdef607d0.htm)
...
|  |
| --- |
| DTSU6606SerialToString 方法 |

[缺少 "M:HslCommunication.Instrument.Delixi.DTSU6606Serial.ToString" 的 <summary> 文档]
...
[缺少 "M:HslCommunication.Instrument.Delixi.DTSU6606Serial.ToString" 的 <returns> 文档]
...
[原文連結](http://api.hslcommunication.cn/html/6ee72806-85c5-3338-bd71-7e873eb0ae1d.htm)
...
[原文連結](http://api.hslcommunication.cn/html/72d4da7c-80dc-14aa-b44e-73804d0909a9.htm)
...
[ElectricalParameters 构造函数](../html/080290c5-8853-4ae1-b673-fba65d3ed94a.htm "ElectricalParameters 构造函数 ")

[ElectricalParameters 属性](../html/6f69db8c-d0d8-6b07-c950-e809098b4bd4.htm "ElectricalParameters 属性")

[ElectricalParameters 方法](../html/67f67102-f7bf-d324-fade-969d401b540a.htm "ElectricalParameters 方法")
...
SystemObject  
  HslCommunication.Instrument.DelixiElectricalParameters
...
```
public ref class ElectricalParameters
```

```
type ElectricalParameters =  class end
```
...
|  | 名称 | 说明 |
| --- | --- | --- |
| 公共方法 | [ElectricalParameters](080290c5-8853-4ae1-b673-fba65d3ed94a.htm) | 初始化 ElectricalParameters 类的一个新实例 |
...
|  | 名称 | 说明 |
| --- | --- | --- |
| 公共属性 | [CurrentA](ce8f492c-a505-b0c0-5e74-3a2ada070bd3.htm) | A相电流，单位A |
| 公共属性 | [CurrentB](c60844e4-288e-f139-0664-99b9868ed845.htm) | B相电流，单位A |
| 公共属性 | [CurrentC](51f801ce-0091-8142-62ff-ec1b5d7c4ea3.htm) | C相电流，单位A |
| 公共属性 | [Frequency](bc7292ee-8d3d-1350-4bc0-6c0e74f49b08.htm) | 频率，Hz |
| 公共属性 | [InstantaneousActivePowerA](dc443e55-2642-073b-e815-19204076f9d4.htm) | 瞬时A相有功功率，单位 kw |
| 公共属性 | [InstantaneousActivePowerB](50772bd9-812a-a930-8cf3-6fd33a651690.htm) | 瞬时B相有功功率，单位 kw |
| 公共属性 | [InstantaneousActivePowerC](3c785b2b-16b7-6bf3-0b8f-e261c82224b0.htm) | 瞬时C相有功功率，单位 kw |
| 公共属性 | [InstantaneousApparentPowerA](4782e154-76e5-3211-e4c0-6766c58356ed.htm) | 瞬时A相视在功率，单位 kVA |
| 公共属性 | [InstantaneousApparentPowerB](edae7ce7-b97c-f86a-9d6e-7c259f9b459e.htm) | 瞬时B相视在功率，单位 kVA |
| 公共属性 | [InstantaneousApparentPowerC](e4b172ec-689c-573d-5590-6948abc6a135.htm) | 瞬时C相视在功率，单位 kVA |
| 公共属性 | [InstantaneousReactivePowerA](caff9674-aee5-c19f-ddc1-587032a96096.htm) | 瞬时A相无功功率，单位 kvar |
| 公共属性 | [InstantaneousReactivePowerB](cc3a7bb4-14c2-e076-d82a-819d9cd585e0.htm) | 瞬时B相无功功率，单位 kvar |
| 公共属性 | [InstantaneousReactivePowerC](d59b5464-08ac-698f-6160-5fa4ea102b53.htm) | 瞬时C相无功功率，单位 kvar |
| 公共属性 | [InstantaneousTotalActivePower](65a93006-61a9-c934-5003-35b1590c3cd5.htm) | 瞬时总有功功率，单位 kw |
| 公共属性 | [InstantaneousTotalApparentPower](b123e97a-7f62-dbdf-804e-f8c9a0098105.htm) | 瞬时总视在功率，单位 kVA |
| 公共属性 | [InstantaneousTotalReactivePower](61bbf3f3-d541-22d8-72f9-a143a98d7ef2.htm) | 瞬时总无功功率，单位 kvar |
| 公共属性 | [PowerFactorA](57d25dfa-1654-defe-456e-197f8e6aa20c.htm) | A相功率因数 |
| 公共属性 | [PowerFactorB](b8ee337b-c6f6-08b4-1b63-1399b41076c3.htm) | B相功率因数 |
| 公共属性 | [PowerFactorC](e7917f22-7906-1e6b-ae73-4e57051a95d3.htm) | C相功率因数 |
| 公共属性 | [TotalPowerFactor](524bab87-fa12-46bf-7d5a-1f31dee5f229.htm) | 总功率因数 |
| 公共属性 | [VoltageA](a9d8464c-cd16-ece1-09c1-f0b5f3dcd2f4.htm) | A相电压，单位V |
| 公共属性 | [VoltageB](226b7b2e-e5bb-7abe-c67d-df870995d128.htm) | B相电压，单位V |
| 公共属性 | [VoltageC](5f73e840-9fbb-7404-fe28-74babd7f65a9.htm) | C相电压，单位V |
...
| 公共方法 | GetType | (继承自 Object。) |
| 受保护的方法 | MemberwiseClone | (继承自 Object。) |
| 公共方法静态成员 | [ParseFromDelixi](e0f505a9-9bc7-bb29-4729-ff639851378f.htm) | 根据德力西电表的原始字节数据，解析出真实的电量参数信息 |
...
---
## ElectricalParameters 构造函数 

[原文連結](http://api.hslcommunication.cn/html/080290c5-8853-4ae1-b673-fba65d3ed94a.htm)
...
初始化 [ElectricalParameters](72d4da7c-80dc-14aa-b44e-73804d0909a9.htm) 类的一个新实例
...
[ElectricalParameters 类](72d4da7c-80dc-14aa-b44e-73804d0909a9.htm)
...
---
## ElectricalParameters 属性

[原文連結](http://api.hslcommunication.cn/html/6f69db8c-d0d8-6b07-c950-e809098b4bd4.htm)
...
[CurrentA 属性](../html/ce8f492c-a505-b0c0-5e74-3a2ada070bd3.htm "CurrentA 属性 ")

[CurrentB 属性](../html/c60844e4-288e-f139-0664-99b9868ed845.htm "CurrentB 属性 ")

[CurrentC 属性](../html/51f801ce-0091-8142-62ff-ec1b5d7c4ea3.htm "CurrentC 属性 ")

[Frequency 属性](../html/bc7292ee-8d3d-1350-4bc0-6c0e74f49b08.htm "Frequency 属性 ")

[InstantaneousActivePowerA 属性](../html/dc443e55-2642-073b-e815-19204076f9d4.htm "InstantaneousActivePowerA 属性 ")

[InstantaneousActivePowerB 属性](../html/50772bd9-812a-a930-8cf3-6fd33a651690.htm "InstantaneousActivePowerB 属性 ")

[InstantaneousActivePowerC 属性](../html/3c785b2b-16b7-6bf3-0b8f-e261c82224b0.htm "InstantaneousActivePowerC 属性 ")

[InstantaneousApparentPowerA 属性](../html/4782e154-76e5-3211-e4c0-6766c58356ed.htm "InstantaneousApparentPowerA 属性 ")

[InstantaneousApparentPowerB 属性](../html/edae7ce7-b97c-f86a-9d6e-7c259f9b459e.htm "InstantaneousApparentPowerB 属性 ")

[InstantaneousApparentPowerC 属性](../html/e4b172ec-689c-573d-5590-6948abc6a135.htm "InstantaneousApparentPowerC 属性 ")

[InstantaneousReactivePowerA 属性](../html/caff9674-aee5-c19f-ddc1-587032a96096.htm "InstantaneousReactivePowerA 属性 ")

[InstantaneousReactivePowerB 属性](../html/cc3a7bb4-14c2-e076-d82a-819d9cd585e0.htm "InstantaneousReactivePowerB 属性 ")

[InstantaneousReactivePowerC 属性](../html/d59b5464-08ac-698f-6160-5fa4ea102b53.htm "InstantaneousReactivePowerC 属性 ")

[InstantaneousTotalActivePower 属性](../html/65a93006-61a9-c934-5003-35b1590c3cd5.htm "InstantaneousTotalActivePower 属性 ")

[InstantaneousTotalApparentPower 属性](../html/b123e97a-7f62-dbdf-804e-f8c9a0098105.htm "InstantaneousTotalApparentPower 属性 ")

[InstantaneousTotalReactivePower 属性](../html/61bbf3f3-d541-22d8-72f9-a143a98d7ef2.htm "InstantaneousTotalReactivePower 属性 ")

[PowerFactorA 属性](../html/57d25dfa-1654-defe-456e-197f8e6aa20c.htm "PowerFactorA 属性 ")

[PowerFactorB 属性](../html/b8ee337b-c6f6-08b4-1b63-1399b41076c3.htm "PowerFactorB 属性 ")

[PowerFactorC 属性](../html/e7917f22-7906-1e6b-ae73-4e57051a95d3.htm "PowerFactorC 属性 ")

[TotalPowerFactor 属性](../html/524bab87-fa12-46bf-7d5a-1f31dee5f229.htm "TotalPowerFactor 属性 ")

[VoltageA 属性](../html/a9d8464c-cd16-ece1-09c1-f0b5f3dcd2f4.htm "VoltageA 属性 ")

[VoltageB 属性](../html/226b7b2e-e5bb-7abe-c67d-df870995d128.htm "VoltageB 属性 ")

[VoltageC 属性](../html/5f73e840-9fbb-7404-fe28-74babd7f65a9.htm "VoltageC 属性 ")
...
[ElectricalParameters](72d4da7c-80dc-14aa-b44e-73804d0909a9.htm) 类型公开以下成员。
...
[原文連結](http://api.hslcommunication.cn/html/ce8f492c-a505-b0c0-5e74-3a2ada070bd3.htm)
...
|  |
| --- |
| ElectricalParametersCurrentA 属性 |
...
```
Public Property CurrentA As Single
	Get
	Set
```
...
```
member CurrentA : float32 with get, set
```
...
[原文連結](http://api.hslcommunication.cn/html/c60844e4-288e-f139-0664-99b9868ed845.htm)
...
|  |
| --- |
| ElectricalParametersCurrentB 属性 |
...
```
Public Property CurrentB As Single
	Get
	Set
```
...
```
member CurrentB : float32 with get, set
```
...
[原文連結](http://api.hslcommunication.cn/html/51f801ce-0091-8142-62ff-ec1b5d7c4ea3.htm)
...
|  |
| --- |
| ElectricalParametersCurrentC 属性 |
...
```
Public Property CurrentC As Single
	Get
	Set
```
...
```
member CurrentC : float32 with get, set
```
...
[原文連結](http://api.hslcommunication.cn/html/bc7292ee-8d3d-1350-4bc0-6c0e74f49b08.htm)
...
|  |
| --- |
| ElectricalParametersFrequency 属性 |
...
```
member Frequency : float32 with get, set
```
...
---
## InstantaneousActivePowerA 属性 

[原文連結](http://api.hslcommunication.cn/html/dc443e55-2642-073b-e815-19204076f9d4.htm)
...
|  |
| --- |
| ElectricalParametersInstantaneousActivePowerA 属性 |
...
```
Public Property InstantaneousActivePowerA As Single
	Get
	Set
```
...
```
public:
property float InstantaneousActivePowerA {
	float get ();
	void set (float value);
}
```
...
```
member InstantaneousActivePowerA : float32 with get, set
```
...
---
## InstantaneousActivePowerB 属性 

[原文連結](http://api.hslcommunication.cn/html/50772bd9-812a-a930-8cf3-6fd33a651690.htm)
...
|  |
| --- |
| ElectricalParametersInstantaneousActivePowerB 属性 |
...
```
Public Property InstantaneousActivePowerB As Single
	Get
	Set
```
...
```
public:
property float InstantaneousActivePowerB {
	float get ();
	void set (float value);
}
```
...
```
member InstantaneousActivePowerB : float32 with get, set
```
...
---
## InstantaneousActivePowerC 属性 

[原文連結](http://api.hslcommunication.cn/html/3c785b2b-16b7-6bf3-0b8f-e261c82224b0.htm)
...
|  |
| --- |
| ElectricalParametersInstantaneousActivePowerC 属性 |
...
```
Public Property InstantaneousActivePowerC As Single
	Get
	Set
```
...
```
public:
property float InstantaneousActivePowerC {
	float get ();
	void set (float value);
}
```
...
```
member InstantaneousActivePowerC : float32 with get, set
```
...
---
## InstantaneousApparentPowerA 属性 

[原文連結](http://api.hslcommunication.cn/html/4782e154-76e5-3211-e4c0-6766c58356ed.htm)
...
|  |
| --- |
| ElectricalParametersInstantaneousApparentPowerA 属性 |
...
```
Public Property InstantaneousApparentPowerA As Single
	Get
	Set
```
...
```
public:
property float InstantaneousApparentPowerA {
	float get ();
	void set (float value);
}
```
...
```
member InstantaneousApparentPowerA : float32 with get, set
```
...
---
## InstantaneousApparentPowerB 属性 

[原文連結](http://api.hslcommunication.cn/html/edae7ce7-b97c-f86a-9d6e-7c259f9b459e.htm)
...
|  |
| --- |
| ElectricalParametersInstantaneousApparentPowerB 属性 |
...
```
Public Property InstantaneousApparentPowerB As Single
	Get
	Set
```
...
```
public:
property float InstantaneousApparentPowerB {
	float get ();
	void set (float value);
}
```
...
```
member InstantaneousApparentPowerB : float32 with get, set
```
...
---
## InstantaneousApparentPowerC 属性 

[原文連結](http://api.hslcommunication.cn/html/e4b172ec-689c-573d-5590-6948abc6a135.htm)
...
|  |
| --- |
| ElectricalParametersInstantaneousApparentPowerC 属性 |
...
```
Public Property InstantaneousApparentPowerC As Single
	Get
	Set
```
...
```
public:
property float InstantaneousApparentPowerC {
	float get ();
	void set (float value);
}
```
...
```
member InstantaneousApparentPowerC : float32 with get, set
```
...
---
## InstantaneousReactivePowerA 属性 

[原文連結](http://api.hslcommunication.cn/html/caff9674-aee5-c19f-ddc1-587032a96096.htm)
...
|  |
| --- |
| ElectricalParametersInstantaneousReactivePowerA 属性 |
...
```
Public Property InstantaneousReactivePowerA As Single
	Get
	Set
```
...
```
public:
property float InstantaneousReactivePowerA {
	float get ();
	void set (float value);
}
```
...
```
member InstantaneousReactivePowerA : float32 with get, set
```
...
---
## InstantaneousReactivePowerB 属性 

[原文連結](http://api.hslcommunication.cn/html/cc3a7bb4-14c2-e076-d82a-819d9cd585e0.htm)
...
|  |
| --- |
| ElectricalParametersInstantaneousReactivePowerB 属性 |
...
```
Public Property InstantaneousReactivePowerB As Single
	Get
	Set
```
...
```
public:
property float InstantaneousReactivePowerB {
	float get ();
	void set (float value);
}
```
...
```
member InstantaneousReactivePowerB : float32 with get, set
```
...
---
## InstantaneousReactivePowerC 属性 

[原文連結](http://api.hslcommunication.cn/html/d59b5464-08ac-698f-6160-5fa4ea102b53.htm)
...
|  |
| --- |
| ElectricalParametersInstantaneousReactivePowerC 属性 |
...
```
Public Property InstantaneousReactivePowerC As Single
	Get
	Set
```
...
```
public:
property float InstantaneousReactivePowerC {
	float get ();
	void set (float value);
}
```
...
```
member InstantaneousReactivePowerC : float32 with get, set
```
...
---
## InstantaneousTotalActivePower 属性 

[原文連結](http://api.hslcommunication.cn/html/65a93006-61a9-c934-5003-35b1590c3cd5.htm)
...
|  |
| --- |
| ElectricalParametersInstantaneousTotalActivePower 属性 |
...
```
Public Property InstantaneousTotalActivePower As Single
	Get
	Set
```
...
```
public:
property float InstantaneousTotalActivePower {
	float get ();
	void set (float value);
}
```
...
```
member InstantaneousTotalActivePower : float32 with get, set
```
...
---
## InstantaneousTotalApparentPower 属性 

[原文連結](http://api.hslcommunication.cn/html/b123e97a-7f62-dbdf-804e-f8c9a0098105.htm)
...
|  |
| --- |
| ElectricalParametersInstantaneousTotalApparentPower 属性 |
...
```
Public Property InstantaneousTotalApparentPower As Single
	Get
	Set
```
...
```
public:
property float InstantaneousTotalApparentPower {
	float get ();
	void set (float value);
}
```
...
```
member InstantaneousTotalApparentPower : float32 with get, set
```
...
---
## InstantaneousTotalReactivePower 属性 

[原文連結](http://api.hslcommunication.cn/html/61bbf3f3-d541-22d8-72f9-a143a98d7ef2.htm)
...
|  |
| --- |
| ElectricalParametersInstantaneousTotalReactivePower 属性 |
...
```
Public Property InstantaneousTotalReactivePower As Single
	Get
	Set
```
...
```
public:
property float InstantaneousTotalReactivePower {
	float get ();
	void set (float value);
}
```
...
```
member InstantaneousTotalReactivePower : float32 with get, set
```
...
[原文連結](http://api.hslcommunication.cn/html/57d25dfa-1654-defe-456e-197f8e6aa20c.htm)
...
|  |
| --- |
| ElectricalParametersPowerFactorA 属性 |
...
```
Public Property PowerFactorA As Single
	Get
	Set
```
...
```
member PowerFactorA : float32 with get, set
```
