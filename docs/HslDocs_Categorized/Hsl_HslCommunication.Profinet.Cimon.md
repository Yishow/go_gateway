# HslCommunication - HslCommunication.Profinet.Cimon
...
[原文連結](http://api.hslcommunication.cn/html/4d04b6b9-f2af-73a9-20eb-d14d4348f680.htm)

HslCommunication Library Document

[HslCommunication Library Document](../html\c136d3de-eab7-9b0f-4bdf-d891297c8018.htm "HslCommunication Library Document")

[HslCommunication.Profinet.Cimon](../html/4d04b6b9-f2af-73a9-20eb-d14d4348f680.htm "HslCommunication.Profinet.Cimon")

[CimonHmiProtocol 类](../html/d5e3fd56-86ec-e873-427c-342eeaea784a.htm "CimonHmiProtocol 类")

[CimonServer 类](../html/22aaf0fe-8ab0-0e56-091c-0538c19678aa.htm "CimonServer 类")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| HslCommunication.Profinet.Cimon 命名空间 |

[缺少 "N:HslCommunication.Profinet.Cimon" 的 <summary> 文档]

![](../icons/SectionExpanded.png)类

|  | 类 | 说明 |
| --- | --- | --- |
| 公共类 | [CimonHmiProtocol](d5e3fd56-86ec-e873-427c-342eeaea784a.htm) | 西蒙PLC的数据读取类，支持的地址请参考Demo测试工具上的示例  Simon PLC data reading class, the supported address please refer to the Demo test tool on the example |
| 公共类 | [CimonServer](22aaf0fe-8ab0-0e56-091c-0538c19678aa.htm) | Cimon的服务器端实现 |
...
[原文連結](http://api.hslcommunication.cn/html/d5e3fd56-86ec-e873-427c-342eeaea784a.htm)
...
[CimonHmiProtocol 构造函数](../html/1971393b-75a0-3009-630f-13b4899290cb.htm "CimonHmiProtocol 构造函数 ")

[CimonHmiProtocol 属性](../html/02f4ce5f-efbe-ed34-8ee7-a19b4afc8168.htm "CimonHmiProtocol 属性")

[CimonHmiProtocol 方法](../html/a93acac9-8279-85f5-4996-378d4353b2af.htm "CimonHmiProtocol 方法")

[CimonHmiProtocol 字段](../html/3596bf57-1f7e-4810-39ed-8007bf159899.htm "CimonHmiProtocol 字段")
...
西蒙PLC的数据读取类，支持的地址请参考Demo测试工具上的示例  
...
        HslCommunication.Profinet.CimonCimonHmiProtocol

**命名空间：**
 [HslCommunication.Profinet.Cimon](4d04b6b9-f2af-73a9-20eb-d14d4348f680.htm)  
**程序集：**
...
```
Public Class CimonHmiProtocol
	Inherits DeviceTcpNet
```

```
public ref class CimonHmiProtocol : public DeviceTcpNet
```

```
type CimonHmiProtocol =  
    class
        inherit DeviceTcpNet
    end
```

CimonHmiProtocol 类型公开以下成员。

![](../icons/SectionExpanded.png)构造函数

|  | 名称 | 说明 |
| --- | --- | --- |
| 公共方法 | [CimonHmiProtocol](07b205d6-615b-5e0d-d4ec-1c300f055bae.htm) | 实例化一个默认的对象 |
| 公共方法 | [CimonHmiProtocol(String, Int32)](80df9f42-8048-885c-999c-882e3e2423ee.htm) | 根据IP地址，端口号来实例化一个对象 |
...
| 公共属性 | [FrameNo](24e791b4-1d29-4ce1-4f9d-66281dea28cd.htm) | 获取或设置当前的站号信息  Gets or sets the current station number information |
...
| 公共方法 | [Read(String, UInt16)](63bd9bbc-2068-46ab-172b-24eb2f477a2d.htm) | 批量读取字节数组信息，需要指定地址和长度，返回原始的字节数组  Batch read byte array information, need to specify the address and length, return the original byte array (重写 [DeviceCommunicationRead(String, UInt16)](9dd09452-c200-bc65-75ff-69aa34b366d4.htm).) |
...
| 公共方法 | [ReadAsync(String, UInt16)](b92ee2c5-c93a-1443-5e59-3bdc8f7a0479.htm) | 异步批量读取字节数组信息，需要指定地址和长度，返回原始的字节数组  Asynchronous batch read byte array information, need to specify the address and length, return the original byte array (重写 [DeviceCommunicationReadAsync(String, UInt16)](d8c14d37-56dc-2a31-1a19-3e2b5b65197d.htm).) |
...
| 公共方法 | [ReadBool(String, UInt16)](5f37a0be-3890-332e-7ea3-a69e936c090c.htm) | 批量读取Boolean数组信息，需要指定地址和长度，返回Boolean 数组  Batch read Boolean array information, need to specify the address and length, return Boolean array (重写 [DeviceCommunicationReadBool(String, UInt16)](69d0d24f-34a7-5b41-5c1b-619edc7e6b54.htm).) |
...
| 公共方法 | [Write(String, Boolean)](6a056f8d-8489-f13e-8f2f-7487b136f4bc.htm) | 批量写入Boolean数组数据，返回是否成功  Batch write Boolean array data, return whether the write was successful (重写 [DeviceCommunicationWrite(String, Boolean)](5b046c82-3d8e-550b-fdf3-41ca5558169b.htm).) |
| 公共方法 | [Write(String, Byte)](9c618cd3-44ac-0989-8c55-4bad0b7c0f63.htm) | 写入原始的byte数组数据到指定的地址，返回是否写入成功  Write the original byte array data to the specified address, and return whether the write was successful (重写 [DeviceCommunicationWrite(String, Byte)](b5536dd6-ccde-6883-ac27-bff9e4b37806.htm).) |
...
| 公共方法 | [WriteAsync(String, Boolean)](70ee5e51-49d9-bca0-27c5-76dfe8d747d4.htm) | 异步批量写入Boolean数组数据，返回是否成功  Asynchronously batch write Boolean array data, return success (重写 [DeviceCommunicationWriteAsync(String, Boolean)](fe872dae-7ef9-12c1-d883-e92ba8676416.htm).) |
| 公共方法代码示例 | [WriteAsync(String, Byte)](965ab119-cdf6-10a9-5fef-f9becce39b6c.htm) | 异步写入原始的byte数组数据到指定的地址，返回是否写入成功  Asynchronously writes the original byte array data to the specified address, and returns whether the write was successful (重写 [DeviceCommunicationWriteAsync(String, Byte)](8f1cec30-8b86-6749-c8f3-7d39168d59df.htm).) |
...
[HslCommunication.Profinet.Cimon 命名空间](4d04b6b9-f2af-73a9-20eb-d14d4348f680.htm)
...
---
## CimonHmiProtocol 构造函数 

[原文連結](http://api.hslcommunication.cn/html/1971393b-75a0-3009-630f-13b4899290cb.htm)
...
[CimonHmiProtocol 构造函数](../html/07b205d6-615b-5e0d-d4ec-1c300f055bae.htm "CimonHmiProtocol 构造函数 ")

[CimonHmiProtocol 构造函数 (String, Int32)](../html/80df9f42-8048-885c-999c-882e3e2423ee.htm "CimonHmiProtocol 构造函数 (String, Int32)")
...
[CimonHmiProtocol 类](d5e3fd56-86ec-e873-427c-342eeaea784a.htm)
...
[原文連結](http://api.hslcommunication.cn/html/07b205d6-615b-5e0d-d4ec-1c300f055bae.htm)
...
[CimonHmiProtocol 重载](1971393b-75a0-3009-630f-13b4899290cb.htm)
...
---
## CimonHmiProtocol 构造函数 (String, Int32)

[原文連結](http://api.hslcommunication.cn/html/80df9f42-8048-885c-999c-882e3e2423ee.htm)
...
Public Sub New ( 
	ip As String,
	Optional port As Integer = 10260
)
```
...
new : 
        ...
        ?port : int 
(* Defaults:
        let _port = defaultArg port 10260
*)
-> CimonHmiProtocol
```
...
[原文連結](http://api.hslcommunication.cn/html/02f4ce5f-efbe-ed34-8ee7-a19b4afc8168.htm)
...
[FrameNo 属性](../html/24e791b4-1d29-4ce1-4f9d-66281dea28cd.htm "FrameNo 属性 ")
...
[CimonHmiProtocol](d5e3fd56-86ec-e873-427c-342eeaea784a.htm) 类型公开以下成员。
...
[原文連結](http://api.hslcommunication.cn/html/24e791b4-1d29-4ce1-4f9d-66281dea28cd.htm)
...
[原文連結](http://api.hslcommunication.cn/html/a93acac9-8279-85f5-4996-378d4353b2af.htm)
...
[Read 方法](../html/3f5f2dfd-4271-4356-d0f4-10e5db3e0f3f.htm "Read 方法 ")

[ReadAsync 方法](../html/e35e541c-6d4f-998f-215c-a3bd7a65bf88.htm "ReadAsync 方法 ")

[ReadBool 方法](../html/58f8c18c-b92f-072e-c10e-b3f58f86b3c4.htm "ReadBool 方法 ")

[ReadBoolAsync 方法](../html/3bd283cf-f6a7-c2ec-24c6-34d50f0d203f.htm "ReadBoolAsync 方法 ")

[ToString 方法](../html/12abb791-b121-f2ae-c4a5-8ef51f657d0c.htm "ToString 方法 ")

[UnpackResponseContent 方法](../html/0f21a8c0-2af7-c1db-e252-9777d4e5855a.htm "UnpackResponseContent 方法 ")

[Write 方法](../html/1b17c39f-b8a3-660b-02d3-b5a1662b4544.htm "Write 方法 ")

[WriteAsync 方法](../html/17c2a174-f905-c1b2-6206-fa032de45bb7.htm "WriteAsync 方法 ")
...
[原文連結](http://api.hslcommunication.cn/html/3f5f2dfd-4271-4356-d0f4-10e5db3e0f3f.htm)
...
[Read 方法 (String, UInt16)](../html/63bd9bbc-2068-46ab-172b-24eb2f477a2d.htm "Read 方法 (String, UInt16)")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| CimonHmiProtocolRead 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/63bd9bbc-2068-46ab-172b-24eb2f477a2d.htm)
...
|  |
| --- |
| CimonHmiProtocolRead 方法 (String, UInt16) |
...
[Read 重载](3f5f2dfd-4271-4356-d0f4-10e5db3e0f3f.htm)
...
[原文連結](http://api.hslcommunication.cn/html/e35e541c-6d4f-998f-215c-a3bd7a65bf88.htm)
...
[ReadAsync 方法 (String, UInt16)](../html/b92ee2c5-c93a-1443-5e59-3bdc8f7a0479.htm "ReadAsync 方法 (String, UInt16)")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| CimonHmiProtocolReadAsync 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/b92ee2c5-c93a-1443-5e59-3bdc8f7a0479.htm)
...
|  |
| --- |
| CimonHmiProtocolReadAsync 方法 (String, UInt16) |
...
[ReadAsync 重载](e35e541c-6d4f-998f-215c-a3bd7a65bf88.htm)
...
[原文連結](http://api.hslcommunication.cn/html/58f8c18c-b92f-072e-c10e-b3f58f86b3c4.htm)
...
[ReadBool 方法 (String, UInt16)](../html/5f37a0be-3890-332e-7ea3-a69e936c090c.htm "ReadBool 方法 (String, UInt16)")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| CimonHmiProtocolReadBool 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/5f37a0be-3890-332e-7ea3-a69e936c090c.htm)
...
|  |
| --- |
| CimonHmiProtocolReadBool 方法 (String, UInt16) |
...
[ReadBool 重载](58f8c18c-b92f-072e-c10e-b3f58f86b3c4.htm)
...
[原文連結](http://api.hslcommunication.cn/html/3bd283cf-f6a7-c2ec-24c6-34d50f0d203f.htm)
...
[ReadBoolAsync 方法 (String, UInt16)](../html/0150502d-0ef2-c1ec-443b-3a02a7966691.htm "ReadBoolAsync 方法 (String, UInt16)")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| CimonHmiProtocolReadBoolAsync 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/0150502d-0ef2-c1ec-443b-3a02a7966691.htm)
...
|  |
| --- |
| CimonHmiProtocolReadBoolAsync 方法 (String, UInt16) |
...
[ReadBoolAsync 重载](3bd283cf-f6a7-c2ec-24c6-34d50f0d203f.htm)
...
[原文連結](http://api.hslcommunication.cn/html/12abb791-b121-f2ae-c4a5-8ef51f657d0c.htm)
...
|  |
| --- |
| CimonHmiProtocolToString 方法 |

[缺少 "M:HslCommunication.Profinet.Cimon.CimonHmiProtocol.ToString" 的 <summary> 文档]
...
[缺少 "M:HslCommunication.Profinet.Cimon.CimonHmiProtocol.ToString" 的 <returns> 文档]
...
[原文連結](http://api.hslcommunication.cn/html/0f21a8c0-2af7-c1db-e252-9777d4e5855a.htm)
...
|  |
| --- |
| CimonHmiProtocolUnpackResponseContent 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/1b17c39f-b8a3-660b-02d3-b5a1662b4544.htm)
...
[Write 方法 (String, Boolean[])](../html/6a056f8d-8489-f13e-8f2f-7487b136f4bc.htm "Write 方法 (String, Boolean[])")

[Write 方法 (String, Byte[])](../html/9c618cd3-44ac-0989-8c55-4bad0b7c0f63.htm "Write 方法 (String, Byte[])")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| CimonHmiProtocolWrite 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/6a056f8d-8489-f13e-8f2f-7487b136f4bc.htm)
...
|  |
| --- |
| CimonHmiProtocolWrite 方法 (String, Boolean) |
...
[Write 重载](1b17c39f-b8a3-660b-02d3-b5a1662b4544.htm)
...
[原文連結](http://api.hslcommunication.cn/html/9c618cd3-44ac-0989-8c55-4bad0b7c0f63.htm)
...
|  |
| --- |
| CimonHmiProtocolWrite 方法 (String, Byte) |
...
[原文連結](http://api.hslcommunication.cn/html/17c2a174-f905-c1b2-6206-fa032de45bb7.htm)
...
[WriteAsync 方法 (String, Boolean[])](../html/70ee5e51-49d9-bca0-27c5-76dfe8d747d4.htm "WriteAsync 方法 (String, Boolean[])")

[WriteAsync 方法 (String, Byte[])](../html/965ab119-cdf6-10a9-5fef-f9becce39b6c.htm "WriteAsync 方法 (String, Byte[])")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| CimonHmiProtocolWriteAsync 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/70ee5e51-49d9-bca0-27c5-76dfe8d747d4.htm)
...
|  |
| --- |
| CimonHmiProtocolWriteAsync 方法 (String, Boolean) |
...
[WriteAsync 重载](17c2a174-f905-c1b2-6206-fa032de45bb7.htm)
...
[原文連結](http://api.hslcommunication.cn/html/965ab119-cdf6-10a9-5fef-f9becce39b6c.htm)
...
|  |
| --- |
| CimonHmiProtocolWriteAsync 方法 (String, Byte) |
...
[原文連結](http://api.hslcommunication.cn/html/3596bf57-1f7e-4810-39ed-8007bf159899.htm)
...
[原文連結](http://api.hslcommunication.cn/html/22aaf0fe-8ab0-0e56-091c-0538c19678aa.htm)
...
[CimonServer 构造函数](../html/c519578d-3e7d-1aac-67ea-fc0d7fcf892c.htm "CimonServer 构造函数 ")

[CimonServer 属性](../html/61ca7c58-becf-3b3d-dffc-fdd409e34064.htm "CimonServer 属性")

[CimonServer 方法](../html/cd3f15b1-2807-60b0-878a-91b8f1f3345e.htm "CimonServer 方法")

[CimonServer 事件](../html/cc3bb5cc-697d-b0a8-4fda-d07cb90a8eca.htm "CimonServer 事件")

[CimonServer 字段](../html/0ff43485-f3c4-e25a-67de-ae1844e7f2f0.htm "CimonServer 字段")
...
        HslCommunication.Profinet.CimonCimonServer
...
```
Public Class CimonServer
	Inherits DeviceServer
```

```
public ref class CimonServer : public DeviceServer
```
...
CimonServer 类型公开以下成员。

![](../icons/SectionExpanded.png)构造函数

|  | 名称 | 说明 |
| --- | --- | --- |
| 公共方法 | [CimonServer](c519578d-3e7d-1aac-67ea-fc0d7fcf892c.htm) | 实例化一个默认的对象  Instantiate a default object |
...
| 公共属性 | [FrameNo](9c28e0ea-c94a-5d55-d3b8-292786684d40.htm) | 获取或设置当前的站号信息  Gets or sets the current station number information |
...
| 受保护的方法 | [DecideWhetherQAMessage](acc40cda-e310-8537-6685-59b67eeb16ff.htm) | 决定当前的消息是否是用于问答机制返回的消息，默认直接返回 true, 实际的情况需要根据协议进行重写方法  To determine whether the current message is the message returned by the question answering mechanism, the default is true. In actual cases, the rewriting method needs to be performed according to the protocol (继承自 [BinaryCommunication](1edb8336-6f5d-2697-7b3b-911625a330f6.htm)。) |
| 公共方法 | [Dispose](b9dda6bf-d342-254e-689a-93fa0bb265d1.htm) | (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 受保护的方法 | [Dispose(Boolean)](219f18c3-64d3-a044-b798-de6e2bf866ef.htm) | (继承自 [DeviceServer](bad891c2-0527-acc1-3bcb-0eecb1a393a2.htm)。) |
| 公共方法 | Equals | (继承自 Object。) |
| 受保护的方法 | [ExtraAfterReadFromCoreServer](06a49a15-a3ce-5e39-28c7-2b78851eca2e.htm) | 和服务器交互完成的时候调用的方法，可以根据读写结果进行一些额外的操作，具体的操作需要根据实际的需求来重写实现  The method called when the interaction with the server is completed can perform some additional operations based on the read and write results. The specific operations need to be rewritten according to actual needs. (继承自 [BinaryCommunication](1edb8336-6f5d-2697-7b3b-911625a330f6.htm)。) |
| 受保护的方法代码示例 | [ExtraOnDisconnect](de9dbba2-3b2c-1c5e-53c8-4e6f8a44e2c4.htm) | 根据实际的协议选择是否重写本方法，有些协议在断开连接之前，需要发送一些报文来关闭当前的网络通道  Select whether to rewrite this method according to the actual protocol. Some protocols need to send some packets to close the current network channel before disconnecting. (继承自 [BinaryCommunication](1edb8336-6f5d-2697-7b3b-911625a330f6.htm)。) |
| 受保护的方法代码示例 | [ExtraOnDisconnectAsync](210f593e-16d8-77c4-1178-58fbcfe9b27b.htm) | 根据实际的协议选择是否重写本方法，有些协议在断开连接之前，需要发送一些报文来关闭当前的网络通道  Select whether to rewrite this method according to the actual protocol. Some protocols need to send some packets to close the current network channel before disconnecting. (继承自 [BinaryCommunication](1edb8336-6f5d-2697-7b3b-911625a330f6.htm)。) |
...
| 受保护的方法 | [LoadFromBytes](4a16c815-c1b7-9620-c705-21db6518272b.htm) | 从字节数据加载数据信息，需要进行重写方法  Loading data information from byte data requires rewriting method (继承自 [DeviceServer](bad891c2-0527-acc1-3bcb-0eecb1a393a2.htm)。) |
| 受保护的方法 | [LogRevcMessage(Byte)](dab1657f-1e75-7fe1-7003-ccedfc69855d.htm) | 使用日志记录一个接收的报文信息  Logs are used to record information about a received packet (继承自 [BinaryCommunication](1edb8336-6f5d-2697-7b3b-911625a330f6.htm)。) |
| 受保护的方法 | [LogRevcMessage(Byte, PipeSession)](0f51ae45-575e-4228-f978-01b37d6d5df1.htm) | 使用日志记录一个接收的报文信息  Logs are used to record information about a received packet (继承自 [BinaryCommunication](1edb8336-6f5d-2697-7b3b-911625a330f6.htm)。) |
| 受保护的方法 | [LogSendMessage(Byte)](4f90eecc-68a2-1ef2-44ef-369f19bed3ec.htm) | 使用日志记录一个发送的报文信息  Logs are used to record information about a send packet (继承自 [BinaryCommunication](1edb8336-6f5d-2697-7b3b-911625a330f6.htm)。) |
| 受保护的方法 | [LogSendMessage(Byte, PipeSession)](209caadf-4f0f-40aa-04c2-ebc61f8dab13.htm) | 使用日志记录一个发送的报文信息  Logs are used to record information about a send packet (继承自 [BinaryCommunication](1edb8336-6f5d-2697-7b3b-911625a330f6.htm)。) |
...
| 公共方法 | [Read(String, UInt16)](d5872b94-efb9-5b2e-8af0-8353a6f106ed.htm) | 批量读取字节数组信息，需要指定地址和长度，返回原始的字节数组  Batch read byte array information, need to specify the address and length, return the original byte array (重写 [DeviceCommunicationRead(String, UInt16)](9dd09452-c200-bc65-75ff-69aa34b366d4.htm).) |
| 公共方法代码示例 | [ReadT](95abe064-5594-5ae7-a849-98c53f88fee0.htm) | 读取支持Hsl特性的数据内容，该特性为[HslDeviceAddressAttribute](e39ddd01-95cf-ea40-1f29-20801dddfbe0.htm)，详细参考api文档说明，或是官网的详细文档  Read the data content of the Hsl attribute. The attribute is [HslDeviceAddressAttribute](e39ddd01-95cf-ea40-1f29-20801dddfbe0.htm), please refer to the api documentation for details. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
...
| 公共方法代码示例 | [ReadAsyncT](0522e740-4bf0-2e31-c4c5-e41384321b37.htm) | 异步读取支持Hsl特性的数据内容，该特性为[HslDeviceAddressAttribute](e39ddd01-95cf-ea40-1f29-20801dddfbe0.htm)，详细参考api文档说明  Asynchronously read the data content of the Hsl attribute. The attribute is [HslDeviceAddressAttribute](e39ddd01-95cf-ea40-1f29-20801dddfbe0.htm), please refer to the api documentation for details. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法 | [ReadBool(String)](9b2faa2e-eaa9-7ace-c49f-7a0318f1df1a.htm) | 读取单个的Boolean数据信息  Read a single Boolean data message (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法 | [ReadBool(String, UInt16)](d16df4b1-cb11-ab6c-3750-3cd13dbc1115.htm) | 批量读取Boolean数组信息，需要指定地址和长度，返回Boolean 数组  Batch read Boolean array information, need to specify the address and length, return Boolean array (重写 [DeviceCommunicationReadBool(String, UInt16)](69d0d24f-34a7-5b41-5c1b-619edc7e6b54.htm).) |
| 公共方法 | [ReadBoolAsync(String)](cc37da1f-d673-fe67-78ee-4e465d29a2bd.htm) | 异步读取单个的Boolean数据信息  Asynchronously read a single Boolean data message (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
...
| 受保护的方法 | [SaveToBytes](871f8a64-6b6d-53ea-143c-479af077c5a3.htm) | 将数据信息存储到字节数组去，需要进行重写方法  To store data information into a byte array, a rewrite method is required (继承自 [DeviceServer](bad891c2-0527-acc1-3bcb-0eecb1a393a2.htm)。) |
...
| 公共方法 | [ToString](c9b1ec90-fc23-c364-1cf0-edd809d01f51.htm) | (重写 [DeviceCommunicationToString](5667665a-da16-d227-f350-5b3f0ab9ab04.htm).) |
...
| 公共方法代码示例 | [Write(String, UInt64)](4924086e-9b36-d446-4ae4-6682134a6ad1.htm) | 写入ulong数据，返回是否成功  Write ulong data, return whether the write was successful (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法代码示例 | [Write(String, UInt64)](b1131bdd-8b51-ec6d-dd0e-fec1f6cb51b6.htm) | 写入ulong数组，返回是否成功  Write ulong array, return whether the write was successful (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法 | [Write(String, Boolean)](22ae090c-1ed6-3471-2ee6-870feb327c26.htm) | 批量写入Boolean数组数据，返回是否成功  Batch write Boolean array data, return whether the write was successful (重写 [DeviceCommunicationWrite(String, Boolean)](5b046c82-3d8e-550b-fdf3-41ca5558169b.htm).) |
| 公共方法 | [Write(String, Byte)](735b8b57-0c03-36af-ed7f-9a03bc1cc669.htm) | 写入原始的byte数组数据到指定的地址，返回是否写入成功  Write the original byte array data to the specified address, and return whether the write was successful (重写 [DeviceCommunicationWrite(String, Byte)](b5536dd6-ccde-6883-ac27-bff9e4b37806.htm).) |
| 公共方法代码示例 | [Write(String, String, Int32)](02fe2ca9-49a3-ede4-d1af-8c6da1f644da.htm) | 写入指定长度的字符串信息，如果超出，就截断字符串，如果长度不足，那就补0操作，编码为ASCII  Write string information of the specified length. If it exceeds the value, the string is truncated. If the length is not enough, it is filled with 0 and the encoding is ASCII. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法代码示例 | [Write(String, String, Encoding)](7b602661-902d-2b70-1fdb-ba87ecd307bf.htm) | 写入字符串信息，需要指定的编码信息  Write string information, need to specify the encoding information (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法代码示例 | [Write(String, String, Int32, Encoding)](e8cb30d9-4c5e-6c68-b9af-1b1b6c2dc714.htm) | 写入指定长度的字符串信息，如果超出，就截断字符串，如果长度不足，那就补0操作，编码为指定的编码信息  Write string information of the specified length. If it exceeds the value, the string is truncated. If the length is not enough, then the operation is complemented with 0 , you should specified the encoding information (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法代码示例 | [WriteT(T)](9f48853f-fbeb-c37d-25a2-1c76d1dee407.htm) | 写入支持Hsl特性的数据，返回是否写入成功，该特性为[HslDeviceAddressAttribute](e39ddd01-95cf-ea40-1f29-20801dddfbe0.htm)，详细参考api文档说明  Write data that supports the Hsl attribute, and return whether the write was successful. The attribute is [HslDeviceAddressAttribute](e39ddd01-95cf-ea40-1f29-20801dddfbe0.htm), please refer to the api documentation for details. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
...
[原文連結](http://api.hslcommunication.cn/html/c519578d-3e7d-1aac-67ea-fc0d7fcf892c.htm)
...
[CimonServer 类](22aaf0fe-8ab0-0e56-091c-0538c19678aa.htm)
...
[原文連結](http://api.hslcommunication.cn/html/61ca7c58-becf-3b3d-dffc-fdd409e34064.htm)
...
[FrameNo 属性](../html/9c28e0ea-c94a-5d55-d3b8-292786684d40.htm "FrameNo 属性 ")
...
[CimonServer](22aaf0fe-8ab0-0e56-091c-0538c19678aa.htm) 类型公开以下成员。
...
[原文連結](http://api.hslcommunication.cn/html/9c28e0ea-c94a-5d55-d3b8-292786684d40.htm)
...
[原文連結](http://api.hslcommunication.cn/html/cd3f15b1-2807-60b0-878a-91b8f1f3345e.htm)
...
[Read 方法](../html/0f27b115-7dce-13b0-ecb5-8e7d948526c9.htm "Read 方法 ")

[ReadBool 方法](../html/05e2c6c5-a30e-98c0-1d95-1a265b4877ff.htm "ReadBool 方法 ")

[ReadFromCoreServer 方法](../html/abf9e734-6035-8111-824c-bf7a1720a85f.htm "ReadFromCoreServer 方法 ")

[ToString 方法](../html/c9b1ec90-fc23-c364-1cf0-edd809d01f51.htm "ToString 方法 ")

[Write 方法](../html/84b7d488-45b8-8470-1f08-5812be8d5d14.htm "Write 方法 ")
