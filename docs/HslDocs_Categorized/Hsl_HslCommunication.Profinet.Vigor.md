# HslCommunication - HslCommunication.Profinet.Vigor
...
[原文連結](http://api.hslcommunication.cn/html/90223bb0-43b8-8f62-127b-57641fcfd1ed.htm)

HslCommunication Library Document

[HslCommunication Library Document](../html\c136d3de-eab7-9b0f-4bdf-d891297c8018.htm "HslCommunication Library Document")

[HslCommunication.Profinet.Vigor](../html/90223bb0-43b8-8f62-127b-57641fcfd1ed.htm "HslCommunication.Profinet.Vigor")

[VigorSerial 类](../html/6fd92c6a-1dd9-ff59-7719-a29336143c03.htm "VigorSerial 类")

[VigorSerialOverTcp 类](../html/3f641415-2ac4-e0dd-5874-7cddeb0da160.htm "VigorSerialOverTcp 类")

[VigorServer 类](../html/0c008626-a426-28f5-c7be-eee6459859b6.htm "VigorServer 类")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| HslCommunication.Profinet.Vigor 命名空间 |

[缺少 "N:HslCommunication.Profinet.Vigor" 的 <summary> 文档]

![](../icons/SectionExpanded.png)类

|  | 类 | 说明 |
| --- | --- | --- |
| 公共类 | [VigorSerial](6fd92c6a-1dd9-ff59-7719-a29336143c03.htm) | 丰炜通信协议的串口通信，支持VS系列，地址支持携带站号，例如 s=2;D100, 字地址支持 D,SD,R,T,C(C200-C255是32位寄存器), 位地址支持X,Y,M,SM,S,TS(定时器触点),TC（定时器线圈）,CS(计数器触点),CC（计数器线圈)  The network port transparent transmission version of Fengwei communication protocol supports VS series, and the address supports carrying station number, such as s=2;D100, word address supports D, SD, R, T, C (C200-C255 are 32-bit registers), Bit address supports X, Y, M, SM, S, TS (timer contact), TC (timer coil), CS (counter contact), CC (counter coil) |
| 公共类 | [VigorSerialOverTcp](3f641415-2ac4-e0dd-5874-7cddeb0da160.htm) | 丰炜通信协议的网口透传版本，支持VS系列，地址支持携带站号，例如 s=2;D100, 字地址支持 D,SD,R,T,C(C200-C255是32位寄存器), 位地址支持X,Y,M,SM,S,TS(定时器触点),TC（定时器线圈）,CS(计数器触点),CC（计数器线圈)  The network port transparent transmission version of Fengwei communication protocol supports VS series, and the address supports carrying station number, such as s=2;D100, word address supports D, SD, R, T, C (C200-C255 are 32-bit registers), Bit address supports X, Y, M, SM, S, TS (timer contact), TC (timer coil), CS (counter contact), CC (counter coil) |
| 公共类 | [VigorServer](0c008626-a426-28f5-c7be-eee6459859b6.htm) | 丰炜的虚拟PLC，模拟了VS系列的通信，可以和对应的客户端进行数据读写测试，位地址支持 X,Y,M,S，字地址支持 D,R,SD |
...
[原文連結](http://api.hslcommunication.cn/html/6fd92c6a-1dd9-ff59-7719-a29336143c03.htm)
...
[VigorSerial 构造函数](../html/c70ae26d-51b6-acc6-a14a-fa4a6a9ff10b.htm "VigorSerial 构造函数 ")

[VigorSerial 属性](../html/47f2ff47-2914-5da8-5d6b-668758dfe8a7.htm "VigorSerial 属性")

[VigorSerial 方法](../html/134b5dec-0318-ed98-2ab5-dcd727dc5ead.htm "VigorSerial 方法")

[VigorSerial 字段](../html/00ae08e9-1bd1-3838-6732-27982710e869.htm "VigorSerial 字段")
...
丰炜通信协议的串口通信，支持VS系列，地址支持携带站号，例如 s=2;D100, 字地址支持 D,SD,R,T,C(C200-C255是32位寄存器), 位地址支持X,Y,M,SM,S,TS(定时器触点),TC（定时器线圈）,CS(计数器触点),CC（计数器线圈)  
...
**命名空间：**
 [HslCommunication.Profinet.Vigor](90223bb0-43b8-8f62-127b-57641fcfd1ed.htm)  
**程序集：**
...
```
Public Class VigorSerial
	Inherits DeviceSerialPort
```

```
public ref class VigorSerial : public DeviceSerialPort
```
...
VigorSerial 类型公开以下成员。

![](../icons/SectionExpanded.png)构造函数

|  | 名称 | 说明 |
| --- | --- | --- |
| 公共方法 | [VigorSerial](c70ae26d-51b6-acc6-a14a-fa4a6a9ff10b.htm) | 实例化一个默认的对象 |
...
| 公共属性 | [Station](b4f04c6f-9a11-1dfb-8afa-4451630b4013.htm) | 获取或设置当前PLC的站号信息 |
...
| 受保护的方法 | [GetNewNetMessage](d251f06a-bd42-6599-8124-69b02a671cb5.htm) | 获取一个新的消息对象的方法，需要在继承类里面进行重写  The method to get a new message object needs to be overridden in the inheritance class (重写 [BinaryCommunicationGetNewNetMessage](16636a1b-a6f0-9c0f-9d9c-c94e26c67459.htm).) |
| 公共方法 | GetType | (继承自 Object。) |
| 受保护的方法 | [GetWordLength](9993760e-0ce2-4bd2-1ffa-baf9ce30566b.htm) | 一个字单位的数据表示的地址长度，西门子为2，三菱，欧姆龙，modbusTcp就为1，AB PLC无效  The address length represented by one word of data, Siemens is 2, Mitsubishi, Omron, modbusTcp is 1, AB PLC is invalid (重写 [DeviceCommunicationGetWordLength(String, Int32, Int32)](c27821ea-1739-8eb9-a848-23a00828fec8.htm).) |
...
| 公共方法 | [Read(String, UInt16)](a55c363d-95b4-50b2-3d4a-c5b51b0d8f36.htm) | 批量读取字节数组信息，需要指定地址和长度，返回原始的字节数组  Batch read byte array information, need to specify the address and length, return the original byte array (重写 [DeviceCommunicationRead(String, UInt16)](9dd09452-c200-bc65-75ff-69aa34b366d4.htm).) |
...
| 公共方法 | [ReadBool(String, UInt16)](9892307e-4f47-6407-8ca6-acc944502d27.htm) | 批量读取Boolean数组信息，需要指定地址和长度，返回Boolean 数组  Batch read Boolean array information, need to specify the address and length, return Boolean array (重写 [DeviceCommunicationReadBool(String, UInt16)](69d0d24f-34a7-5b41-5c1b-619edc7e6b54.htm).) |
...
| 公共方法 | [ToString](2fbd3533-028c-85e8-4773-cf1607f054f0.htm) | (重写 [DeviceSerialPortToString](774e7804-97ce-fb07-3764-39fb1ca2e1e7.htm).) |
...
| 公共方法 | [Write(String, Boolean)](6c11750c-f4c4-6510-e52d-3d9f21b10e70.htm) | 批量写入Boolean数组数据，返回是否成功  Batch write Boolean array data, return whether the write was successful (重写 [DeviceCommunicationWrite(String, Boolean)](5b046c82-3d8e-550b-fdf3-41ca5558169b.htm).) |
| 公共方法 | [Write(String, Byte)](b415f8ce-6057-8595-3a64-5bb83578c48a.htm) | 写入原始的byte数组数据到指定的地址，返回是否写入成功  Write the original byte array data to the specified address, and return whether the write was successful (重写 [DeviceCommunicationWrite(String, Byte)](b5536dd6-ccde-6883-ac27-bff9e4b37806.htm).) |
...
[HslCommunication.Profinet.Vigor 命名空间](90223bb0-43b8-8f62-127b-57641fcfd1ed.htm)
...
[原文連結](http://api.hslcommunication.cn/html/c70ae26d-51b6-acc6-a14a-fa4a6a9ff10b.htm)
...
[VigorSerial 类](6fd92c6a-1dd9-ff59-7719-a29336143c03.htm)
...
[原文連結](http://api.hslcommunication.cn/html/47f2ff47-2914-5da8-5d6b-668758dfe8a7.htm)
...
[Station 属性](../html/b4f04c6f-9a11-1dfb-8afa-4451630b4013.htm "Station 属性 ")
...
[VigorSerial](6fd92c6a-1dd9-ff59-7719-a29336143c03.htm) 类型公开以下成员。
...
[原文連結](http://api.hslcommunication.cn/html/b4f04c6f-9a11-1dfb-8afa-4451630b4013.htm)
...
[原文連結](http://api.hslcommunication.cn/html/134b5dec-0318-ed98-2ab5-dcd727dc5ead.htm)
...
[GetNewNetMessage 方法](../html/d251f06a-bd42-6599-8124-69b02a671cb5.htm "GetNewNetMessage 方法 ")

[GetWordLength 方法](../html/9993760e-0ce2-4bd2-1ffa-baf9ce30566b.htm "GetWordLength 方法 ")

[Read 方法](../html/e01c4e84-72a9-2e52-0330-82fad669c578.htm "Read 方法 ")

[ReadBool 方法](../html/8dd8320b-a192-acdf-c0b8-cb7bd6f77b0e.htm "ReadBool 方法 ")

[ToString 方法](../html/2fbd3533-028c-85e8-4773-cf1607f054f0.htm "ToString 方法 ")

[Write 方法](../html/990c61be-0c20-5eb3-c360-d2df4f9aec5d.htm "Write 方法 ")
...
[原文連結](http://api.hslcommunication.cn/html/d251f06a-bd42-6599-8124-69b02a671cb5.htm)
...
|  |
| --- |
| VigorSerialGetNewNetMessage 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/9993760e-0ce2-4bd2-1ffa-baf9ce30566b.htm)
...
```
protected override ushort GetWordLength(
	string address,
	int length,
	int dataTypeLength
)
...
```
Protected Overrides Function GetWordLength ( 
	address As String,
	length As Integer,
...
[缺少 "M:HslCommunication.Profinet.Vigor.VigorSerial.GetWordLength(System.String,System.Int32,System.Int32)" 的 <returns> 文档]
...
[原文連結](http://api.hslcommunication.cn/html/e01c4e84-72a9-2e52-0330-82fad669c578.htm)
...
[Read 方法 (String, UInt16)](../html/a55c363d-95b4-50b2-3d4a-c5b51b0d8f36.htm "Read 方法 (String, UInt16)")
...
[原文連結](http://api.hslcommunication.cn/html/a55c363d-95b4-50b2-3d4a-c5b51b0d8f36.htm)
...
|  |
| --- |
| VigorSerialRead 方法 (String, UInt16) |
...
[Read 重载](e01c4e84-72a9-2e52-0330-82fad669c578.htm)
...
[原文連結](http://api.hslcommunication.cn/html/8dd8320b-a192-acdf-c0b8-cb7bd6f77b0e.htm)
...
[ReadBool 方法 (String, UInt16)](../html/9892307e-4f47-6407-8ca6-acc944502d27.htm "ReadBool 方法 (String, UInt16)")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| VigorSerialReadBool 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/9892307e-4f47-6407-8ca6-acc944502d27.htm)
...
|  |
| --- |
| VigorSerialReadBool 方法 (String, UInt16) |
...
[ReadBool 重载](8dd8320b-a192-acdf-c0b8-cb7bd6f77b0e.htm)
...
[原文連結](http://api.hslcommunication.cn/html/2fbd3533-028c-85e8-4773-cf1607f054f0.htm)
...
|  |
| --- |
| VigorSerialToString 方法 |

[缺少 "M:HslCommunication.Profinet.Vigor.VigorSerial.ToString" 的 <summary> 文档]
...
[缺少 "M:HslCommunication.Profinet.Vigor.VigorSerial.ToString" 的 <returns> 文档]
...
[原文連結](http://api.hslcommunication.cn/html/990c61be-0c20-5eb3-c360-d2df4f9aec5d.htm)
...
[Write 方法 (String, Boolean[])](../html/6c11750c-f4c4-6510-e52d-3d9f21b10e70.htm "Write 方法 (String, Boolean[])")

[Write 方法 (String, Byte[])](../html/b415f8ce-6057-8595-3a64-5bb83578c48a.htm "Write 方法 (String, Byte[])")
...
[原文連結](http://api.hslcommunication.cn/html/6c11750c-f4c4-6510-e52d-3d9f21b10e70.htm)
...
|  |
| --- |
| VigorSerialWrite 方法 (String, Boolean) |
...
[Write 重载](990c61be-0c20-5eb3-c360-d2df4f9aec5d.htm)
...
[原文連結](http://api.hslcommunication.cn/html/b415f8ce-6057-8595-3a64-5bb83578c48a.htm)
...
|  |
| --- |
| VigorSerialWrite 方法 (String, Byte) |
...
[原文連結](http://api.hslcommunication.cn/html/00ae08e9-1bd1-3838-6732-27982710e869.htm)
...
---
## VigorSerialOverTcp 类

[原文連結](http://api.hslcommunication.cn/html/3f641415-2ac4-e0dd-5874-7cddeb0da160.htm)
...
[VigorSerialOverTcp 构造函数](../html/567a75d9-a71c-7001-f945-1c1fb74a782b.htm "VigorSerialOverTcp 构造函数 ")

[VigorSerialOverTcp 属性](../html/1a814ec4-8152-bff4-f84c-f50afd8abcf9.htm "VigorSerialOverTcp 属性")

[VigorSerialOverTcp 方法](../html/1f029f95-1309-30d7-005e-f2d9dd298992.htm "VigorSerialOverTcp 方法")

[VigorSerialOverTcp 字段](../html/4621c139-7609-b3b5-1f3d-419865b40a2d.htm "VigorSerialOverTcp 字段")
...
丰炜通信协议的网口透传版本，支持VS系列，地址支持携带站号，例如 s=2;D100, 字地址支持 D,SD,R,T,C(C200-C255是32位寄存器), 位地址支持X,Y,M,SM,S,TS(定时器触点),TC（定时器线圈）,CS(计数器触点),CC（计数器线圈)  
The network port transparent transmission version of Fengwei communication protocol supports VS series, and the address supports carrying station number,
such as s=2;D100, word address supports D, SD, R, T, C (C200-C255 are 32-bit registers), Bit address supports X, Y, M, SM, S, TS (timer contact),
TC (timer coil), CS (counter contact), CC (counter coil)
...
        HslCommunication.Profinet.VigorVigorSerialOverTcp
...
```
Public Class VigorSerialOverTcp
	Inherits DeviceTcpNet
```

```
public ref class VigorSerialOverTcp : public DeviceTcpNet
```

```
type VigorSerialOverTcp =  
    class
        inherit DeviceTcpNet
    end
```

VigorSerialOverTcp 类型公开以下成员。

![](../icons/SectionExpanded.png)构造函数

|  | 名称 | 说明 |
| --- | --- | --- |
| 公共方法 | [VigorSerialOverTcp](aaf14074-8a48-9819-2a4d-09d2898d2572.htm) | 实例化默认的构造方法  Instantiate the default constructor |
| 公共方法 | [VigorSerialOverTcp(String, Int32)](4098019e-2b43-c03b-dae0-c19340943c32.htm) | 使用指定的ip地址和端口来实例化一个对象  Instantiate an object with the specified IP address and port |
...
| 公共属性 | [Station](3fa265e9-8f0d-3f28-74c2-482c680c8b73.htm) | 获取或设置当前PLC的站号信息 |
| 受保护的属性 | [WordLength](f1a505cc-e85c-6c8b-b189-58a1ab5753f9.htm) | 一个字单位的数据表示的地址长度，西门子为2，三菱，欧姆龙，modbusTcp就为1，AB PLC无效  The address length represented by one word of data, Siemens is 2, Mitsubishi, Omron, modbusTcp is 1, AB PLC is invalid (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
...
| 公共方法 | GetHashCode | (继承自 Object。) |
| 受保护的方法 | [GetLogTextFromBinary](67f3b2f7-957c-fa0b-8320-6799237157db.htm) | 获取当前的报文进行日志记录的时候，是否使用二进制的格式记录，默认返回 [LogMsgFormatBinary](2ed2ff87-caec-0e44-f08b-e2b015225a58.htm)，重写可以根据session对象分别返回不同记录模式  Whether to log the current packet in binary format, the default return is [LogMsgFormatBinary](2ed2ff87-caec-0e44-f08b-e2b015225a58.htm). If you want to override it, different recording modes can be returned according to session (继承自 [BinaryCommunication](1edb8336-6f5d-2697-7b3b-911625a330f6.htm)。) |
| 受保护的方法 | [GetNewNetMessage](b165e408-4bdb-2011-7dd0-6e293458cf2a.htm) | 获取一个新的消息对象的方法，需要在继承类里面进行重写  The method to get a new message object needs to be overridden in the inheritance class (重写 [BinaryCommunicationGetNewNetMessage](16636a1b-a6f0-9c0f-9d9c-c94e26c67459.htm).) |
| 公共方法 | GetType | (继承自 Object。) |
...
| 受保护的方法 | MemberwiseClone | (继承自 Object。) |
| 公共方法 | [PackCommandWithHeader](d0b2cd76-c306-11fc-38c7-af8ad306cce7.htm) | 对当前的命令进行打包处理，通常是携带命令头内容，标记当前的命令的长度信息，需要进行重写，否则默认不打包  The current command is packaged, usually carrying the content of the command header, marking the length of the current command, and it needs to be rewritten, otherwise it is not packaged by default (继承自 [BinaryCommunication](1edb8336-6f5d-2697-7b3b-911625a330f6.htm)。) |
| 公共方法 | [Read(String, UInt16)](9ff92445-85c9-1bf5-d2dd-2a1af6bf09a4.htm) | 批量读取字节数组信息，需要指定地址和长度，返回原始的字节数组  Batch read byte array information, need to specify the address and length, return the original byte array (重写 [DeviceCommunicationRead(String, UInt16)](9dd09452-c200-bc65-75ff-69aa34b366d4.htm).) |
| 公共方法代码示例 | [ReadT](95abe064-5594-5ae7-a849-98c53f88fee0.htm) | 读取支持Hsl特性的数据内容，该特性为[HslDeviceAddressAttribute](e39ddd01-95cf-ea40-1f29-20801dddfbe0.htm)，详细参考api文档说明，或是官网的详细文档  Read the data content of the Hsl attribute. The attribute is [HslDeviceAddressAttribute](e39ddd01-95cf-ea40-1f29-20801dddfbe0.htm), please refer to the api documentation for details. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法 | [ReadAsync(String, UInt16)](98575375-2f8f-b3e7-dd3f-299a39fabc28.htm) | 批量读取字节数组信息，需要指定地址和长度，返回原始的字节数组  Batch read byte array information, need to specify the address and length, return the original byte array (重写 [DeviceCommunicationReadAsync(String, UInt16)](d8c14d37-56dc-2a31-1a19-3e2b5b65197d.htm).) |
| 公共方法代码示例 | [ReadAsyncT](0522e740-4bf0-2e31-c4c5-e41384321b37.htm) | 异步读取支持Hsl特性的数据内容，该特性为[HslDeviceAddressAttribute](e39ddd01-95cf-ea40-1f29-20801dddfbe0.htm)，详细参考api文档说明  Asynchronously read the data content of the Hsl attribute. The attribute is [HslDeviceAddressAttribute](e39ddd01-95cf-ea40-1f29-20801dddfbe0.htm), please refer to the api documentation for details. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法 | [ReadBool(String)](9b2faa2e-eaa9-7ace-c49f-7a0318f1df1a.htm) | 读取单个的Boolean数据信息  Read a single Boolean data message (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法 | [ReadBool(String, UInt16)](d65a7c87-6305-86a7-a94c-69e2ec01f33f.htm) | 批量读取Boolean数组信息，需要指定地址和长度，返回Boolean 数组  Batch read Boolean array information, need to specify the address and length, return Boolean array (重写 [DeviceCommunicationReadBool(String, UInt16)](69d0d24f-34a7-5b41-5c1b-619edc7e6b54.htm).) |
| 公共方法 | [ReadBoolAsync(String)](cc37da1f-d673-fe67-78ee-4e465d29a2bd.htm) | 异步读取单个的Boolean数据信息  Asynchronously read a single Boolean data message (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法 | [ReadBoolAsync(String, UInt16)](c33084eb-c7ee-785f-2e35-5cd12e998054.htm) | 批量读取Boolean数组信息，需要指定地址和长度，返回Boolean 数组  Batch read Boolean array information, need to specify the address and length, return Boolean array (重写 [DeviceCommunicationReadBoolAsync(String, UInt16)](a45d383d-0095-3ea7-32f8-e75af88d60f8.htm).) |
| 公共方法代码示例 | [ReadCustomerT(String)](ca069688-d8f0-7dbd-e962-86a10dce83cf.htm) | 读取自定义的数据类型，需要继承自IDataTransfer接口，返回一个新的类型的实例对象。  To read a custom data type, you need to inherit from the IDataTransfer interface and return an instance object of a new type. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法代码示例 | [ReadCustomerT(String, T)](ca7dc1a1-c97d-689f-9819-4dae4af67206.htm) | 读取自定义的数据类型，需要继承自IDataTransfer接口，传入一个实例，对这个实例进行赋值，并返回该实例的对象。  To read a custom data type, you need to inherit from the IDataTransfer interface, pass in an instance, assign a value to this instance, and return the object of the instance. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法代码示例 | [ReadCustomerAsyncT(String)](f3fcda2b-255d-aadd-567e-c7b3df3636d9.htm) | 读取自定义的数据类型，需要继承自IDataTransfer接口，返回一个新的类型的实例对象。  To read a custom data type, you need to inherit from the IDataTransfer interface and return an instance object of a new type. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法代码示例 | [ReadCustomerAsyncT(String, T)](527c9fae-4743-6ebd-7b9a-5ef3a8b7c455.htm) | 读取自定义的数据类型，需要继承自IDataTransfer接口，传入一个实例，对这个实例进行赋值，并返回该实例的对象。  To read a custom data type, you need to inherit from the IDataTransfer interface, pass in an instance, assign a value to this instance, and return the object of the instance. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
...
| 公共方法 | [ToString](f1fe2a5d-242e-24fd-d3e6-d68ee1084193.htm) | (重写 [DeviceTcpNetToString](209a196b-90ea-2b73-e915-ce4b11f1263d.htm).) |
| 公共方法 | [UnpackResponseContent](208017a7-8da2-33f8-3273-d7e7e850100f.htm) | 根据对方返回的报文命令，对命令进行基本的拆包，例如各种Modbus协议拆包为统一的核心报文，还支持对报文的验证  According to the message command returned by the other party, the command is basically unpacked, for example, various Modbus protocols are unpacked into a unified core message, and the verification of the message is also supported (继承自 [BinaryCommunication](1edb8336-6f5d-2697-7b3b-911625a330f6.htm)。) |
| 公共方法 | [Wait(String, Boolean, Int32, Int32)](0e4db26e-1177-2b18-9492-ba05afb6fcc4.htm) | 等待指定地址的Boolean值为指定的值，可以指定刷新数据的频率，等待的超时时间，如果超时时间为-1的话，则是无期限等待。  Waiting for the Boolean value of the specified address to be the specified value, you can specify the frequency of refreshing the data, and the timeout time to wait. If the timeout time is -1, it is an indefinite wait. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法 | [Wait(String, Int16, Int32, Int32)](e06fe098-8c8b-83f9-73ca-2a7cce19d43d.htm) | 等待指定地址的Int16值为指定的值，可以指定刷新数据的频率，等待的超时时间，如果超时时间为-1的话，则是无期限等待。  Waiting for the Int16 value of the specified address to be the specified value, you can specify the frequency of refreshing the data, and the timeout time to wait. If the timeout time is -1, it is an indefinite wait. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法 | [Wait(String, Int32, Int32, Int32)](1bce0aae-27e9-f1d6-e8f3-25ae6b47554e.htm) | 等待指定地址的Int32值为指定的值，可以指定刷新数据的频率，等待的超时时间，如果超时时间为-1的话，则是无期限等待。  Waiting for the Int32 value of the specified address to be the specified value, you can specify the frequency of refreshing the data, and the timeout time to wait. If the timeout time is -1, it is an indefinite wait. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
...
| 公共方法代码示例 | [Write(String, UInt64)](4924086e-9b36-d446-4ae4-6682134a6ad1.htm) | 写入ulong数据，返回是否成功  Write ulong data, return whether the write was successful (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法代码示例 | [Write(String, UInt64)](b1131bdd-8b51-ec6d-dd0e-fec1f6cb51b6.htm) | 写入ulong数组，返回是否成功  Write ulong array, return whether the write was successful (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法 | [Write(String, Boolean)](0bacd2da-d696-de93-7e92-8425fbf3de6f.htm) | 批量写入Boolean数组数据，返回是否成功  Batch write Boolean array data, return whether the write was successful (重写 [DeviceCommunicationWrite(String, Boolean)](5b046c82-3d8e-550b-fdf3-41ca5558169b.htm).) |
| 公共方法 | [Write(String, Byte)](dbb1cae0-a563-5484-c09e-2a929baca942.htm) | 写入原始的byte数组数据到指定的地址，返回是否写入成功  Write the original byte array data to the specified address, and return whether the write was successful (重写 [DeviceCommunicationWrite(String, Byte)](b5536dd6-ccde-6883-ac27-bff9e4b37806.htm).) |
| 公共方法代码示例 | [Write(String, String, Int32)](02fe2ca9-49a3-ede4-d1af-8c6da1f644da.htm) | 写入指定长度的字符串信息，如果超出，就截断字符串，如果长度不足，那就补0操作，编码为ASCII  Write string information of the specified length. If it exceeds the value, the string is truncated. If the length is not enough, it is filled with 0 and the encoding is ASCII. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法代码示例 | [Write(String, String, Encoding)](7b602661-902d-2b70-1fdb-ba87ecd307bf.htm) | 写入字符串信息，需要指定的编码信息  Write string information, need to specify the encoding information (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法代码示例 | [Write(String, String, Int32, Encoding)](e8cb30d9-4c5e-6c68-b9af-1b1b6c2dc714.htm) | 写入指定长度的字符串信息，如果超出，就截断字符串，如果长度不足，那就补0操作，编码为指定的编码信息  Write string information of the specified length. If it exceeds the value, the string is truncated. If the length is not enough, then the operation is complemented with 0 , you should specified the encoding information (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法代码示例 | [WriteT(T)](9f48853f-fbeb-c37d-25a2-1c76d1dee407.htm) | 写入支持Hsl特性的数据，返回是否写入成功，该特性为[HslDeviceAddressAttribute](e39ddd01-95cf-ea40-1f29-20801dddfbe0.htm)，详细参考api文档说明  Write data that supports the Hsl attribute, and return whether the write was successful. The attribute is [HslDeviceAddressAttribute](e39ddd01-95cf-ea40-1f29-20801dddfbe0.htm), please refer to the api documentation for details. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
...
| 公共方法代码示例 | [WriteAsync(String, UInt64)](e396074d-6cf1-b45d-5e8e-01026f6e391b.htm) | 异步写入ulong数据，返回是否成功  Asynchronously write ulong data, return whether the write was successful (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法代码示例 | [WriteAsync(String, UInt64)](ae3df8ec-29c0-42ff-3d6a-68f496997b3d.htm) | 异步写入ulong数组，返回是否成功  Asynchronously write ulong array, return whether the write was successful (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法 | [WriteAsync(String, Boolean)](5c820875-1bce-1704-7c87-17887114856b.htm) | 批量写入Boolean数组数据，返回是否成功  Batch write Boolean array data, return whether the write was successful (重写 [DeviceCommunicationWriteAsync(String, Boolean)](fe872dae-7ef9-12c1-d883-e92ba8676416.htm).) |
| 公共方法 | [WriteAsync(String, Byte)](f4a2d292-f23d-7a51-e453-d93749d8153b.htm) | 写入原始的byte数组数据到指定的地址，返回是否写入成功  Write the original byte array data to the specified address, and return whether the write was successful (重写 [DeviceCommunicationWriteAsync(String, Byte)](8f1cec30-8b86-6749-c8f3-7d39168d59df.htm).) |
| 公共方法 | [WriteAsync(String, String, Int32)](b739b983-b03c-8ecf-2713-75f19233ae2f.htm) | 异步写入指定长度的字符串信息，如果超出，就截断字符串，如果长度不足，那就补0操作，编码为ASCII  Asynchronously write string information of the specified length. If it exceeds the value, the string is truncated. If the length is not enough, it is filled with 0 and the encoding is ASCII. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法代码示例 | [WriteAsync(String, String, Encoding)](876e9800-0406-6407-bdf8-8ab1cf28df38.htm) | 异步写入字符串信息，需要指定的编码信息  Asynchronously write string information, need to specify the encoding information (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法 | [WriteAsync(String, String, Int32, Encoding)](ae9fb2a3-fddb-48eb-e9ad-6cc0ebbac1f6.htm) | 异步写入指定长度的字符串信息，如果超出，就截断字符串，如果长度不足，那就补0操作，编码为指定的编码信息  Asynchronously write string information of the specified length. If it exceeds the value, the string is truncated. If the length is not enough, then the operation is complemented with 0 , you should specified the encoding information (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
| 公共方法代码示例 | [WriteAsyncT(T)](25d96e77-d1b2-918c-33f9-e5e4cc57c9cd.htm) | 异步写入支持Hsl特性的数据，返回是否写入成功，该特性为[HslDeviceAddressAttribute](e39ddd01-95cf-ea40-1f29-20801dddfbe0.htm)，详细参考api文档说明  Asynchronously write data that supports the Hsl attribute, and return whether the write was successful. The attribute is [HslDeviceAddressAttribute](e39ddd01-95cf-ea40-1f29-20801dddfbe0.htm), please refer to the api documentation for details. (继承自 [DeviceCommunication](d345c980-d488-c83d-72ce-f958039275db.htm)。) |
...
---
## VigorSerialOverTcp 构造函数 

[原文連結](http://api.hslcommunication.cn/html/567a75d9-a71c-7001-f945-1c1fb74a782b.htm)
...
[VigorSerialOverTcp 构造函数](../html/aaf14074-8a48-9819-2a4d-09d2898d2572.htm "VigorSerialOverTcp 构造函数 ")

[VigorSerialOverTcp 构造函数 (String, Int32)](../html/4098019e-2b43-c03b-dae0-c19340943c32.htm "VigorSerialOverTcp 构造函数 (String, Int32)")
...
[VigorSerialOverTcp 类](3f641415-2ac4-e0dd-5874-7cddeb0da160.htm)
...
[原文連結](http://api.hslcommunication.cn/html/aaf14074-8a48-9819-2a4d-09d2898d2572.htm)
...
[VigorSerialOverTcp 重载](567a75d9-a71c-7001-f945-1c1fb74a782b.htm)
...
---
## VigorSerialOverTcp 构造函数 (String, Int32)

[原文連結](http://api.hslcommunication.cn/html/4098019e-2b43-c03b-dae0-c19340943c32.htm)
...
---
## VigorSerialOverTcp 属性

[原文連結](http://api.hslcommunication.cn/html/1a814ec4-8152-bff4-f84c-f50afd8abcf9.htm)
...
[Station 属性](../html/3fa265e9-8f0d-3f28-74c2-482c680c8b73.htm "Station 属性 ")
...
[VigorSerialOverTcp](3f641415-2ac4-e0dd-5874-7cddeb0da160.htm) 类型公开以下成员。
...
[原文連結](http://api.hslcommunication.cn/html/3fa265e9-8f0d-3f28-74c2-482c680c8b73.htm)
...
---
## VigorSerialOverTcp 方法

[原文連結](http://api.hslcommunication.cn/html/1f029f95-1309-30d7-005e-f2d9dd298992.htm)
...
[GetNewNetMessage 方法](../html/b165e408-4bdb-2011-7dd0-6e293458cf2a.htm "GetNewNetMessage 方法 ")

[Read 方法](../html/5f7e6663-b65c-b958-a5f8-19b659dc0ecc.htm "Read 方法 ")

[ReadAsync 方法](../html/fe4985cc-1319-06ee-8ca1-cc0a31df9f0d.htm "ReadAsync 方法 ")

[ReadBool 方法](../html/6d5e4eaf-0f3f-7ff9-7313-a74b178153b4.htm "ReadBool 方法 ")

[ReadBoolAsync 方法](../html/1f38c011-a77e-c4f8-bbeb-534aa69f9fb4.htm "ReadBoolAsync 方法 ")

[ToString 方法](../html/f1fe2a5d-242e-24fd-d3e6-d68ee1084193.htm "ToString 方法 ")

[Write 方法](../html/9f82a48c-c7c3-6fb9-a855-da27c9829880.htm "Write 方法 ")

[WriteAsync 方法](../html/8adb6028-b786-0c38-8803-0151a70d3772.htm "WriteAsync 方法 ")
...
[原文連結](http://api.hslcommunication.cn/html/b165e408-4bdb-2011-7dd0-6e293458cf2a.htm)
...
|  |
| --- |
| VigorSerialOverTcpGetNewNetMessage 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/5f7e6663-b65c-b958-a5f8-19b659dc0ecc.htm)
...
[Read 方法 (String, UInt16)](../html/9ff92445-85c9-1bf5-d2dd-2a1af6bf09a4.htm "Read 方法 (String, UInt16)")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| VigorSerialOverTcpRead 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/9ff92445-85c9-1bf5-d2dd-2a1af6bf09a4.htm)
...
|  |
| --- |
| VigorSerialOverTcpRead 方法 (String, UInt16) |
...
[Read 重载](5f7e6663-b65c-b958-a5f8-19b659dc0ecc.htm)
...
[原文連結](http://api.hslcommunication.cn/html/fe4985cc-1319-06ee-8ca1-cc0a31df9f0d.htm)
...
[ReadAsync 方法 (String, UInt16)](../html/98575375-2f8f-b3e7-dd3f-299a39fabc28.htm "ReadAsync 方法 (String, UInt16)")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| VigorSerialOverTcpReadAsync 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/98575375-2f8f-b3e7-dd3f-299a39fabc28.htm)
...
|  |
| --- |
| VigorSerialOverTcpReadAsync 方法 (String, UInt16) |
...
[ReadAsync 重载](fe4985cc-1319-06ee-8ca1-cc0a31df9f0d.htm)
...
[原文連結](http://api.hslcommunication.cn/html/6d5e4eaf-0f3f-7ff9-7313-a74b178153b4.htm)
...
[ReadBool 方法 (String, UInt16)](../html/d65a7c87-6305-86a7-a94c-69e2ec01f33f.htm "ReadBool 方法 (String, UInt16)")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| VigorSerialOverTcpReadBool 方法 |
