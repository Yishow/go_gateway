# HslCommunication - HslCommunication.Profinet.XINJE
...
[原文連結](http://api.hslcommunication.cn/html/55c60947-491c-64b8-20f6-5f82e6aa6859.htm)

HslCommunication Library Document

[HslCommunication Library Document](../html\c136d3de-eab7-9b0f-4bdf-d891297c8018.htm "HslCommunication Library Document")

[HslCommunication.Profinet.XINJE](../html/55c60947-491c-64b8-20f6-5f82e6aa6859.htm "HslCommunication.Profinet.XINJE")

[XinJEHelper 类](../html/19038b75-d848-5a1f-0389-39e435537088.htm "XinJEHelper 类")

[XinJEInternalNet 类](../html/ca636a22-46ab-2bfd-4e31-499ea0f9884b.htm "XinJEInternalNet 类")

[XinJESerial 类](../html/d3938272-556e-2aff-1909-94be043c2866.htm "XinJESerial 类")

[XinJESerialOverTcp 类](../html/c756b605-1e16-e2d4-3120-ddca1734a554.htm "XinJESerialOverTcp 类")

[XinJESeries 枚举](../html/cd6da7c9-8a93-8828-7fb9-44415c0c7a4b.htm "XinJESeries 枚举")

[XinJEServer 类](../html/612b4747-3940-d1a8-587a-e43c80c4ecde.htm "XinJEServer 类")

[XinJETcpNet 类](../html/e8181c20-8669-a20b-613b-1ff6ed96b8fd.htm "XinJETcpNet 类")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| HslCommunication.Profinet.XINJE 命名空间 |

[缺少 "N:HslCommunication.Profinet.XINJE" 的 <summary> 文档]

![](../icons/SectionExpanded.png)类

|  | 类 | 说明 |
| --- | --- | --- |
| 公共类 | [XinJEHelper](19038b75-d848-5a1f-0389-39e435537088.htm) | 信捷PLC的相关辅助类 |
| 公共类 | [XinJEInternalNet](ca636a22-46ab-2bfd-4e31-499ea0f9884b.htm) | 信捷内部的TCP信息，该协议是信捷基于modbus协议扩展而来，支持更多的地址类型，以及更广泛的地址范围。具体参考Demo界面信息。  The TCP information inside Xinjie, which is extended by Xinjie based on the modbus protocol, supports more address types and a wider range of addresses. For details, refer to the Demo UI. |
| 公共类 | [XinJESerial](d3938272-556e-2aff-1909-94be043c2866.htm) | 信捷PLC的XC,XD,XL系列的串口通讯类，底层使用ModbusRtu协议实现，每个系列支持的地址类型及范围不一样，详细参考DEMO程序说明  XC, XD, XL series serial communication of Xinje PLC, the bottom layer is implemented by ModbusRtu protocol, the address type and range supported by each series are different, please refer to the Demo for details |
| 公共类 | [XinJESerialOverTcp](c756b605-1e16-e2d4-3120-ddca1734a554.htm) | 信捷PLC的XC,XD,XL系列的串口转网口通讯类，虽然硬件层走的是TCP协议，但是底层使用ModbusRtu协议实现，每个系列支持的地址类型及范围不一样，详细参考Demo程序  Xinje PLC's XC, XD, XL series serial port to network port communication type, although the hardware layer uses TCP protocol, but the bottom layer is implemented by ModbusRtu protocol. The address types and ranges supported by each series are different. Please refer to the DEMO for details. |
| 公共类 | [XinJEServer](612b4747-3940-d1a8-587a-e43c80c4ecde.htm) | 信捷内部TCP的虚拟服务器类，基于Modbus的虚拟服务器扩展而来，从服务上只支持modbus地址读写，从客户端额外支持M,D,SD,SM,HD 五个数据区  Xinjie's internal TCP virtual server class, based on Modbus virtual server extension, only supports modbus address reading and writing from the service, and additionally supports M, D, SD, SM, HD five data areas from the client |
| 公共类 | [XinJETcpNet](e8181c20-8669-a20b-613b-1ff6ed96b8fd.htm) | 信捷PLC的XC,XD,XL系列的网口通讯类，底层使用ModbusTcp协议实现，每个系列支持的地址类型及范围不一样，详细参考Demo程序  XC, XD, XL series of Xinje PLC's network port communication class, the bottom layer is realized by ModbusTcp protocol, each series supports different address types and ranges, please refer to the Demo for details |

![](../icons/SectionExpanded.png)枚举

|  | 枚举 | 说明 |
| --- | --- | --- |
| 公共枚举 | [XinJESeries](cd6da7c9-8a93-8828-7fb9-44415c0c7a4b.htm) | 信捷PLC的不同系列的枚举 |
...
[原文連結](http://api.hslcommunication.cn/html/19038b75-d848-5a1f-0389-39e435537088.htm)
...
[XinJEHelper 构造函数](../html/c571cc51-d4fe-c670-8158-eadbc5ffba9e.htm "XinJEHelper 构造函数 ")

[XinJEHelper 方法](../html/38a38f3a-daf0-90c0-63b0-c084dc676847.htm "XinJEHelper 方法")
...
SystemObject  
  HslCommunication.Profinet.XINJEXinJEHelper

**命名空间：**
 [HslCommunication.Profinet.XINJE](55c60947-491c-64b8-20f6-5f82e6aa6859.htm)  
**程序集：**
...
```
public ref class XinJEHelper
```

```
type XinJEHelper =  class end
```

XinJEHelper 类型公开以下成员。

![](../icons/SectionExpanded.png)构造函数

|  | 名称 | 说明 |
| --- | --- | --- |
| 公共方法 | [XinJEHelper](c571cc51-d4fe-c670-8158-eadbc5ffba9e.htm) | 初始化 XinJEHelper 类的一个新实例 |
...
| 公共方法静态成员 | [PraseXinJEAddress](b0d83d6e-8144-9f2f-3cfc-190c68302cd4.htm) | 根据信捷PLC的地址，解析出转换后的modbus协议信息 |
| 公共方法静态成员 | [PraseXinJEXCAddress](57aaada1-b71f-6a2b-c32a-d2eaa53616df.htm) | 根据信捷PLC的地址，解析出转换后的modbus协议信息，适用XC系列 |
| 公共方法静态成员 | [PraseXinJEXD1XD2XD3XL1XL3Address](bdd08cca-76e9-699d-677e-24b0f23fb1bf.htm) | 解析信捷的XD1,XD2,XD3,XL1,XL3系列的PLC的Modbus地址和内部软元件的对照 |
...
[HslCommunication.Profinet.XINJE 命名空间](55c60947-491c-64b8-20f6-5f82e6aa6859.htm)
...
[原文連結](http://api.hslcommunication.cn/html/c571cc51-d4fe-c670-8158-eadbc5ffba9e.htm)
...
初始化 [XinJEHelper](19038b75-d848-5a1f-0389-39e435537088.htm) 类的一个新实例
...
[XinJEHelper 类](19038b75-d848-5a1f-0389-39e435537088.htm)
...
[原文連結](http://api.hslcommunication.cn/html/38a38f3a-daf0-90c0-63b0-c084dc676847.htm)
...
[PraseXinJEAddress 方法](../html/b0d83d6e-8144-9f2f-3cfc-190c68302cd4.htm "PraseXinJEAddress 方法 ")

[PraseXinJEXCAddress 方法](../html/57aaada1-b71f-6a2b-c32a-d2eaa53616df.htm "PraseXinJEXCAddress 方法 ")

[PraseXinJEXD1XD2XD3XL1XL3Address 方法](../html/bdd08cca-76e9-699d-677e-24b0f23fb1bf.htm "PraseXinJEXD1XD2XD3XL1XL3Address 方法 ")
...
[XinJEHelper](19038b75-d848-5a1f-0389-39e435537088.htm) 类型公开以下成员。
...
---
## PraseXinJEAddress 方法 

[原文連結](http://api.hslcommunication.cn/html/b0d83d6e-8144-9f2f-3cfc-190c68302cd4.htm)
...
|  |
| --- |
| XinJEHelperPraseXinJEAddress 方法 |
...
```
Public Shared Function PraseXinJEAddress ( 
...
```
public:
static OperateResult<String^>^ PraseXinJEAddress(
	XinJESeries series, 
	String^ address, 
...
```
static member PraseXinJEAddress : 
        series : XinJESeries * 
        address : string * 
...
series
:   类型：[HslCommunication.Profinet.XINJEXinJESeries](cd6da7c9-8a93-8828-7fb9-44415c0c7a4b.htm)  
    PLC的系列信息
...
---
## PraseXinJEXCAddress 方法 

[原文連結](http://api.hslcommunication.cn/html/57aaada1-b71f-6a2b-c32a-d2eaa53616df.htm)
...
```
Public Shared Function PraseXinJEXCAddress ( 
	station As String,
	address As String,
	modbusCode As Byte
) As OperateResult(Of String)
...
```
public:
static OperateResult<String^>^ PraseXinJEXCAddress(
	String^ station, 
	String^ address, 
	unsigned char modbusCode
)
...
```
static member PraseXinJEXCAddress : 
        station : string * 
        address : string * 
        modbusCode : byte -> OperateResult<string> 
```
...
---
## PraseXinJEXD1XD2XD3XL1XL3Address 方法 

[原文連結](http://api.hslcommunication.cn/html/bdd08cca-76e9-699d-677e-24b0f23fb1bf.htm)
...
|  |
| --- |
| XinJEHelperPraseXinJEXD1XD2XD3XL1XL3Address 方法 |
...
```
Public Shared Function PraseXinJEXD1XD2XD3XL1XL3Address ( 
	station As String,
	address As String,
	modbusCode As Byte
) As OperateResult(Of String)
...
```
public:
static OperateResult<String^>^ PraseXinJEXD1XD2XD3XL1XL3Address(
	String^ station, 
	String^ address, 
	unsigned char modbusCode
)
...
```
static member PraseXinJEXD1XD2XD3XL1XL3Address : 
        station : string * 
        address : string * 
        modbusCode : byte -> OperateResult<string> 
```
...
适用 XD1、XD2、XD3、XL1、XL3、XD5、XDM、XDC、XD5E、XDME、XL5、XL5E、XLME, XDH 只是支持的地址范围不一样而已
...
[原文連結](http://api.hslcommunication.cn/html/ca636a22-46ab-2bfd-4e31-499ea0f9884b.htm)
...
[XinJEInternalNet 构造函数](../html/cf50dc5f-a22c-b4dc-2826-fbcd601c6409.htm "XinJEInternalNet 构造函数 ")

[XinJEInternalNet 属性](../html/844cb970-776c-6b07-88e5-1893aaf40979.htm "XinJEInternalNet 属性")

[XinJEInternalNet 方法](../html/5969f75b-3ceb-387c-5449-65964c3efc36.htm "XinJEInternalNet 方法")

[XinJEInternalNet 字段](../html/d6fb5fe9-ae48-f9e6-95ed-07705e755d1a.htm "XinJEInternalNet 字段")
...
信捷内部的TCP信息，该协议是信捷基于modbus协议扩展而来，支持更多的地址类型，以及更广泛的地址范围。具体参考Demo界面信息。  
...
        HslCommunication.Profinet.XINJEXinJEInternalNet
...
```
public ref class XinJEInternalNet : public DeviceTcpNet
```

```
type XinJEInternalNet =  
    class
        inherit DeviceTcpNet
    end
```

XinJEInternalNet 类型公开以下成员。

![](../icons/SectionExpanded.png)构造函数

|  | 名称 | 说明 |
| --- | --- | --- |
| 公共方法 | [XinJEInternalNet](6a18b9b2-5811-ba70-a745-917d95f235da.htm) | 实例化一个XINJE-Tcp协议的客户端对象  Instantiate a client object of the Modbus-Tcp protocol |
| 公共方法 | [XinJEInternalNet(String, Int32, Byte)](3653cbfd-2ed1-8385-f142-52a90c3378e4.htm) | 指定服务器地址，端口号，客户端自己的站号来初始化  Specify the server address, port number, and client's own station number to initialize |
...
| 公共属性 | [DataFormat](9034d93c-13e9-b3b1-a097-447ab8220c37.htm) | 获取或设置数据解析的格式，可选ABCD, BADC，CDAB，DCBA格式，对int,uint,float,double,long,ulong类型有作用  Get or set the format of the data analysis, optional ABCD, BADC, CDAB, DCBA format, effective for int, uint, float, double, long, ulong type |
...
| 公共属性 | [IsStringReverse](401dd761-84bb-9910-ed75-87f9a174f123.htm) | 字符串数据是否按照字来反转，默认为False  Whether the string data is reversed according to words. The default is False. |
...
| 公共属性 | [Station](439e103e-d4f2-e342-6426-b16eb351803e.htm) | 获取或者重新修改服务器的默认站号信息，当然，你可以再读写的时候动态指定，参见备注  Get or modify the default station number information of the server. Of course, you can specify it dynamically when reading and writing, see note |
...
| 受保护的方法 | [GetNewNetMessage](6fd344f9-bf24-2597-d2fc-808fbf4aff56.htm) | 获取一个新的消息对象的方法，需要在继承类里面进行重写  The method to get a new message object needs to be overridden in the inheritance class (重写 [BinaryCommunicationGetNewNetMessage](16636a1b-a6f0-9c0f-9d9c-c94e26c67459.htm).) |
| 公共方法 | GetType | (继承自 Object。) |
...
| 受保护的方法 | MemberwiseClone | (继承自 Object。) |
| 公共方法 | [PackCommandWithHeader](80817ee9-72d1-7a53-1a94-1fb71647ea2b.htm) | 对当前的命令进行打包处理，通常是携带命令头内容，标记当前的命令的长度信息，需要进行重写，否则默认不打包  The current command is packaged, usually carrying the content of the command header, marking the length of the current command, and it needs to be rewritten, otherwise it is not packaged by default (重写 [BinaryCommunicationPackCommandWithHeader(Byte)](d0b2cd76-c306-11fc-38c7-af8ad306cce7.htm).) |
| 公共方法 | [Read(String, UInt16)](3dc86564-1604-6753-813c-9f3cedef9f2d.htm) | 批量读取字节数组信息，需要指定地址和长度，返回原始的字节数组  Batch read byte array information, need to specify the address and length, return the original byte array (重写 [DeviceCommunicationRead(String, UInt16)](9dd09452-c200-bc65-75ff-69aa34b366d4.htm).) |
...
| 公共方法 | [ReadAsync(String, UInt16)](28d6ce37-f463-d877-bed1-51f245133db9.htm) | 批量读取字节数组信息，需要指定地址和长度，返回原始的字节数组  Batch read byte array information, need to specify the address and length, return the original byte array (重写 [DeviceCommunicationReadAsync(String, UInt16)](d8c14d37-56dc-2a31-1a19-3e2b5b65197d.htm).) |
...
| 公共方法 | [ReadBool(String, UInt16)](0b5d9b1d-773a-15b6-696f-39b8253e17dd.htm) | 批量读取Boolean数组信息，需要指定地址和长度，返回Boolean 数组  Batch read Boolean array information, need to specify the address and length, return Boolean array (重写 [DeviceCommunicationReadBool(String, UInt16)](69d0d24f-34a7-5b41-5c1b-619edc7e6b54.htm).) |
...
| 公共方法 | [ReadBoolAsync(String, UInt16)](c435efa4-1c46-826b-991d-995312c284e6.htm) | 批量读取Boolean数组信息，需要指定地址和长度，返回Boolean 数组  Batch read Boolean array information, need to specify the address and length, return Boolean array (重写 [DeviceCommunicationReadBoolAsync(String, UInt16)](a45d383d-0095-3ea7-32f8-e75af88d60f8.htm).) |
...
| 公共方法 | [Write(String, Boolean)](cf0173d3-c0c6-f4be-b3eb-f5d9694db79a.htm) | 批量写入Boolean数组数据，返回是否成功  Batch write Boolean array data, return whether the write was successful (重写 [DeviceCommunicationWrite(String, Boolean)](5b046c82-3d8e-550b-fdf3-41ca5558169b.htm).) |
| 公共方法 | [Write(String, Byte)](93963978-41e3-5617-0258-645e26972adb.htm) | 写入原始的byte数组数据到指定的地址，返回是否写入成功  Write the original byte array data to the specified address, and return whether the write was successful (重写 [DeviceCommunicationWrite(String, Byte)](b5536dd6-ccde-6883-ac27-bff9e4b37806.htm).) |
...
| 公共方法 | [WriteAsync(String, Boolean)](0c96bdde-4889-1973-9bef-a24fdd6685bd.htm) | 批量写入Boolean数组数据，返回是否成功  Batch write Boolean array data, return whether the write was successful (重写 [DeviceCommunicationWriteAsync(String, Boolean)](fe872dae-7ef9-12c1-d883-e92ba8676416.htm).) |
| 公共方法 | [WriteAsync(String, Byte)](488bde2f-76bb-dae6-86ef-4445c3322705.htm) | 写入原始的byte数组数据到指定的地址，返回是否写入成功  Write the original byte array data to the specified address, and return whether the write was successful (重写 [DeviceCommunicationWriteAsync(String, Byte)](8f1cec30-8b86-6749-c8f3-7d39168d59df.htm).) |
...
---
## XinJEInternalNet 构造函数 

[原文連結](http://api.hslcommunication.cn/html/cf50dc5f-a22c-b4dc-2826-fbcd601c6409.htm)
...
[XinJEInternalNet 构造函数](../html/6a18b9b2-5811-ba70-a745-917d95f235da.htm "XinJEInternalNet 构造函数 ")

[XinJEInternalNet 构造函数 (String, Int32, Byte)](../html/3653cbfd-2ed1-8385-f142-52a90c3378e4.htm "XinJEInternalNet 构造函数 (String, Int32, Byte)")
...
[XinJEInternalNet 类](ca636a22-46ab-2bfd-4e31-499ea0f9884b.htm)
...
[原文連結](http://api.hslcommunication.cn/html/6a18b9b2-5811-ba70-a745-917d95f235da.htm)
...
[XinJEInternalNet 重载](cf50dc5f-a22c-b4dc-2826-fbcd601c6409.htm)
...
---
## XinJEInternalNet 构造函数 (String, Int32, Byte)

[原文連結](http://api.hslcommunication.cn/html/3653cbfd-2ed1-8385-f142-52a90c3378e4.htm)
...
[原文連結](http://api.hslcommunication.cn/html/844cb970-776c-6b07-88e5-1893aaf40979.htm)
...
[DataFormat 属性](../html/9034d93c-13e9-b3b1-a097-447ab8220c37.htm "DataFormat 属性 ")

[IsStringReverse 属性](../html/401dd761-84bb-9910-ed75-87f9a174f123.htm "IsStringReverse 属性 ")

[MessageId 属性](../html/a04f7470-82ec-351d-963f-73798c163c80.htm "MessageId 属性 ")

[Station 属性](../html/439e103e-d4f2-e342-6426-b16eb351803e.htm "Station 属性 ")
...
[XinJEInternalNet](ca636a22-46ab-2bfd-4e31-499ea0f9884b.htm) 类型公开以下成员。
...
| 公共属性 | [LocalBinding](622b418f-5969-3726-5dcc-04456c4b97a7.htm) | 获取或设置绑定的本地的IP地址和端口号信息，如果端口设置为0，代表任何可用的端口  Get or set the bound local IP address and port number information, if the port is set to 0, it means any available port (继承自 [DeviceTcpNet](09da6b9b-3727-e84e-5c46-19061382088e.htm)。) |
| 公共属性代码示例 | [LogNet](8c56f246-88ac-afb8-8c06-972fafe4f78a.htm) | 组件的日志工具，支持日志记录，只要实例化后，当前网络的基本信息，就以[DEBUG](3ce37fee-7678-e278-6a0a-7656126003b6.htm)等级进行输出  The component's logging tool supports logging. As long as the instantiation of the basic network information, the output will be output at [DEBUG](3ce37fee-7678-e278-6a0a-7656126003b6.htm) (继承自 [BinaryCommunication](1edb8336-6f5d-2697-7b3b-911625a330f6.htm)。) |
| 公共属性 | [MessageId](a04f7470-82ec-351d-963f-73798c163c80.htm) | 获取协议自增的消息号，你可以自定义modbus的消息号的规则，详细参见[XinJEInternalNet](ca636a22-46ab-2bfd-4e31-499ea0f9884b.htm)说明，也可以查找[SoftIncrementCount](fa4c7c56-11c0-0ef9-d17b-2106a420c805.htm)说明。  Get the message number incremented by the modbus protocol. You can customize the rules of the message number of the modbus. For details, please refer to the description of [ModbusTcpNet](8b0255a2-7125-a4ed-7a9c-14314e33603a.htm), or you can find the description of [SoftIncrementCount](fa4c7c56-11c0-0ef9-d17b-2106a420c805.htm) |
| 公共属性代码示例 | [Port](6f1ad24a-c916-5b67-aa17-a8c7dc2acb2e.htm) | 获取或设置服务器的端口号，具体的值需要取决于对方的配置  Gets or sets the port number of the server. The specific value depends on the configuration of the other party. (继承自 [DeviceTcpNet](09da6b9b-3727-e84e-5c46-19061382088e.htm)。) |
| 公共属性代码示例 | [ReceiveTimeOut](250560a7-332b-ce1b-5eb0-e3abe4ee6012.htm) | 获取或设置接收服务器反馈的时间，如果为负数，则不接收反馈   Gets or sets the time to receive server feedback, and if it is a negative number, does not receive feedback (继承自 [BinaryCommunication](1edb8336-6f5d-2697-7b3b-911625a330f6.htm)。) |
| 公共属性 | [SendBeforeHex](72aa1de4-116f-abfe-4adb-814a0be0e560.htm) | 获取或设置在发送通信报文前追加发送的字节信息，HEX格式，通常用于lora组网时，需要携带 00 00 00 02 四个字节的站地址功能。  Obtain or set the byte information sent before sending communication packets, HEX format, usually used for LORA networking, you need to carry 00 00 00 02 four-byte station address function. (继承自 [BinaryCommunication](1edb8336-6f5d-2697-7b3b-911625a330f6.htm)。) |
| 公共属性 | [SleepTime](86a5fbb9-3456-6beb-7113-5bbad5eabbc5.htm) | 获取或设置在正式接收对方返回数据前的时候，需要休息的时间，当设置为0的时候，不需要休息。  Get or set the time required to rest before officially receiving the data from the other party. When it is set to 0, no rest is required. (继承自 [BinaryCommunication](1edb8336-6f5d-2697-7b3b-911625a330f6.htm)。) |
...
[原文連結](http://api.hslcommunication.cn/html/9034d93c-13e9-b3b1-a097-447ab8220c37.htm)
...
```
member DataFormat : DataFormat with get, set
```
...
[原文連結](http://api.hslcommunication.cn/html/401dd761-84bb-9910-ed75-87f9a174f123.htm)
...
|  |
| --- |
| XinJEInternalNetIsStringReverse 属性 |
...
[原文連結](http://api.hslcommunication.cn/html/a04f7470-82ec-351d-963f-73798c163c80.htm)
...
获取协议自增的消息号，你可以自定义modbus的消息号的规则，详细参见[XinJEInternalNet](ca636a22-46ab-2bfd-4e31-499ea0f9884b.htm)说明，也可以查找[SoftIncrementCount](fa4c7c56-11c0-0ef9-d17b-2106a420c805.htm)说明。  
Get the message number incremented by the modbus protocol. You can customize the rules of the message number of the modbus. For details, please refer to the description of [ModbusTcpNet](8b0255a2-7125-a4ed-7a9c-14314e33603a.htm), or you can find the description of [SoftIncrementCount](fa4c7c56-11c0-0ef9-d17b-2106a420c805.htm)
...
类型：[SoftIncrementCount](fa4c7c56-11c0-0ef9-d17b-2106a420c805.htm)
...
[原文連結](http://api.hslcommunication.cn/html/439e103e-d4f2-e342-6426-b16eb351803e.htm)
...
[原文連結](http://api.hslcommunication.cn/html/5969f75b-3ceb-387c-5449-65964c3efc36.htm)
...
[GetNewNetMessage 方法](../html/6fd344f9-bf24-2597-d2fc-808fbf4aff56.htm "GetNewNetMessage 方法 ")

[PackCommandWithHeader 方法](../html/80817ee9-72d1-7a53-1a94-1fb71647ea2b.htm "PackCommandWithHeader 方法 ")

[Read 方法](../html/d4fad63d-39a0-c038-260f-3ec31b730103.htm "Read 方法 ")

[ReadAsync 方法](../html/6798f76a-fedb-cae1-861a-d97975bee490.htm "ReadAsync 方法 ")

[ReadBool 方法](../html/da4bea2a-9d70-d004-cb6b-18b5f84a2649.htm "ReadBool 方法 ")

[ReadBoolAsync 方法](../html/f324cae6-f59c-27d8-cdee-0d1abc8985fe.htm "ReadBoolAsync 方法 ")

[ToString 方法](../html/8e689c9d-2b6a-cfe1-d12a-33d12a138906.htm "ToString 方法 ")

[UnpackResponseContent 方法](../html/df2709b2-686b-dc5b-6fd4-ed6d46723969.htm "UnpackResponseContent 方法 ")

[Write 方法](../html/87b28365-43af-4bc3-3ca3-e6f150fa417e.htm "Write 方法 ")

[WriteAsync 方法](../html/54909cbe-5cd7-0a8a-a6ee-92e943257772.htm "WriteAsync 方法 ")
...
[原文連結](http://api.hslcommunication.cn/html/6fd344f9-bf24-2597-d2fc-808fbf4aff56.htm)
...
|  |
| --- |
| XinJEInternalNetGetNewNetMessage 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/80817ee9-72d1-7a53-1a94-1fb71647ea2b.htm)
...
|  |
| --- |
| XinJEInternalNetPackCommandWithHeader 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/d4fad63d-39a0-c038-260f-3ec31b730103.htm)
...
[Read 方法 (String, UInt16)](../html/3dc86564-1604-6753-813c-9f3cedef9f2d.htm "Read 方法 (String, UInt16)")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| XinJEInternalNetRead 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/3dc86564-1604-6753-813c-9f3cedef9f2d.htm)
...
|  |
| --- |
| XinJEInternalNetRead 方法 (String, UInt16) |
...
[Read 重载](d4fad63d-39a0-c038-260f-3ec31b730103.htm)
...
[原文連結](http://api.hslcommunication.cn/html/6798f76a-fedb-cae1-861a-d97975bee490.htm)
...
[ReadAsync 方法 (String, UInt16)](../html/28d6ce37-f463-d877-bed1-51f245133db9.htm "ReadAsync 方法 (String, UInt16)")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| XinJEInternalNetReadAsync 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/28d6ce37-f463-d877-bed1-51f245133db9.htm)
...
|  |
| --- |
| XinJEInternalNetReadAsync 方法 (String, UInt16) |
...
[ReadAsync 重载](6798f76a-fedb-cae1-861a-d97975bee490.htm)
...
[原文連結](http://api.hslcommunication.cn/html/da4bea2a-9d70-d004-cb6b-18b5f84a2649.htm)
...
[ReadBool 方法 (String, UInt16)](../html/0b5d9b1d-773a-15b6-696f-39b8253e17dd.htm "ReadBool 方法 (String, UInt16)")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| XinJEInternalNetReadBool 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/0b5d9b1d-773a-15b6-696f-39b8253e17dd.htm)
...
|  |
| --- |
| XinJEInternalNetReadBool 方法 (String, UInt16) |
...
[ReadBool 重载](da4bea2a-9d70-d004-cb6b-18b5f84a2649.htm)
...
[原文連結](http://api.hslcommunication.cn/html/f324cae6-f59c-27d8-cdee-0d1abc8985fe.htm)
...
[ReadBoolAsync 方法 (String, UInt16)](../html/c435efa4-1c46-826b-991d-995312c284e6.htm "ReadBoolAsync 方法 (String, UInt16)")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| XinJEInternalNetReadBoolAsync 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/c435efa4-1c46-826b-991d-995312c284e6.htm)
...
|  |
| --- |
| XinJEInternalNetReadBoolAsync 方法 (String, UInt16) |
...
[ReadBoolAsync 重载](f324cae6-f59c-27d8-cdee-0d1abc8985fe.htm)
...
[原文連結](http://api.hslcommunication.cn/html/8e689c9d-2b6a-cfe1-d12a-33d12a138906.htm)
...
|  |
| --- |
| XinJEInternalNetToString 方法 |

[缺少 "M:HslCommunication.Profinet.XINJE.XinJEInternalNet.ToString" 的 <summary> 文档]
...
[缺少 "M:HslCommunication.Profinet.XINJE.XinJEInternalNet.ToString" 的 <returns> 文档]
...
[原文連結](http://api.hslcommunication.cn/html/df2709b2-686b-dc5b-6fd4-ed6d46723969.htm)
...
|  |
| --- |
| XinJEInternalNetUnpackResponseContent 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/87b28365-43af-4bc3-3ca3-e6f150fa417e.htm)
...
[Write 方法 (String, Boolean[])](../html/cf0173d3-c0c6-f4be-b3eb-f5d9694db79a.htm "Write 方法 (String, Boolean[])")

[Write 方法 (String, Byte[])](../html/93963978-41e3-5617-0258-645e26972adb.htm "Write 方法 (String, Byte[])")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| XinJEInternalNetWrite 方法 |
