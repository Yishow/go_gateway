# HslCommunication - HslCommunication.Profinet.Siemens
...
[原文連結](http://api.hslcommunication.cn/html/d3bc924f-9449-3708-ac13-bdaebf44321c.htm)

HslCommunication Library Document

[HslCommunication Library Document](../html\c136d3de-eab7-9b0f-4bdf-d891297c8018.htm "HslCommunication Library Document")

[HslCommunication.Profinet.Siemens](../html/d3bc924f-9449-3708-ac13-bdaebf44321c.htm "HslCommunication.Profinet.Siemens")

[SiemensDateTime 类](../html/e7769360-374d-95e3-88f1-b895bdc423a5.htm "SiemensDateTime 类")

[SiemensFetchWriteNet 类](../html/29c8cac4-e223-4a8d-8622-b9eb72d6d601.htm "SiemensFetchWriteNet 类")

[SiemensFetchWriteServer 类](../html/d84f4a4c-1c1c-8ab0-ec1e-270c12312872.htm "SiemensFetchWriteServer 类")

[SiemensMPI 类](../html/585e2fa1-87a7-04c2-5a69-ad61146dbf5f.htm "SiemensMPI 类")

[SiemensPLCS 枚举](../html/1142171c-c90e-e3bf-39f3-def144bd11da.htm "SiemensPLCS 枚举")

[SiemensPPI 类](../html/59137b36-1feb-6f82-55dd-ed8cda809564.htm "SiemensPPI 类")

[SiemensPPIOverTcp 类](../html/e0c7d759-f723-1ba9-4835-723aa38aceb3.htm "SiemensPPIOverTcp 类")

[SiemensPPIServer 类](../html/65fa05f9-fc43-d903-ac25-8a6e04335c27.htm "SiemensPPIServer 类")

[SiemensS7Net 类](../html/e255b778-7bab-195f-3f07-8f57bf5d8fb7.htm "SiemensS7Net 类")

[SiemensS7Plus 类](../html/1b3f6853-d54f-ffb6-163a-3f2fb3bb6025.htm "SiemensS7Plus 类")

[SiemensS7Server 类](../html/baa96cf7-c2e5-8fdc-4716-14d839ab996a.htm "SiemensS7Server 类")

[SiemensWebApi 类](../html/9b991d27-9b8f-f674-4e2a-e37e35e8bcd1.htm "SiemensWebApi 类")
...
|  | 类 | 说明 |
| --- | --- | --- |
| 公共类 | [SiemensDateTime](e7769360-374d-95e3-88f1-b895bdc423a5.htm) | Contains the methods to convert between DateTime and S7 representation of datetime values. |
| 公共类代码示例 | [SiemensFetchWriteNet](29c8cac4-e223-4a8d-8622-b9eb72d6d601.htm) | 使用了Fetch/Write协议来和西门子进行通讯，该种方法需要在PLC侧进行一些配置  Using the Fetch/write protocol to communicate with Siemens, this method requires some configuration on the PLC side |
| 公共类代码示例 | [SiemensFetchWriteServer](d84f4a4c-1c1c-8ab0-ec1e-270c12312872.htm) | 西门子的Fetch/Write协议的虚拟PLC，可以用来调试通讯，也可以实现一个虚拟的PLC功能，从而开发一套带虚拟环境的上位机系统，可以用来演示，测试。  The virtual PLC of Siemens Fetch/Write protocol can be used for debugging communication, and can also realize a virtual PLC function, so as to develop a set of upper computer system with virtual environment, which can be used for demonstration and testing. |
| 公共类 | [SiemensMPI](585e2fa1-87a7-04c2-5a69-ad61146dbf5f.htm) | 西门子的MPI协议信息，注意：未测试通过，无法使用  Siemens MPI protocol information, note: it has not passed the test and cannot be used |
| 公共类 | [SiemensPPI](59137b36-1feb-6f82-55dd-ed8cda809564.htm) | 西门子的PPI协议，适用于s7-200plc，注意，由于本类库的每次通讯分成2次操作，内部增加了一个同步锁，所以单次通信时间比较久，另外，地址支持携带站号，例如：s=2;M100  Siemens' PPI protocol is suitable for s7-200plc. Note that since each communication of this class library is divided into two operations, and a synchronization lock is added inside, the single communication time is relatively long. In addition, the address supports carrying the station number, for example : S=2;M100 |
| 公共类 | [SiemensPPIOverTcp](e0c7d759-f723-1ba9-4835-723aa38aceb3.htm) | 西门子的PPI协议，适用于s7-200plc，注意，由于本类库的每次通讯分成2次操作，内部增加了一个同步锁，所以单次通信时间比较久，另外，地址支持携带站号，例如：s=2;M100  Siemens' PPI protocol is suitable for s7-200plc. Note that since each communication of this class library is divided into two operations, and a synchronization lock is added inside, the single communication time is relatively long. In addition, the address supports carrying the station number, for example : S=2;M100 |
| 公共类 | [SiemensPPIServer](65fa05f9-fc43-d903-ac25-8a6e04335c27.htm) | PPIServer的虚拟服务器对象，支持的地址类型和S7虚拟服务器一致 |
| 公共类代码示例 | [SiemensS7Net](e255b778-7bab-195f-3f07-8f57bf5d8fb7.htm) | 一个西门子的客户端类，使用S7协议来进行数据交互，对于s300,s400需要关注[Slot](02f087a0-3462-0ee9-08e4-f99b136d0e77.htm)和[Rack](b54ce01d-87af-bcf3-d9c3-c106ccef49d4.htm)的设置值， 对于s200，需要关注[LocalTSAP](98b6f132-2c89-ddfa-8df7-45ce657a2e88.htm)和[DestTSAP](897f518b-cb86-5bf0-ef6d-7cd296a42d65.htm)的设置值，详细参考demo的设置。   A Siemens client class uses the S7 protocol for data exchange. For s300 and s400, you need to pay attention to the setting values of [Slot](02f087a0-3462-0ee9-08e4-f99b136d0e77.htm) and [Rack](b54ce01d-87af-bcf3-d9c3-c106ccef49d4.htm). For s200, you need to pay attention to [Slot](02f087a0-3462-0ee9-08e4-f99b136d0e77.htm) and [Rack](b54ce01d-87af-bcf3-d9c3-c106ccef49d4.htm). See cref="LocalTSAP"/> and [DestTSAP](897f518b-cb86-5bf0-ef6d-7cd296a42d65.htm) settings, please refer to the demo settings for details. |
| 公共类 | [SiemensS7Plus](1b3f6853-d54f-ffb6-163a-3f2fb3bb6025.htm) | 测试的基于S7 PLUS的协议，功能还未完成，无法调用 |
| 公共类代码示例 | [SiemensS7Server](baa96cf7-c2e5-8fdc-4716-14d839ab996a.htm) | 西门子S7协议的虚拟服务器，支持TCP协议，模拟的是1200的PLC进行通信，在客户端进行操作操作的时候，最好是选择1200的客户端对象进行通信。  The virtual server of Siemens S7 protocol supports TCP protocol. It simulates 1200 PLC for communication. When the client is operating, it is best to select the 1200 client object for communication. |
| 公共类 | [SiemensWebApi](9b991d27-9b8f-f674-4e2a-e37e35e8bcd1.htm) | 西门子的基于WebApi协议读写数据对象，支持对PLC的标签进行读取，适用于1500系列，该数据标签需要共享开放出来。  Siemens reads and writes data objects based on the WebApi protocol, supports reading PLC tags, and is suitable for the 1500 series. The data tags need to be shared and opened. |

![](../icons/SectionExpanded.png)枚举

|  | 枚举 | 说明 |
| --- | --- | --- |
| 公共枚举 | [SiemensPLCS](1142171c-c90e-e3bf-39f3-def144bd11da.htm) | 西门子的PLC类型，目前支持的访问类型 |
...
[原文連結](http://api.hslcommunication.cn/html/e7769360-374d-95e3-88f1-b895bdc423a5.htm)
...
[SiemensDateTime 构造函数](../html/2365b054-be39-41d7-bc86-3cc64abeec40.htm "SiemensDateTime 构造函数 ")

[SiemensDateTime 方法](../html/19b3ed25-e5a0-93c3-f1cb-c47970db305f.htm "SiemensDateTime 方法")

[SiemensDateTime 字段](../html/800fd6fe-d3d4-9fda-4fba-6ee35f597d52.htm "SiemensDateTime 字段")
...
SystemObject  
  HslCommunication.Profinet.SiemensSiemensDateTime

**命名空间：**
 [HslCommunication.Profinet.Siemens](d3bc924f-9449-3708-ac13-bdaebf44321c.htm)  
**程序集：**
...
```
public ref class SiemensDateTime
```

```
type SiemensDateTime =  class end
```

SiemensDateTime 类型公开以下成员。

![](../icons/SectionExpanded.png)构造函数

|  | 名称 | 说明 |
| --- | --- | --- |
| 公共方法 | [SiemensDateTime](2365b054-be39-41d7-bc86-3cc64abeec40.htm) | 初始化 SiemensDateTime 类的一个新实例 |
...
| 公共方法静态成员 | [FromByteArray](4ff6d77c-6858-ad92-17e4-1d0a8d7f0414.htm) | Parses a DateTime value from bytes. |
| 公共方法静态成员 | [GetBytesFromDTLTime](57714605-2ea9-abfc-e652-28ec7c922a78.htm) | 将时间数据转换为西门子的DTL格式的时间数据 |
| 公共方法静态成员 | [GetDTLTime](25f1f6e8-2d89-f734-acae-0c56f0243ee0.htm) | 从西门子的原始字节数据中，提取出DTL格式的时间信息 |
| 公共方法 | GetHashCode | (继承自 Object。) |
| 公共方法 | GetType | (继承自 Object。) |
| 受保护的方法 | MemberwiseClone | (继承自 Object。) |
| 公共方法静态成员 | [ToArray](82607ab7-f590-9a0b-1dfe-7d5080e533b1.htm) | Parses an array of DateTime values from bytes. |
| 公共方法静态成员 | [ToByteArray(DateTime)](b6f5786f-e420-6000-bc95-5d8508c5d7fc.htm) | Converts a DateTime value to a byte array. |
| 公共方法静态成员 | [ToByteArray(DateTime)](8aad243c-683a-297b-1f95-7130b7d2a7b5.htm) | Converts an array of DateTime values to a byte array. |
...
|  | 名称 | 说明 |
| --- | --- | --- |
| 公共字段静态成员 | [SpecMaximumDateTime](48edcf23-5ac3-3406-9152-a5230477a831.htm) | The maximum DateTime value supported by the specification. |
| 公共字段静态成员 | [SpecMinimumDateTime](cd05ed1e-361f-d96c-c6b4-50d59d1fe4dc.htm) | The minimum DateTime value supported by the specification. |
...
[HslCommunication.Profinet.Siemens 命名空间](d3bc924f-9449-3708-ac13-bdaebf44321c.htm)
...
---
## SiemensDateTime 构造函数 

[原文連結](http://api.hslcommunication.cn/html/2365b054-be39-41d7-bc86-3cc64abeec40.htm)
...
初始化 [SiemensDateTime](e7769360-374d-95e3-88f1-b895bdc423a5.htm) 类的一个新实例
...
[SiemensDateTime 类](e7769360-374d-95e3-88f1-b895bdc423a5.htm)
...
[原文連結](http://api.hslcommunication.cn/html/19b3ed25-e5a0-93c3-f1cb-c47970db305f.htm)
...
[FromByteArray 方法](../html/4ff6d77c-6858-ad92-17e4-1d0a8d7f0414.htm "FromByteArray 方法 ")

[GetBytesFromDTLTime 方法](../html/57714605-2ea9-abfc-e652-28ec7c922a78.htm "GetBytesFromDTLTime 方法 ")

[GetDTLTime 方法](../html/25f1f6e8-2d89-f734-acae-0c56f0243ee0.htm "GetDTLTime 方法 ")

[ToArray 方法](../html/82607ab7-f590-9a0b-1dfe-7d5080e533b1.htm "ToArray 方法 ")

[ToByteArray 方法](../html/203b125c-8083-fa82-2d25-bad664d45dcd.htm "ToByteArray 方法 ")
...
[SiemensDateTime](e7769360-374d-95e3-88f1-b895bdc423a5.htm) 类型公开以下成员。
...
[原文連結](http://api.hslcommunication.cn/html/4ff6d77c-6858-ad92-17e4-1d0a8d7f0414.htm)
...
![](../icons/SectionExpanded.png)异常

| 异常 | 条件 |
| --- | --- |
| ArgumentOutOfRangeException | Thrown when the length of bytes is not 8 or any value in bytes is outside the valid range of values. |
...
---
## GetBytesFromDTLTime 方法 

[原文連結](http://api.hslcommunication.cn/html/57714605-2ea9-abfc-e652-28ec7c922a78.htm)
...
```
Public Shared Function GetBytesFromDTLTime ( 
...
```
public:
static array<unsigned char>^ GetBytesFromDTLTime(
	IByteTransform^ byteTransform, 
	DateTime dateTime
)
```
...
```
static member GetBytesFromDTLTime : 
        byteTransform : IByteTransform * 
        dateTime : DateTime -> byte[] 
```
...
[原文連結](http://api.hslcommunication.cn/html/25f1f6e8-2d89-f734-acae-0c56f0243ee0.htm)
...
```
Public Shared Function GetDTLTime ( 
	byteTransform As IByteTransform,
	buffer As Byte(),
	index As Integer
) As OperateResult(Of DateTime)
...
```
public:
static OperateResult<DateTime>^ GetDTLTime(
	IByteTransform^ byteTransform, 
...
```
static member GetDTLTime : 
        byteTransform : IByteTransform * 
        buffer : byte[] * 
        index : int -> OperateResult<DateTime> 
```
...
[原文連結](http://api.hslcommunication.cn/html/82607ab7-f590-9a0b-1dfe-7d5080e533b1.htm)
...
| 异常 | 条件 |
| --- | --- |
| ArgumentOutOfRangeException | Thrown when the length of bytes is not a multiple of 8 or any value in bytes is outside the valid range of values. |
...
[原文連結](http://api.hslcommunication.cn/html/203b125c-8083-fa82-2d25-bad664d45dcd.htm)
...
[ToByteArray 方法 (DateTime)](../html/b6f5786f-e420-6000-bc95-5d8508c5d7fc.htm "ToByteArray 方法 (DateTime)")

[ToByteArray 方法 (DateTime[])](../html/8aad243c-683a-297b-1f95-7130b7d2a7b5.htm "ToByteArray 方法 (DateTime[])")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| SiemensDateTimeToByteArray 方法 |
...
---
## ToByteArray 方法 (DateTime)

[原文連結](http://api.hslcommunication.cn/html/b6f5786f-e420-6000-bc95-5d8508c5d7fc.htm)
...
| 异常 | 条件 |
| --- | --- |
| ArgumentOutOfRangeException | Thrown when the value of dateTime is before [P:SpecMinimumDateTime] or after [P:SpecMaximumDateTime]. |
...
[ToByteArray 重载](203b125c-8083-fa82-2d25-bad664d45dcd.htm)
...
[原文連結](http://api.hslcommunication.cn/html/8aad243c-683a-297b-1f95-7130b7d2a7b5.htm)
...
| 异常 | 条件 |
| --- | --- |
| ArgumentOutOfRangeException | Thrown when any value of dateTimes is before [P:SpecMinimumDateTime] or after [P:SpecMaximumDateTime]. |
...
[原文連結](http://api.hslcommunication.cn/html/800fd6fe-d3d4-9fda-4fba-6ee35f597d52.htm)
...
[SpecMaximumDateTime 字段](../html/48edcf23-5ac3-3406-9152-a5230477a831.htm "SpecMaximumDateTime 字段")

[SpecMinimumDateTime 字段](../html/cd05ed1e-361f-d96c-c6b4-50d59d1fe4dc.htm "SpecMinimumDateTime 字段")
...
---
## SpecMaximumDateTime 字段

[原文連結](http://api.hslcommunication.cn/html/48edcf23-5ac3-3406-9152-a5230477a831.htm)
...
|  |
| --- |
| SiemensDateTimeSpecMaximumDateTime 字段 |

The maximum DateTime value supported by the specification.
...
```
public static readonly DateTime SpecMaximumDateTime
```

```
Public Shared ReadOnly SpecMaximumDateTime As DateTime
```

```
public:
static initonly DateTime SpecMaximumDateTime
```

```
static val SpecMaximumDateTime: DateTime
```
...
---
## SpecMinimumDateTime 字段

[原文連結](http://api.hslcommunication.cn/html/cd05ed1e-361f-d96c-c6b4-50d59d1fe4dc.htm)
...
|  |
| --- |
| SiemensDateTimeSpecMinimumDateTime 字段 |

The minimum DateTime value supported by the specification.
...
```
public static readonly DateTime SpecMinimumDateTime
```

```
Public Shared ReadOnly SpecMinimumDateTime As DateTime
```

```
public:
static initonly DateTime SpecMinimumDateTime
```

```
static val SpecMinimumDateTime: DateTime
```
...
---
## SiemensFetchWriteNet 类

[原文連結](http://api.hslcommunication.cn/html/29c8cac4-e223-4a8d-8622-b9eb72d6d601.htm)
...
[SiemensFetchWriteNet 构造函数](../html/f939910b-b0bb-7677-e532-b25f3c4bb7a8.htm "SiemensFetchWriteNet 构造函数 ")

[SiemensFetchWriteNet 属性](../html/0ae8197a-8d05-09fb-5182-a3439aef0776.htm "SiemensFetchWriteNet 属性")

[SiemensFetchWriteNet 方法](../html/926ffdbd-5ca3-1328-331d-952102e901d3.htm "SiemensFetchWriteNet 方法")

[SiemensFetchWriteNet 字段](../html/b19f54dc-3420-303e-4acb-dc8fbfee41ae.htm "SiemensFetchWriteNet 字段")
...
        HslCommunication.Profinet.SiemensSiemensFetchWriteNet
...
```
public ref class SiemensFetchWriteNet : public DeviceTcpNet
```

```
type SiemensFetchWriteNet =  
    class
        inherit DeviceTcpNet
    end
```

SiemensFetchWriteNet 类型公开以下成员。

![](../icons/SectionExpanded.png)构造函数

|  | 名称 | 说明 |
| --- | --- | --- |
| 公共方法 | [SiemensFetchWriteNet](b4be2962-bb2f-2344-f85f-a6b89f9986c3.htm) | 实例化一个西门子的Fetch/Write协议的通讯对象  Instantiate a communication object for a Siemens Fetch/write protocol |
| 公共方法 | [SiemensFetchWriteNet(String, Int32)](9fee95e3-186e-01f0-0c0b-3a2cf51c1180.htm) | 实例化一个西门子的Fetch/Write协议的通讯对象  Instantiate a communication object for a Siemens Fetch/write protocol |
...
|  | 名称 | 说明 |
| --- | --- | --- |
| 公共方法静态成员 | [BuildReadCommand](7c48ec6b-4cc0-a4b5-cd5b-3f1265c86947.htm) | 生成一个读取字数据指令头的通用方法  A general method for generating a command header to read a Word data |
| 公共方法静态成员 | [BuildWriteCommand](31b9e438-33ba-ec7b-47ce-2e999bb418c4.htm) | 生成一个写入字节数据的指令  Generate an instruction to write byte data |
...
| 受保护的方法 | [GetNewNetMessage](9815f68a-c84b-b6d0-ba25-639e101b9d25.htm) | 获取一个新的消息对象的方法，需要在继承类里面进行重写  The method to get a new message object needs to be overridden in the inheritance class (重写 [BinaryCommunicationGetNewNetMessage](16636a1b-a6f0-9c0f-9d9c-c94e26c67459.htm).) |
| 公共方法 | GetType | (继承自 Object。) |
...
| 公共方法代码示例 | [Read(String, UInt16)](580e5018-765d-6ea1-874d-cc96de291fe7.htm) | 从PLC读取数据，地址格式为I100，Q100，DB20.100，M100，T100，C100，以字节为单位  Read data from PLC, address format I100,Q100,DB20.100,M100,T100,C100, in bytes (重写 [DeviceCommunicationRead(String, UInt16)](9dd09452-c200-bc65-75ff-69aa34b366d4.htm).) |
...
| 公共方法代码示例 | [ReadAsync(String, UInt16)](57d21c02-e0db-40a7-9527-a12f5350c2ec.htm) | 从PLC读取数据，地址格式为I100，Q100，DB20.100，M100，T100，C100，以字节为单位  Read data from PLC, address format I100,Q100,DB20.100,M100,T100,C100, in bytes (重写 [DeviceCommunicationReadAsync(String, UInt16)](d8c14d37-56dc-2a31-1a19-3e2b5b65197d.htm).) |
...
| 公共方法 | [ReadByte](2748a461-3bef-c235-621a-8a35d81f952d.htm) | 读取指定地址的byte数据  Reads the byte data for the specified address |
| 公共方法 | [ReadByteAsync](0e7e7d4e-9dad-5461-3b5a-b2dfef587da6.htm) | 读取指定地址的byte数据  Reads the byte data for the specified address |
...
| 公共方法 | [ToString](99a86fa1-ff09-36a4-c6d6-1a219afcdd14.htm) | (重写 [DeviceTcpNetToString](209a196b-90ea-2b73-e915-ce4b11f1263d.htm).) |
...
| 公共方法 | [Write(String, Byte)](16dfd399-d1ab-f3ae-afc1-7d11340ebe4d.htm) | 向PLC中写入byte数据，返回是否写入成功  Writes byte data to the PLC and returns whether the write succeeded |
| 公共方法代码示例 | [Write(String, Byte)](0e8923b8-9073-c62e-3d88-54e29728f96f.htm) | 将数据写入到PLC数据，地址格式为I100，Q100，DB20.100，M100，以字节为单位  Writes data to the PLC data, in the address format i100,q100,db20.100,m100, in bytes (重写 [DeviceCommunicationWrite(String, Byte)](b5536dd6-ccde-6883-ac27-bff9e4b37806.htm).) |
...
| 公共方法 | [WriteAsync(String, Byte)](1d7b03e0-a8f6-b812-b08b-2c356eba5e64.htm) | 向PLC中写入byte数据，返回是否写入成功  Writes byte data to the PLC and returns whether the write succeeded |
| 公共方法代码示例 | [WriteAsync(String, Byte)](1f5ee0d4-18d8-aa39-0a1c-56c8654e74e4.htm) | 将数据写入到PLC数据，地址格式为I100，Q100，DB20.100，M100，以字节为单位  Writes data to the PLC data, in the address format i100,q100,db20.100,m100, in bytes (重写 [DeviceCommunicationWriteAsync(String, Byte)](8f1cec30-8b86-6749-c8f3-7d39168d59df.htm).) |
...
---
## SiemensFetchWriteNet 构造函数 

[原文連結](http://api.hslcommunication.cn/html/f939910b-b0bb-7677-e532-b25f3c4bb7a8.htm)
...
[SiemensFetchWriteNet 构造函数](../html/b4be2962-bb2f-2344-f85f-a6b89f9986c3.htm "SiemensFetchWriteNet 构造函数 ")

[SiemensFetchWriteNet 构造函数 (String, Int32)](../html/9fee95e3-186e-01f0-0c0b-3a2cf51c1180.htm "SiemensFetchWriteNet 构造函数 (String, Int32)")
...
[SiemensFetchWriteNet 类](29c8cac4-e223-4a8d-8622-b9eb72d6d601.htm)
...
[原文連結](http://api.hslcommunication.cn/html/b4be2962-bb2f-2344-f85f-a6b89f9986c3.htm)
...
[SiemensFetchWriteNet 重载](f939910b-b0bb-7677-e532-b25f3c4bb7a8.htm)
...
---
## SiemensFetchWriteNet 构造函数 (String, Int32)

[原文連結](http://api.hslcommunication.cn/html/9fee95e3-186e-01f0-0c0b-3a2cf51c1180.htm)
...
---
## SiemensFetchWriteNet 属性

[原文連結](http://api.hslcommunication.cn/html/0ae8197a-8d05-09fb-5182-a3439aef0776.htm)
...
[SiemensFetchWriteNet](29c8cac4-e223-4a8d-8622-b9eb72d6d601.htm) 类型公开以下成员。
...
---
## SiemensFetchWriteNet 方法

[原文連結](http://api.hslcommunication.cn/html/926ffdbd-5ca3-1328-331d-952102e901d3.htm)
...
[BuildReadCommand 方法](../html/7c48ec6b-4cc0-a4b5-cd5b-3f1265c86947.htm "BuildReadCommand 方法 ")

[BuildWriteCommand 方法](../html/31b9e438-33ba-ec7b-47ce-2e999bb418c4.htm "BuildWriteCommand 方法 ")

[GetNewNetMessage 方法](../html/9815f68a-c84b-b6d0-ba25-639e101b9d25.htm "GetNewNetMessage 方法 ")

[Read 方法](../html/4e011450-8095-5a33-ff77-942adaaf2a4c.htm "Read 方法 ")

[ReadAsync 方法](../html/64462186-3e10-9e15-66d1-3c331acb491a.htm "ReadAsync 方法 ")

[ReadByte 方法](../html/2748a461-3bef-c235-621a-8a35d81f952d.htm "ReadByte 方法 ")

[ReadByteAsync 方法](../html/0e7e7d4e-9dad-5461-3b5a-b2dfef587da6.htm "ReadByteAsync 方法 ")

[ToString 方法](../html/99a86fa1-ff09-36a4-c6d6-1a219afcdd14.htm "ToString 方法 ")

[Write 方法](../html/d75ded73-76a9-d0cd-41ed-8ac33913f5cc.htm "Write 方法 ")

[WriteAsync 方法](../html/dfb0817c-389b-d6de-a6f1-0a15f2c32ec9.htm "WriteAsync 方法 ")
...
[原文連結](http://api.hslcommunication.cn/html/7c48ec6b-4cc0-a4b5-cd5b-3f1265c86947.htm)
...
|  |
| --- |
| SiemensFetchWriteNetBuildReadCommand 方法 |
...
static member BuildReadCommand : 
        address : string * 
        count : uint16 -> OperateResult<byte[]> 
```
...
[原文連結](http://api.hslcommunication.cn/html/31b9e438-33ba-ec7b-47ce-2e999bb418c4.htm)
...
|  |
| --- |
| SiemensFetchWriteNetBuildWriteCommand 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/9815f68a-c84b-b6d0-ba25-639e101b9d25.htm)
...
|  |
| --- |
| SiemensFetchWriteNetGetNewNetMessage 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/4e011450-8095-5a33-ff77-942adaaf2a4c.htm)
...
[Read 方法 (String, UInt16)](../html/580e5018-765d-6ea1-874d-cc96de291fe7.htm "Read 方法 (String, UInt16)")

![点击或拖拽改变大小](../icons/TocOpen.gif "点击或拖拽改变大小")![点击或拖拽改变大小](../icons/TocClose.gif "点击或拖拽改变大小")

|  |
| --- |
| SiemensFetchWriteNetRead 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/580e5018-765d-6ea1-874d-cc96de291fe7.htm)
...
|  |
| --- |
| SiemensFetchWriteNetRead 方法 (String, UInt16) |
...
[Read 重载](4e011450-8095-5a33-ff77-942adaaf2a4c.htm)
...
[原文連結](http://api.hslcommunication.cn/html/64462186-3e10-9e15-66d1-3c331acb491a.htm)
...
[ReadAsync 方法 (String, UInt16)](../html/57d21c02-e0db-40a7-9527-a12f5350c2ec.htm "ReadAsync 方法 (String, UInt16)")
...
[原文連結](http://api.hslcommunication.cn/html/57d21c02-e0db-40a7-9527-a12f5350c2ec.htm)
...
[ReadAsync 重载](64462186-3e10-9e15-66d1-3c331acb491a.htm)
...
[原文連結](http://api.hslcommunication.cn/html/2748a461-3bef-c235-621a-8a35d81f952d.htm)
...
|  |
| --- |
| SiemensFetchWriteNetReadByte 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/0e7e7d4e-9dad-5461-3b5a-b2dfef587da6.htm)
...
|  |
| --- |
| SiemensFetchWriteNetReadByteAsync 方法 |
...
[原文連結](http://api.hslcommunication.cn/html/99a86fa1-ff09-36a4-c6d6-1a219afcdd14.htm)
...
|  |
| --- |
| SiemensFetchWriteNetToString 方法 |

[缺少 "M:HslCommunication.Profinet.Siemens.SiemensFetchWriteNet.ToString" 的 <summary> 文档]
...
[缺少 "M:HslCommunication.Profinet.Siemens.SiemensFetchWriteNet.ToString" 的 <returns> 文档]
