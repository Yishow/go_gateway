...
import { WorkbenchProvider } from '@/pages/datalink/workbench/WorkbenchProvider';
import { DatabaseTargetBoard } from '@/pages/datalink/workbench/DatabaseTargetBoard';
import type { WorkbenchOutputCandidate } from '@/pages/datalink/workbench/workbenchOutputTypes';
...
vi.mock('@/pages/datalink/workbench/useRefreshSourceRuleCandidates', () => ({
