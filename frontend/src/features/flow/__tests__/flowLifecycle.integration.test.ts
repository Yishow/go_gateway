...
import { useFlowLifecycle } from '../stateMachine';
  ...
  it('supports draft -> validated -> active flow with diagnostics updates', () => {
    ...
    act(() => {
      ...
      result.current.setDiagnostics({
        source: { latestValue: '23.1', quality: 'good', timestamp: '2026-02-13T00:00:00Z', error: '' },
        grid: { latestValue: 'D100', quality: 'good', timestamp: '2026-02-13T00:00:01Z', error: '' },
        tag: { latestValue: 'line.temp', quality: 'good', timestamp: '2026-02-13T00:00:02Z', error: '' },
      });
    });
