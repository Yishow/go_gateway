  ...
  return (
    <div className="space-y-8">
      ...
      {loading ? (
        ...
        <div className="text-center py-20 bg-slate-800/30 rounded-2xl border-2 border-slate-700/50 border-dashed group hover:border-purple-500/30 transition-colors cursor-pointer" onClick={handleCreate}>
