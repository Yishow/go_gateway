        ...
        {!connectionId ? (
          ...
          <div className="space-y-3 animate-fade-in">
            ...
            <button
              ...
              disabled={loading}
              className="w-full bg-white text-red-600 border border-red-200 px-4 py-3 rounded-xl font-semibold hover:bg-red-50 hover:border-red-300 active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? '斷線中...' : '斷開連線'}
            </button>
          </div>
