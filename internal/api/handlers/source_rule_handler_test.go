...
func TestSourceRuleHandler_CreateAndList(t *testing.T) {
	...
	req, err := http.NewRequestWithContext(context.Background(), http.MethodPost, "/datalink/source-rules", bytes.NewBuffer(body))
	require.NoError(t, err)
	...
	listReq, err := http.NewRequestWithContext(t.Context(), http.MethodGet, "/datalink/source-rules?device_id=device-1", http.NoBody)
	require.NoError(t, err)
...
func TestSourceRuleHandler_Disable(t *testing.T) {
	...
	disableReq, err := http.NewRequestWithContext(t.Context(), http.MethodPost, "/datalink/source-rules/rule-1/disable", http.NoBody)
	require.NoError(t, err)
...
func TestSourceRuleHandler_Get_NotFound(t *testing.T) {
	...
	req, err := http.NewRequestWithContext(t.Context(), http.MethodGet, "/datalink/source-rules/missing-rule", http.NoBody)
	require.NoError(t, err)
	resp := httptest.NewRecorder()
	router.ServeHTTP(resp, req)
...
func TestSourceRuleHandler_Update_ClearsOptionalConversionSettings(t *testing.T) {
	...
	updateReq, err := http.NewRequestWithContext(context.Background(), http.MethodPut, "/datalink/source-rules/rule-clear-conversion", bytes.NewBufferString(`{"target_data_type":null,"scale_multiplier":null,"scale_offset":null}`))
	require.NoError(t, err)
	...
	getReq, err := http.NewRequestWithContext(t.Context(), http.MethodGet, "/datalink/source-rules/rule-clear-conversion", http.NoBody)
	require.NoError(t, err)
