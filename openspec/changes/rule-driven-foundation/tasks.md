...
- [ ] 2.1 Update device readiness logic to return planning, activation, and apply eligibility separately
...
- [ ] 4.1 Add tests for source-rule revision persistence and restart restore
