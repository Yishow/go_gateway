...
- [x] 3.3 Keep verification-first checks inside the Local Modbus apply flow instead of a separate manual-first path

## 4. Validation

- [x] 4.1 Add tests for restart restore of Local Modbus rule-owned state
- [x] 4.2 Add tests for conflict detection and selective blocking behavior
- [x] 4.3 Add tests proving Local Modbus apply does not affect Database state
