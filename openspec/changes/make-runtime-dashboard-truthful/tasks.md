...
- [ ] 1.1 Deliver Runtime backend expresses degraded and empty states explicitly by extending snapshot and stream contracts with truthful empty or degraded markers, and verify it with runtime handler or stream tests that cover empty and unavailable states.
